...
import image1 from '../../../2020-1/dqsdsx/sub_static/img/image1.png';
import image2 from '../../../2020-1/dqsdsx/sub_static/img/image2.png';
import image3 from '../../../2020-1/dqsdsx/sub_static/img/image3.png';
import image4 from '../../../2020-1/dqsdsx/sub_static/img/image4.png';
...
export class MyCanvas {
    ...
    async addButtonImage() {
        const src = [image1, image2, image3, image4];
        this.buttonImage = [];
    ...
    resize() {
        ...
        for (let i = 0; i < this.buttonImage.length; i++) {
            ...
            this.button[i].set('left', this.background.get('left') + this.config.button[i].left);
            this.button[i].set('top', this.background.get('top') - this.background.get('height') * 0.5 * 0.5 + this.config.button[i].top );

            this.explainText[i].set('left', this.background.get('left') + this.config.explainText[i].left);
