...
export class ViewModel extends Vue {
    ...
    swiperList = [
        ...
        { id: 3, bgSrc1: bgSrc3, tip: window.env.browserInfo.lang.text[2], pos: 'righttop' },
        { id: 4, bgSrc1: bgSrc4, tip: window.env.browserInfo.lang.text[3], pos: 'leftbottom' },
        ...
        { id: 9, bgSrc1: bgSrc9, tip: window.env.browserInfo.lang.text[8], pos: 'leftbottom' },
        ...
        { id: 13, bgSrc1: bgSrc13, tip: window.env.browserInfo.lang.text[12], pos: 'leftbottom' }
    ];
