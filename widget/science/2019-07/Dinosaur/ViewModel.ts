...
export class ViewModel extends Vue {
    ...
    setTimeout = null;
    swiperList = [
        { id: 1, bgSrc1: bgSrc1, tip: window.env.browserInfo.lang.text[0], pos: 'lefttop' },
        ...
        { id: 5, bgSrc1: bgSrc5, tip: window.env.browserInfo.lang.text[4], pos: 'lefttop' },
        { id: 6, bgSrc1: bgSrc6, tip: window.env.browserInfo.lang.text[5], pos: 'righttop' },
        { id: 7, bgSrc1: bgSrc7, tip: window.env.browserInfo.lang.text[6], pos: 'righttop' },
        { id: 8, bgSrc1: bgSrc8, tip: window.env.browserInfo.lang.text[7], pos: 'righttop' },
        { id: 9, bgSrc1: bgSrc9, tip: window.env.browserInfo.lang.text[8], pos: 'righttop' },
        ...
        { id: 12, bgSrc1: bgSrc12, tip: window.env.browserInfo.lang.text[11], pos: 'rightbottom' }
    ];
