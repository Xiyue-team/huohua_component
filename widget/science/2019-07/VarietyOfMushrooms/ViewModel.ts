...
export class ViewModel extends Vue {
    ...
    setTimeout = null;
    swiperList = [
        { id: 1, bgSrc1: bgSrc1, tip: window.env.browserInfo.lang.text[0], pos: 'righttop' },
        { id: 2, bgSrc1: bgSrc2, tip: window.env.browserInfo.lang.text[1], pos: 'righttop' },
        { id: 3, bgSrc1: bgSrc3, tip: window.env.browserInfo.lang.text[2], pos: 'leftbottom' },
        { id: 4, bgSrc1: bgSrc4, tip: window.env.browserInfo.lang.text[3], pos: 'rightbottom' },
        { id: 5, bgSrc1: bgSrc5, tip: window.env.browserInfo.lang.text[4], pos: 'leftbottom' },
        { id: 6, bgSrc1: bgSrc6, tip: window.env.browserInfo.lang.text[5], pos: 'lefttop' },
        { id: 7, bgSrc1: bgSrc7, tip: window.env.browserInfo.lang.text[6], pos: 'rightbottom' },
        ...
        { id: 10, bgSrc1: bgSrc10, tip: window.env.browserInfo.lang.text[9], pos: 'righttop' },
        { id: 11, bgSrc1: bgSrc11, tip: window.env.browserInfo.lang.text[10], pos: 'leftbottom' },
        { id: 12, bgSrc1: bgSrc12, tip: window.env.browserInfo.lang.text[11], pos: 'leftbottom' }
    ];
