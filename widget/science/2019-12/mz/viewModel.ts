...
import * as image_One from './sub_static/image1.png';
import * as image_Two from './sub_static/image2.png';
import * as image_Three from './sub_static/image3.png';
import * as image_four from './sub_static/image4.png';
import * as image_five from './sub_static/image5.png';
import * as image_six from './sub_static/image6.png';
import * as image_seven from './sub_static/image7.png';
import * as image_eight from './sub_static/image8.png';
...
export class ViewModel extends Vue {
  ...
  isAnimation = false;
  zoomIndex = 0;
  imageList = [image_One, image_Two, image_Three, image_four, image_five, image_six, image_seven, image_eight];
  ...
  initImagePosition(index: number) {
    ...
    switch (index) {
      case 1:
        positionObj = { left: 0, top: 0, width: 49.8, height: 49.8 };
        break;
      case 2:
        positionObj = { left: 0, top: 0,  width: 24.8, height: 49.8 };
        break;
      case 3:
        positionObj = { left: 25, top: 0, width: 24.8, height: 49.8 };
        break;
      case 4:
        positionObj = { left: 50, top: 0, width: 24.8, height: 49.8 };
        break;
      case 5:
        positionObj = { left: 50, top: 0, width: 24.8, height: 49.8 };
        break;
      case 6:
        positionObj = { left: 0, top: 0, width: 25, height: 33.1 };
        break;
      case 7:
        positionObj = { left: 0, top: 33.5, width: 25, height: 33.1 };
        break;
      case 8:
        positionObj = { left: 0, top: 0, width: 25, height: 33 };
        break;
    }
    return positionObj;
  }
  ...
  swiperEvent() {
    ...
    this.resetImage();
    let swiperIndex = (swiper.activeIndex % 8);
    if (swiperIndex === 0) {
      swiperIndex = 8;
    }
  ...
  resetImage() {
    ...
    this.imageElement[0].style.width = '49.8%';
    this.imageElement[0].style.height = '49.8%';

    this.imageElement[1].style.zIndex = 1;
    this.imageElement[1].style.width = '24.8%';
    this.imageElement[1].style.height = '49.8%';

    this.imageElement[2].style.zIndex = 1;
    this.imageElement[2].style.left = '25%';
    this.imageElement[2].style.width = '24.8%';
    this.imageElement[2].style.height = '49.8%';

    this.imageElement[3].style.zIndex = 1;
    this.imageElement[3].style.left = '50%';
    this.imageElement[3].style.width = '24.8%';
    this.imageElement[3].style.height = '49.8%';

    this.imageElement[4].style.zIndex = 1;
    this.imageElement[4].style.left = '50%';
    this.imageElement[4].style.width = '24.8%';
    this.imageElement[4].style.height = '49.8%';

    this.imageElement[5].style.zIndex = 1;
    this.imageElement[5].style.width = '25%';
    this.imageElement[5].style.height = '33.1%';

    this.imageElement[6].style.zIndex = 1;
    this.imageElement[6].style.top = '33.5%';
    this.imageElement[6].style.width = '25%';
    this.imageElement[6].style.height = '33.1%';

    this.imageElement[7].style.zIndex = 1;
    this.imageElement[7].style.width = '25%';
    this.imageElement[7].style.height = '33%';
  }
  ...
  setTextAnima() {
    ...
    this.removeSwiperText(7);
    this.removeSwiperText(8);
