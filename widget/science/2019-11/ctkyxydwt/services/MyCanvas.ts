...
export class MyCanvas {
    ...
    addDashFrame() {
      ...
      for (let i = 0; i < this.config.attractiveDashFrame.length; i ++) {
        this.attractiveDashFrame[i] = new fabric.Rect(
          Object.assign({
          left: this.config.attractiveDashFrame[i].left + 111 * 0.5,
          top: this.config.attractiveDashFrame[i].top + 111 * 0.5,
        }, this.config.dashFrame));

        this.rightDiscolorationFrame[i] = new fabric.Rect(
          Object.assign({
          left: this.config.attractiveDashFrame[i].left + 111 * 0.5 + 1,
          top: this.config.attractiveDashFrame[i].top + 111 * 0.5 + 1,
        }, this.config.discolorationFrame));

        this.unattractiveDashFrame[i] = new fabric.Rect(
          Object.assign({
          left: this.config.unattractiveDashFrame[i].left + 111 * 0.5,
          top: this.config.unattractiveDashFrame[i].top + 111 * 0.5,
        }, this.config.dashFrame));

        this.leftDiscolorationFrame[i] = new fabric.Rect(
          Object.assign({
          left: this.config.unattractiveDashFrame[i].left + 111 * 0.5 + 1,
          top: this.config.unattractiveDashFrame[i].top + 111 * 0.5 + 1,
        }, this.config.discolorationFrame));
    ...
    async addattractive() {
      ...
      this.attractive[1] = await FabricUtil.loadImage(image3, this.config.attractive[1]);
      this.myCanvas.add(this.attractive[1]);

      this.attractive[2] = await FabricUtil.loadImage(image5, this.config.attractive[2]);
      this.myCanvas.add(this.attractive[2]);

      this.attractive[3] = await FabricUtil.loadImage(image8, this.config.attractive[3]);
      this.myCanvas.add(this.attractive[3]);
      ...
      await this.imageDragEvent(this.attractive[3], this.config.attractive[3], this.unattractiveDashFrame,
        this.attractiveDashFrame, this.unattractiveFrameGroupDrop, this.leftDiscolorationFrame, this.rightDiscolorationFrame,
        this.attractiveDashFrameDrop);
    }
    ...
    async addunattractive() {
      ...
      this.unattractive[0] = await FabricUtil.loadImage(image2, this.config.unattractive[0]);
      this.myCanvas.add(this.unattractive[0]);

      this.unattractive[1] = await FabricUtil.loadImage(image4, this.config.unattractive[1]);
      ...
      this.unattractive[3] = await FabricUtil.loadImage(image7, this.config.unattractive[3]);
      this.myCanvas.add(this.unattractive[3]);
      ...
      await this.imageDragEvent(this.unattractive[3], this.config.unattractive[3], this.attractiveDashFrame,
        this.unattractiveDashFrame, this.attractiveDashFrameDrop, this.rightDiscolorationFrame, this.leftDiscolorationFrame,
        this.unattractiveFrameGroupDrop);
    }
