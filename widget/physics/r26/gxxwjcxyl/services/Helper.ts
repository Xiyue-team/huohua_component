...
export class Helper {
  ...
  /*通过两直线斜率和线上一点计算出两直线焦点*/
  /**
   * @param {number} k1 直线的斜率
   * @param {number} k2 直线的斜率
   * @param {number} y1 k1直线上的一点的纵坐标
   * @param {number} y2 k2直线上的一点的纵坐标
   * @param {number} x1 k1直线上的一点的横坐标
   * @param {number} x2 k2直线上的一点的横坐标
   */
