...
export class Vbf3dModel extends ThreeBase {
...
/*
    rotateArrow(b1: number[], v1: number[], b2: number[], v2: number[]) {
        let center1: number[];
        let center2: number[];
        center1 = [(b1[0] + v1[0]) / 2, (b1[1] + v1[1]) / 2,  (b1[2] + v1[2]) / 2];
        center2 = [ (b2[0] + v2[0]) / 2, (b2[1] + v2[1]) / 2, (b2[2] + v2[2]) / 2];
