...
import {DlbdsViewHandler} from './services/DlbdsViewHandler';
...
export class ViewModel extends Vue {
    ...
    created() {
        ...
        ViewController.getInstance(new DlbdsViewHandler(this), viewOption);
     ...
     */
    randomNumber() {
        (ViewController.getInstance().viewHandler as DlbdsViewHandler).randomNumberEvent();
    }
    /**
     * 监听是否切换量程
     * @param value 
    ...
    animationControl(value: boolean) {
        (ViewController.getInstance().viewHandler as DlbdsViewHandler).changeRangeEvent();
    }
