...
import {Spring3DModel} from './Spring3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class SpringViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new Spring3DModel(document.getElementById('3dModel'), null, width, height);
