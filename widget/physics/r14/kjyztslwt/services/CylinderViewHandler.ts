...
import {Cylinder3DModel} from './Cylinder3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class CylinderViewHandler extends CommonViewHandler implements ViewHandler {


    gltf: Cylinder3DModel;
    ...
    domReady(): void {
        ...
        this.gltf = new Cylinder3DModel(document.getElementById('3dModel'), null, width, height);
