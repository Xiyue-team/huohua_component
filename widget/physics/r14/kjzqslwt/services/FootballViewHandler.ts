...
import {Football3DModel} from './Football3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class FootballViewHandler extends CommonViewHandler implements ViewHandler {


    gltf: Football3DModel;
    ...
    domReady(): void {
        ...
        this.gltf = new Football3DModel(document.getElementById('3dModel'), null, width, height);
