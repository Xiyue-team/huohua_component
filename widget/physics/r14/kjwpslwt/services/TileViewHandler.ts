...
import {Tile3DModel} from './Tile3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class TileViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new Tile3DModel(document.getElementById('3dModel'), null, width, height);
