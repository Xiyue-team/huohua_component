...
import {TileViewHandler} from './services/TileViewHandler';
...
export default Vue.extend({
    ...
    created() {
        ...
        this.exerciseOption.resizeCall = () => { (ViewController.getInstance().viewHandler as TileViewHandler).moveDiv(); };

        (window as any).noMobile = true;
        ViewController.getInstance(new TileViewHandler(this));
    ...
    mounted() {
        ...
        (ViewController.getInstance().viewHandler as TileViewHandler).moveDiv();
    ...
    methods: {
        resetEvent() {
            (ViewController.getInstance().viewHandler as TileViewHandler).reset();
        },
    }
});
</script>
