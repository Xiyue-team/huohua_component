...
import {Coil3DModel} from './Coil3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';
import {D3Helper} from '../../../../../src/three/util/3DHelper';

export class CoilViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new Coil3DModel(document.getElementById('3dModel'), null, width, height);

        // const d3Helper = new D3Helper(this.gltf);
        // d3Helper.axisHelper(200);
