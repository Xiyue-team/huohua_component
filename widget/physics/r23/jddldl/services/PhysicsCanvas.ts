...
import * as light from '../sub_static/more.png';
...
export default class PhysicsCanvas {
    ...
    async initResource() {
        ...
        this.topLight2 = await this.loadImage(light as any, config3);
        ...
        this.myCanvas.add(this.topLight2);
    ...
    lightAnimation() {
        if (this.topSwitch !== 'on') {
            ...
            this.topLight2.setSrc(null as any);
        ...
        if (this.bottomSwitch === 'on') {
            this.bottomLight.setSrc(bulbBImg as any);
            this.topLight2.setSrc(bulbL as any);
        } else {
