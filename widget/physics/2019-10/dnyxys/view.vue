<template>
    <div class="aspectration root_div_container bg_blue height" data-ratio="16:9" @click="hideKg">
        <div  class="control-panel_div_content fill_parent">
            ...
            <div :class="[isMobile ? 'mcontorl' : 'contorl']">
                <div :class="[isMobile ? 'mcontorl-kg' : 'contorl-kg']">
                    ...
                    <div @click.stop="showKg" :class="[isMobile ? 'mcontorl-kg-con' : 'contorl-kg-con']">
                        <div class="kg-text">
                            {{kilogram}}
                        </div>
                ...
                <div :class="[isMobile ? 'mcontorl-height' : 'contorl-height']" id="heightInput">
                    ...
                    <div style="float: left; position: relative;">
                        <div 
                            ...
                            :style="{left: (isMobile ? 7.77 : 13.33) * (height - 1) + 'px'}">{{height}}</div>
                        <input @input="hideKg" id="heightInput" :class="[isMobile ? 'minput' : 'input']" v-model="height" type="range" min="1" max="10" step="1" :disabled="rDis"/>
                    </div>
