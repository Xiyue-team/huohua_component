...
export class RightImageStorage {
  imageSrc1 = [
    cardImage1, cardImage2, cardImage3, cardImage4, cardImage5, cardImage6, cardImage7, cardImage8, cardImage9
  ];

  imageSrc2 = [
    card2Image1, card2Image2, card2Image3, card2Image4, card2Image5, card2Image6, card2Image7, card2Image8, card2Image9
  ];
