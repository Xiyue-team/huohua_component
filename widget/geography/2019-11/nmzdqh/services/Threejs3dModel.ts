...
import regionImage10 from '../sub_static/img/left/regionImage10.png';
...
export class Threejs3dModel extends ThreeBase {
  ...
  addTextImageSrc() {
    this.textImageSrc = [
      textImage1, textImage2, textImage3, textImage4, textImage5, textImage6, textImage7, textImage8, textImage9, textImage10
    ];

    this.regionImageSrc = [
      regionImage1, regionImage2, regionImage3, regionImage4, regionImage5, regionImage6, regionImage7, regionImage8,
      regionImage9, regionImage10
    ];
  }
  ...
  // 添加静态图片
  addStaticImage() {
    this.map = ThreeUtil.createImg(this.mapWidth * 2 / 3, this.mapHeight * 2 / 3, backgroundImage, 0, 0);
  ...
  addRegionImage() {
    for (let i = 0; i < this.regionImageSrc.length; i++) {
      this.regionArray[i] = ThreeUtil.createImg(this.mapWidth * 2 / 3, this.mapHeight * 2 / 3, this.regionImageSrc[i], 0, 0);
