...
export class Threejs3dModel extends ThreeBase {
  ...
  addStaticImage() {
    ...
    const text1 = ThreeUtil.createText('工业区', '#000000', -560, -25, 0, 0.8);
    const text2 = ThreeUtil.createText('主要工业城市', '#000000', -500, -100, 0, 0.8);
    const text3 = ThreeUtil.createText('钢铁', '#000000', -580, -160, 0, 0.8);
    const text4 = ThreeUtil.createText('棉纺织工业', '#000000', -520, -230, 0, 0.8);
    const text5 = ThreeUtil.createText('麻纺织工业', '#000000', -520, -305, 0, 0.8);
    const text6 = ThreeUtil.createText('汽车工业', '#000000', -540, -355, 0, 0.8);
    const text7 = ThreeUtil.createText('造船工业', '#000000', -540, -420, 0, 0.8);
    const text8 = ThreeUtil.createText('电子电器工业', '#000000', -500, -500, 0, 0.8);
    const text9 = ThreeUtil.createText('机械制造工业', '#000000', -500, -580, 0, 0.8);
    const text10 = ThreeUtil.createText('化学工业', '#000000', -540, -660, 0, 0.8);
    const text11 = ThreeUtil.createText('煤', '#000000', -260, -410, 0, 0.8);
    const text12 = ThreeUtil.createText('石油', '#000000', -240, -490, 0, 0.8);
    const text13 = ThreeUtil.createText('锰', '#000000', -260, -570, 0, 0.8);
    const text14 = ThreeUtil.createText('铁', '#000000', -260, -660, 0, 0.8);
    this.map.add(text1, text2, text3, text4, text5, text6, text7, text8, text9, text10, text11, text12, text13, text14);
