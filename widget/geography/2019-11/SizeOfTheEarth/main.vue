<template>
    <div class="aspectration bg_white root_div_container" data-ratio="16:9">
        <fullScreensLayout>
            ...
            <div class="title_text" :style="`color: ${color}`">{{title_text}}</div>
            ...
            <div class="buttonG">
                <div class="button_Formula" @click="surfaceEvent()">
                    <buttonPrimary
                    style="width: 100%"
                    v-bind:title="btntext[0]"
                    v-bind:actived="surfaceActived"
                    type="ellipse"
                    ></buttonPrimary>
                </div>
                 <div class="button_Formula" @click="perimeterEvent()">
                    <buttonPrimary
                    style="width: 100%"
                    v-bind:title="btntext[1]"
                    v-bind:actived="perimeterActived"
                    type="ellipse"
                    ></buttonPrimary>
                </div>
            </div>
