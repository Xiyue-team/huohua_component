...
export class RightCradCanvas {
  ...
  reverseAnim() {
    ...
    this.card[this.animIndex].children[4].text = window.env.browserInfo.lang.cardText[this.animIndex].content;
    // 左侧返回动画
  ...
  nextPage() {
    if (this.pageIndex + 1 < this.card[this.animIndex].children.length - 2) {
      this.card[this.animIndex].children[4].text = window.env.browserInfo.lang.cardText[this.animIndex].content2;
      this.card[this.animIndex].children[this.pageIndex].renderable = false;
      this.card[this.animIndex].children[this.pageIndex + 1].renderable = true;
      this.pageIndex += 1;
    }
