...
export class ViewModel extends Vue {
  ...
  isShowPlateauText2 = false;
  isShowPlainText2 = false;
  isShowHillyAreaText2 = false;
  ...
  resetEvent() {
    ...
    this.isShowPlateauText2 = false;
    this.isShowPlainText2 = false;
    this.isShowHillyAreaText2 = false;
    ...
    setTimeout(() => {
      (ViewController.getInstance().viewHandler as any).three3dModel.showRegion();
    }, 0);
  ...
  // 高原2
  @Watch('isShowPlateauText2')
  showPlateauText2() {
    (ViewController.getInstance().viewHandler as any).three3dModel.showPlateauText2(this.isShowPlateauText2);
  }

  // 平原2
  @Watch('isShowPlainText2')
  showPlainText2() {
    (ViewController.getInstance().viewHandler as any).three3dModel.showPlainText2(this.isShowPlainText2);
  }

  // 山地2
  @Watch('isShowHillyAreaText2')
  showHillyAreaText2() {
    (ViewController.getInstance().viewHandler as any).three3dModel.showHillyAreaText2(this.isShowHillyAreaText2);
  }
}
