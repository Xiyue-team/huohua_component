...
export class RightCradCanvas {
  ...
  async addCard(res: PIXI.LoaderResource) {
    ...
    for (let i = 0; i < this.config.smallCradImage.length; i++) {
      ...
      if (i === 3) {
        this.card[3].children[6].style.lineHeight = 28;
        console.log('card4', this.card[3].children[6].style.fontSize);
      }
  ...
  reverseAnim() {
    ...
    this.card[this.animIndex].children[6].text = window.env.browserInfo.lang.cardText[this.animIndex].content;
  ...
  previousPage() {
    ...
    this.card[this.animIndex].children[6].text = window.env.browserInfo.lang.cardText[this.animIndex].sub_content[this.pageIndex];
  }
