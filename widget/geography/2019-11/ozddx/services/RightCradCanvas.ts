...
export class RightCradCanvas {
  ...
  async addCard(res: PIXI.LoaderResource) {
    ...
    let src = '/static/widget/geography/2019-11/ozddx/sub_static/img/right';
    if ((process.env.component as any).config.dev) {
      src = '/static/widget/geography/2019-11/ozddx/sub_static/img/right';
    } else {
      src = './widget/geography/2019-11/ozddx/sub_static/img/right';
    }
