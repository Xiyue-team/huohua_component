...
export class DmCanvas extends SimpleKonvaTemplate4 {
    config: DmConfig;
    ...
    drawLineAnimation() {
      const tween = {
        dashSpline1Y1: this.config.height * 0.363,
        dashSpline1Y2: this.config.height * 0.363,

        dashSpline2Y1: this.config.height * 0.673,
        dashSpline2Y2: this.config.height * 0.673,
      };
