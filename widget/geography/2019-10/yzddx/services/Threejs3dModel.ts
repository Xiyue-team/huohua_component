...
export class Threejs3dModel extends ThreeBase {
  ...
  render = () => {
    ...
    const x1 = 280 + 275 * -(this.camera.position.z - 500) / 350;
    const x2 = -270 + -275 * -(this.camera.position.z - 500) / 350;

    const y1 = 220 + 235 * -(this.camera.position.z - 500) / 350;
    const y2 = -270 + -236 * -(this.camera.position.z - 500) / 350;
  ...
  showPlateauText(isShow: boolean) {
    this.textArray[2].visible = isShow;
    this.textArray[3].visible = isShow;
    this.textArray[4].visible = isShow;
    this.textArray[6].visible = isShow;
    this.textArray[9].visible = isShow;
    this.textArray[15].visible = isShow;
    this.textArray[18].visible = isShow;
  }

  // 平原
  showPlainText(isShow: boolean) {
    this.textArray[0].visible = isShow;
    this.textArray[7].visible = isShow;
    this.textArray[10].visible = isShow;
    this.textArray[13].visible = isShow;
    this.textArray[16].visible = isShow;
    this.textArray[17].visible = isShow;
  }

  // 山地
  showHillyAreaText(isShow: boolean) {
    this.textArray[1].visible = isShow;
    this.textArray[5].visible = isShow;
    this.textArray[8].visible = isShow;
    this.textArray[11].visible = isShow;
    this.textArray[12].visible = isShow;
    this.textArray[14].visible = isShow;
  }
