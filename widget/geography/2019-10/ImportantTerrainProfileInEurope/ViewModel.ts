...
export class ViewModel extends Vue {
    ...
    created() {
        ...
        this.labelData = this.SrcUtilss.labelData.e100;
    ...
    ButtonEvent(type: number) {
        ...
        this.labelData = this.finalFuncActived === 1 ? this.SrcUtilss.labelData.e100 : this.SrcUtilss.labelData.n40;

        this.msg = this.labelData[0].tip;
        if (this.assemble) {
    ...
    slideTo(index: number, move = true) {
        if (move) {
            ...
            if (this.msg !== this.labelData[index].tip) {
                this.msg = this.labelData[index].tip;
            }
        }
    }
