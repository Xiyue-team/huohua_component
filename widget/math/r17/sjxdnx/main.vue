    ...
    <div class="aspectration bg_white root_div_container" data-ratio="16:9">
        <fullScreensLayout>
            <template slot="viewBox" slot-scope="viewBox">
                <span id="title" class="title_text">三角形的内心</span>
                    ...
                    <div class="ctrl-wrap" v-show="showEquation" :class="{'no-click':disabledClick}">
                        <div class="row">
                            <div class="left" v-show="active1">
                                <div class="content">三角形内心指三个内角的三条角平分线相交于一点，这个点叫做三角形的内心。</div>
                            </div>
                        ...
                        <div class="row">
                            <div class="left" v-show="active2">
                                <div class="section">
                                    ...
                                    <div class="content" v-show="active3">三角形的内心到三边的距离相等，都等于内切圆半径r,OD=OE=OF=r</div>
                                </div>
                                <div class="section">
