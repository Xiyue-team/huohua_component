...
export default class CenterPoint {
    ...
    private textO = common.createText1('O3', [8, 2, 0], { color: '#BD10E0' });
    ...
    private innerPoint = common.drawCircle(1, { color: '#BD10E0' });
    ...
    initElement() {
        ...
        this.group2.add(this.line_od, this.line_oe, this.line_of, this.groupRightAngle, this.groupTwoLine);
