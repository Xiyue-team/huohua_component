...
export default class CenterPoint {
    ...
    private textO = common.createText1('O2', [8, 2, 0], { color: '#D0021B' });
    ...
    private innerPoint = common.drawCircle(1, { color: '#D0021B' });
    ...
    initElement() {
        ...
        this.group1.add(this.line_ob, this.line_oa, this.line_oc);
        ...
        this.scene.add(this.line_bc, this.line_ab, this.line_ac, this.textA, this.textB, this.textC, this.group1, this.groupInnerPoint);
