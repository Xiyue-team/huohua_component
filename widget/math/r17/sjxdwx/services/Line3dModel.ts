...
import OuterPoint from './OuterPoint.ts';
let thiz: any = null;
OBJLoader(THREE);
export class Line3dModel extends ThreeBase {
    ...
    private ctrlPoint = common.createImg([-0, 40 * Math.tan(50 * Math.PI / 180) - 30, 2], 15, 15, pointImg);
    private count = 0;private pointArr = [{
            x: 0,
            y: 40 * Math.sqrt(3) - 30
        },
        {
