parcelRequire = function (e, r, t, n) {
            ...
            return function (t) {
                ...
                var a = {
                    name: "dep-reg-toString-checker", getDevtoolsDetail: function () {
                        return o(this, void 0, void 0, function () {
                            return i(this, function (t) {
                                return c = !1, Object(r.c)({dep: u}), Object(r.a)(), [2, {
                                    isOpen: c,
                ...
                var a = {
                    name: "function-to-string-checker", getDevtoolsDetail: function () {
                        return o(this, void 0, void 0, function () {
                            return i(this, function (t) {
                                return c = 0, Object(r.b)(u), Object(r.a)(), [2, {
                                    isOpen: 2 === c,
                                    checkerName: this.name
                                }]
                            })
                ...
                var c = s.MD5 = a.extend({
                    _doReset: function () {
                        ...
                        var a = this._hash.words, s = r[t + 0], c = r[t + 1], l = r[t + 2], _ = r[t + 3], d = r[t + 4],
                            p = r[t + 5], y = r[t + 6], D = r[t + 7], H = r[t + 8], M = r[t + 9], g = r[t + 10],
                            m = r[t + 11], w = r[t + 12], x = r[t + 13], B = r[t + 14], b = r[t + 15], j = a[0],
                            k = a[1], q = a[2], z = a[3];
                    ...
                    _doReset: function () {
                        ...
                        for (var e = this._hash.words, o = e[0], n = e[1], s = e[2], i = e[3], a = e[4], f = e[5], u = e[6], l = e[7], _ = 0; _ < 64; _++) {
                            if (_ < 16) h[_] = 0 | r[t + _]; else {
                                var p = h[_ - 15], d = (p << 25 | p >>> 7) ^ (p << 14 | p >>> 18) ^ p >>> 3,
                                    v = h[_ - 2], H = (v << 15 | v >>> 17) ^ (v << 13 | v >>> 19) ^ v >>> 10;
                    ...
                    _doReset: function () {
                        ...
                        for (var o = this._hash.words, e = o[0], t = o[1], n = o[2], r = o[3], l = o[4], s = o[5], c = o[6], g = o[7], u = e.high, f = e.low, _ = t.high, v = t.low, d = n.high, p = n.low, H = r.high, y = r.low, x = l.high, S = l.low, A = s.high, m = s.low, B = c.high, b = c.low, k = g.high, q = g.low, z = u, W = f, j = _, C = v, D = d, F = p, J = H, M = y, P = x, R = S, X = A, E = m, G = B, I = b, K = k, L = q, N = 0; N < 80; N++) {
                            ...
                            if (N < 16) var Q = O.high = 0 | i[h + 2 * N], T = O.low = 0 | i[h + 2 * N + 1]; else {
                                var U = w[N - 15], V = U.high, Y = U.low,
                                    Z = (V >>> 1 | Y << 31) ^ (V >>> 8 | Y << 24) ^ V >>> 7,
                                    $ = (Y >>> 1 | V << 31) ^ (Y >>> 8 | V << 24) ^ (Y >>> 7 | V << 25), ii = w[N - 2],
                                    hi = ii.high, oi = ii.low,
                                    ei = (hi >>> 19 | oi << 13) ^ (hi << 3 | oi >>> 29) ^ hi >>> 6,
                                    ti = (oi >>> 19 | hi << 13) ^ (oi << 3 | hi >>> 29) ^ (oi >>> 6 | hi << 26),
                                    ni = w[N - 7], ri = ni.high, li = ni.low, ai = w[N - 16], wi = ai.high, si = ai.low;
                                Q = (Q = (Q = Z + ri + ((T = $ + li) >>> 0 < $ >>> 0 ? 1 : 0)) + ei + ((T = T + ti) >>> 0 < ti >>> 0 ? 1 : 0)) + wi + ((T = T + si) >>> 0 < si >>> 0 ? 1 : 0);
                                O.high = Q, O.low = T
                            }
                            var ci, gi = P & X ^ ~P & G, ui = R & E ^ ~R & I, fi = z & j ^ z & D ^ j & D,
                                _i = W & C ^ W & F ^ C & F,
                                vi = (z >>> 28 | W << 4) ^ (z << 30 | W >>> 2) ^ (z << 25 | W >>> 7),
                                di = (W >>> 28 | z << 4) ^ (W << 30 | z >>> 2) ^ (W << 25 | z >>> 7),
                                pi = (P >>> 14 | R << 18) ^ (P >>> 18 | R << 14) ^ (P << 23 | R >>> 9),
                                Hi = (R >>> 14 | P << 18) ^ (R >>> 18 | P << 14) ^ (R << 23 | P >>> 9), yi = a[N],
                                xi = yi.high, Si = yi.low, Ai = K + pi + ((ci = L + Hi) >>> 0 < L >>> 0 ? 1 : 0),
                                mi = di + _i;
    ...
    }, {"./core": "KOvs", "./x64-core": "aSfD", "./sha512": "fOEq"}],
                    ...
                    cfg: h.cfg.extend({outputLength: 512}), _doReset: function () {
                        ...
                        for (var n = 0; n < 24; n++) {
                            ...
                            for (g = 0; g < 5; g++) for (w = 0; w < 5; w++) {
                                var B = t[S = g + 5 * w], L = l[S], q = l[(g + 1) % 5 + 5 * w],
                                    W = l[(g + 2) % 5 + 5 * w];
                        ...
                        var r = this._data, t = r.words, e = (this._nDataBytes, 8 * r.sigBytes),
                            h = 32 * this.blockSize;
                ...
                var t = r, o = t.lib, n = o.WordArray, s = o.Hasher, a = t.algo,
                    ...
                    d = n.create([1352829926, 1548603684, 1836072691, 2053994217, 0]), l = a.RIPEMD160 = s.extend({
                        _doReset: function () {
                            ...
                            var s, a, l, H, M, P, R, g, m, x, B, E = this._hash.words, I = f.words, b = d.words,
                                j = c.words, k = i.words, q = u.words, z = h.words;
    ...
    "v95G": [function (require, module, exports) {
        var define;
        var e;
        !function (t, i) {
    ...
    }, {"./core": "KOvs", "./sha1": "NPgf", "./hmac": "v95G"}],
    "QDOL": [function (require, module, exports) {
        var define;
        var e;
        !function (t, r, i) {
    ...
    }, {"./core": "KOvs", "./cipher-core": "hULA"}],
    "paNp": [function (require, module, exports) {
        var define;
        var e;
        !function (r, o, t) {
            "object" == typeof exports ? module.exports = exports = o(require("./core"), require("./cipher-core")) : "function" == typeof e && e.amd ? e(["./core", "./cipher-core"], o) : o(r.CryptoJS)
    ...
    "aNpV": [function (require, module, exports) {
        var define;
        var e;
        !function (r, o, t) {
            "object" == typeof exports ? module.exports = exports = o(require("./core"), require("./cipher-core")) : "function" == typeof e && e.amd ? e(["./core", "./cipher-core"], o) : o(r.CryptoJS)
    ...
    "Sh1G": [function (require, module, exports) {
        var define;
        var e;
        !function (r, o, t) {
            "object" == typeof exports ? module.exports = exports = o(require("./core"), require("./cipher-core")) : "function" == typeof e && e.amd ? e(["./core", "./cipher-core"], o) : o(r.CryptoJS)
    ...
    "vket": [function (require, module, exports) {
        var define;
        var e;
        !function (o, r, c) {
    ...
    "YNBD": [function (require, module, exports) {
        var define;
        var e;
        !function (r, o, t) {
            "object" == typeof exports ? module.exports = exports = o(require("./core"), require("./cipher-core")) : "function" == typeof e && e.amd ? e(["./core", "./cipher-core"], o) : o(r.CryptoJS)
    ...
    "Xa8o": [function (require, module, exports) {
        var define;
        var e;
        !function (r, o, t) {
            ...
            return function () {
                var r = e, o = r.lib.BlockCipher, t = r.algo, i = [], c = [], n = [], s = [], u = [], f = [], h = [],
                    d = [], a = [], y = [];
                !function () {
    ...
    }, {"./core": "KOvs", "./enc-base64": "fV5T", "./md5": "Pylf", "./evpkdf": "QDOL", "./cipher-core": "hULA"}],
    ...
    "JEs2": [function (require, module, exports) {
        var define;
        var r;
        !function (e, i, t) {
                    ...
                    _doReset: function () {
                        ...
                        if (e) {
                            var c = e.words, s = c[0], a = c[1],
                                ...
                                b = n >>> 16 | 4294901760 & h, u = h << 16 | 65535 & n;
    ...
    "BXaB": [function (require, module, exports) {
        ...
        "./mode-cfb": "xYui",
        "./mode-ctr": "paNp",
        "./mode-ctr-gladman": "aNpV",
        "./mode-ofb": "Sh1G",
        "./mode-ecb": "vket",
        "./pad-ansix923": "cvA5",
        "./pad-iso10126": "LjAz",
        "./pad-iso97971": "tnw3",
        "./pad-zeropadding": "YNBD",
        "./pad-nopadding": "yjzY",
        "./format-hex": "myyq",
        "./aes": "Xa8o",
        "./tripledes": "Evye",
    ...
    "SVC2": [function (require, module, exports) {
            ...
            return c.prototype = {
                initialize: function (e, a) {
                    ...
                    for (var v = [{name: "AdobeAIR", regexp: /AdobeAIR\/([0-9.]*)/}, {
                        ...
                        name: "Odyssey",
                        regexp: /OWB\/([0-9.]*)/
                    }, {name: "OmniWeb", regexp: /OmniWeb/}, {name: "Orca", regexp: /Orca\/([0-9.]*)/}, {
                        name: "Origyn",
    ...
    "TSVj": [function (require, module, exports) {
        module.exports = require("./lib/ua-device.js");
    }, {"./lib/ua-device.js": "G8Un"}],
    "ybv9": [function (require, module, exports) {
        "use strict";
        ...
        var e = require("./SecretUtil"), r = require("ua-device"), a = function () {
            ...
            return a.ua = function (e) {
                ...
                var r = window.clientToken;
                if (!r) return !1;
                var t = e.SecretUtil.Decrypt(r).split("_");
                if (t.length < 3) return !1;
                if (-1 === a.partners.indexOf(t[0])) return !1;
                var o = new Date, n = new Date(Date.parse(t[2]));
                return !(n instanceof Date && o > n)
    ...
    }, {"./SecretUtil": "AKWS", "ua-device": "TSVj"}],
        ...
        var e = function () {
            ...
            return e.expiredTip = function (e) {
                if (!document.getElementById("illegalTip")) {
                    ...
                    var t = '<div id="illegalTip" style="position: absolute;z-index: 9999;width: 100%;height: 100%;background: #333333;margin: 0;padding: 0;font-size: 16px;color: #E0E0E0;text-align: center;line-height: 24px;display: -webkit-box;-webkit-box-orient: horizontal;-webkit-box-pack: center;-webkit-box-align: center;">教学资源使用授权已到期</br>请联系火花学院咨询授权事宜。</br>（tel：400-086-6662 ' + i + ' email：huohuaS@huohuaschool.com）</div>',
    ...
    "ny7m": [function (require, module, exports) {
        ...
        var e = require("devtools-detector"), t = require("./SecurityVerify"), i = require("./SecretUtil"),
            o = require("./SystemTip"), n = function () {
                function n() {
                    this.interval = 1e4, console.log("init security"), this.receiveParentMessage(), this.checkIsDevModel() ? console.log("当前是开发模式") : (this.condition = new Map, this.condition.set("token", t.SecurityVerify.token), self === top && (this.condition.set("ua", t.SecurityVerify.ua), this.condition.set("engine", t.SecurityVerify.engine)), this.devtoolsDetect(), this.timerThreshold() ? console.log("验证时间未开始") : this.verifyTimer())
                }
                ...
                return n.getInstance = function () {
                    ...
                    var e = new Date, t = e.getUTCFullYear() + "" + (e.getUTCMonth() + 1) + e.getDate();
                    try {
                        var o = location.hash.split("#"), n = i.SecretUtil.Decrypt(o[2] + "");
                        if ("dev" === o[1] && t === n) return !0
                    } catch (r) {
                    }
                    return !1
        ...
        exports.Security = n;
        window.SS = n;
    }, {"devtools-detector": "soli", "./SecurityVerify": "ybv9", "./SecretUtil": "AKWS", "./SystemTip": "iG0A"}]
}, {}, ["ny7m"], null)
//# sourceMappingURL=/Security.ef04551d.js.map