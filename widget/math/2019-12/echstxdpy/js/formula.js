...
function setCalcuState() {
  ...
  calculator.setExpression({
    ...
    "fillOpacity": 0.4,
    "hidden": true,
    "label": katex.renderToString('y=x') + '²',
  ...
  sliderOne = new slider({
    ...
    ondrag:(obj)=>{
      ...
      if (sliderNum === 0) {
        ...
        unTwiceFormulaTips.style.display = 'block';
        calculator.setExpression({
          "id": "formulaLine9",
          "latex": "y=0",
          "color": "#FF5A5A",
        ...
        if (numberA === 0 && numberB === 0) {
          ...
          calculator.setExpression({
            "id": "formulaLine4",
            "latex": "\\left(y-b\\right)=" + sliderNum + "\\left(x-a\\right)^2",
            "color": "#F5A623",
            "lineStyle": "SOLID",
            "type": "expression",
            "dragMode": "AUTO",
          ...
          if (sliderNum === 1) {
            calculator.setExpression({
              "id": "formulaLine5",
              "latex": "\\left(a+1," + sliderNum + "+b\\right)",
              "color": "#2d70b3",
              "lineStyle": "SOLID",
              "type": "expression",
              "dragMode": "NONE",
            ...
            calculator.setExpression({
              ...
              "fillOpacity": 0.4,
              "hidden": true,
              "label": katex.renderToString('y=') + sliderNum + katex.renderToString('x') + '²',
              "labelOrientation": "right",
              "labelSize": "large",
              "pointStyle": "POINT",
              "secret": false,
          ...
          if (numberB >= 0 && numberA >= 0) {
            calculator.setExpression({
              "id": "formulaLine5",
              "latex": "\\left(" + (numberA + 1) + "," + sliderNum + "+" + numberB + "\\right)",
              "color": "#2d70b3",
              "lineStyle": "SOLID",
              "type": "expression",
              "dragMode": "NONE",
              "fillOpacity": 0.4,
              "hidden": true,
              "label": katex.renderToString('y=') + sliderNum + katex.renderToString('(x-') + numberA + ')²+' + numberB,
              "labelOrientation": "right",
              "labelSize": "large",
              "pointStyle": "POINT",
              "secret": false,
...
function checkValueAB() {
  ...
  a.observe("numericValue", function() {
    ...
    if (numberA === 0 && numberB === 0) {
      calculator.setExpression({
        "id": "formulaLine4",
        "latex": "\\left(y-" + numberB + "\\right)=" + sliderNum + "\\left(x-" + numberA + "\\right)^2",
        "color": "#F5A623",
        "lineStyle": "SOLID",
        "type": "expression",
        "dragMode": "AUTO",
