...
function updateFunctionLine() {
    ...
    if (sliderNumOne == 0) {
        ...
        isShowSymmetryAxis = true;
    }


    if (isShowSymmetryAxis) {
        calculator.setExpression({
            id: "formulaLine4",
            latex: "x\\ =\\ -h",
            color: "#FF5A5A",
        ...
        calculator.setExpression({
            id: "formulaLine5",
            labelSize: 'large',
            latex: "\\left(-h,\\ -3\\right)",
            color: "#FF5A5A",
            dragMode: "NONE",
            hidden: true,
           label: katex.renderToString("x = " + (-sliderNumTwo)),
    ...
    calculator.setExpression({
        id: "formulaLine6",
        labelSize: 'large',
        latex: "\\left(-h,\\ k\\right)",
        color: "#FF5A5A",
        dragMode: "NONE",
        hidden: !isShowSymmetryAxis,
        label: "",
        labelOrientation: "right",
        labelSize: "medium",
        pointStyle: "POINT",
    ...
    calculator.setExpression({
        id: "formulaLine7",
        labelSize: 'large',
        latex: "\\left(-h,\\ k-0.1\\right)",
        color: "#000000",
        dragMode: "NONE",
        hidden: true,
        label:  katex.renderToString("A(" + -sliderNumTwo + "," + sliderNumThree +")"),
        labelOrientation: "below",
        labelSize: "medium",
        pointStyle: "POINT",
        secret: false,
        showLabel: isShowSymmetryAxis,
        verticalLabel: false
    });
