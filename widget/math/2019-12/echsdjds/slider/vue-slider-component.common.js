  ...
  control_createClass(Control, [{
    ...
    get: function get() {
      ...
      dotsPos.forEach(function (pos, i) {
        valuePosRange.push([Math.max(_this8.minRange ? _this8.minRangeDir * i : 0, !_this8.enableCross ? dotsPos[i - 1] || 0 : 0), Math.min(_this8.minRange ? 100 - _this8.minRangeDir * (dotsPos.length - 1 - i) : 100, !_this8.enableCross ? dotsPos[i + 1] || 100 : 100)]);
      });
...
function (_Vue) {
  ...
  vue_slider_createClass(VueSlider, [{
    ...
    value: function initControl() {
      ...
      ['data', 'enableCross', 'fixed', 'max', 'min', 'interval', 'minRange', 'maxRange', 'order', 'marks', 'process', 'adsorb', 'included'].forEach(function (name) {
    ...
    get: function get() {
      ...
      return {
        padding: this.isHorizontal ? "".concat(dotHeight / 2, "px 0") : "0 ".concat(dotWidth / 2, "px"),
