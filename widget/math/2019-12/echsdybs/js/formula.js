...
var sliderNumOne = 1;
var sliderNumTwo = 2;
var sliderNumThree = -3;

var sliderNumOneText = 1;
var sliderNumTwoText = 2;
var sliderNumThreeText = '(-3)';
...
function updateFunctionLine() {
    ...
    calculator.setExpression({
        id: "formulaLine5",
        labelSize: 'large',
        latex: "\\left(\\frac{b}{-2a},\\ -3\\right)",
        color: "#FF5A5A",
        dragMode: "NONE",
        hidden: true,
        label: katex.renderToString("x = " + ((-sliderNumTwo) / (2 * sliderNumOne)).toFixed(2)),
        labelOrientation: "right",
        labelSize: "medium",
        pointStyle: "POINT",
