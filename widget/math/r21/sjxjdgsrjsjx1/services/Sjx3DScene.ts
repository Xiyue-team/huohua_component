...
import { Sjx3DModel } from './Sjx3DModel';
...
export class Sjx3DScene extends ThreeBase {
    private controls: any;

    coneCurve3DModel: Sjx3DModel;
    ...
    init3DModel() {
      this.coneCurve3DModel = new Sjx3DModel(this.scene, this.camera, this.renderer);
    }
