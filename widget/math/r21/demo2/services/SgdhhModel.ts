...
export class SgdhhModel extends ThreeBase { 
    ...
    private cola2 = common.createImg([200, 70 , 0], 26, 26, cola);
    private coffee2 = common.createImg([200, 30 , 0], 26, 26, juice);
    ...
    private cola11 = common.createImg([200, 70 , 0], 26, 26, cola);
    private coffee11 = common.createImg([200, 30 , 0], 26, 26, juice);
    private hamburger11 = common.createImg([200, -10 , 0], 26, 26, hamburger);
    private pizza11 = common.createImg([200, -50 , 0], 26, 26, pizza);
    private sandwich11 = common.createImg([200, -90 , 0], 26, 26, sandwich);
    ...
    init() {
        ...
        this.group.push(this.cola, this.coffee, this.hamburger, this.pizza, this.sandwich,
            this.hamburger1, this.pizza1, this.sandwich1, this.cola1, this.cola2, this.coffee1, this.coffee2);
        this.group1.push(this.cola11, this.coffee11, this.hamburger11, this.pizza11, this.sandwich11);
    ...
    initElement() {
        ...
        this.scene.add(this.cola, this.coffee, this.hamburger, this.pizza, this.sandwich,
             this.plane, this.hamburger1, this.pizza1, this.sandwich1, this.foodGroup, this.cola1, this.cola2, this.coffee1, this.coffee2);
    }
    // 初始化拖动点
    initEvt() {
        this.sliderControlLine = new SliderControlLine(
            [this.cola, this.coffee, this.hamburger, this.pizza, this.cola1, this.cola2, this.coffee1, this.coffee2,
