...
import { Jpfxdxz3DModel } from './Jpfxdxz3DModel';
const OBJLoader = require('three-obj-loader');
const TrackballControls = require('three-trackballcontrols');
const Interaction = require('three.interaction');
OBJLoader(THREE);

export class Jpfxdxz3DScene extends ThreeBase {
    private controls: any;

    coneCurve3DModel: Jpfxdxz3DModel;
    ...
    initCamera(): void {
      ...
      if ((window as any)['env'].browserInfo.isIpad) {
        ...
        scale = window.screen.width / 180;
      } else if ((window as any)['env'].browserInfo.isPC) {
        scale = window.innerWidth / 270;
      } else {
    ...
    init3DModel() {
      this.coneCurve3DModel = new Jpfxdxz3DModel(this.scene, this.camera, this.renderer);
    }
