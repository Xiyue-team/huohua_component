...
import * as cola from '../sub_static/2.png';
import * as hamburger from '../sub_static/4.png';
import * as juice from '../sub_static/1.png';
import * as pizza from '../sub_static/3.png';
import * as sandwich from '../sub_static/5.png';
...
export class SgdhhModel extends ThreeBase { 
    ...
    private cola = common.createImg([200, 70 , 0], 31.4, 15, cola);
    private coffee = common.createImg([200, 30 , 0], 31.4, 15, juice);
    private hamburger = common.createImg([200, -10 , 0], 31.4, 15, hamburger);
    private pizza = common.createImg([200, -50 , 0], 31.4, 15, pizza);
    private sandwich = common.createImg([200, -90 , 0], 31.4, 15, sandwich);
    private hamburger1 = common.createImg([200, -10 , 0], 31.4, 15, hamburger);
    private pizza1 = common.createImg([200, -50 , 0], 31.4, 15, pizza);
    private sandwich1 = common.createImg([200, -90 , 0], 31.4, 15, sandwich);

    private cola11 = common.createImg([200, 70 , 0], 31.4, 15, cola);
    private coffee11 = common.createImg([200, 30 , 0], 31.4, 15, juice);
    private hamburger11 = common.createImg([200, -10 , 0], 31.4, 15, hamburger);
    private pizza11 = common.createImg([200, -50 , 0], 31.4, 15, pizza);
    private sandwich11 = common.createImg([200, -90 , 0], 31.4, 15, sandwich);
    ...
    init() {
        ...
        this.group1.push(this.hamburger1, this.pizza1, this.sandwich1, 
            this.cola11, this.coffee11, this.hamburger11, this.pizza11, this.sandwich11);
    ...
    initElement() {
        ...
        this.foodGroup.add(this.cola11, this.coffee11, this.hamburger11, this.pizza11, this.sandwich11);
        for (let i = 0; i < 5; i++) {
        ...
        this.selectobjs.push(this.cola, this.coffee, this.hamburger, this.pizza, this.sandwich,
             this.hamburger1, this.pizza1, this.sandwich1);
        this.scene.add(this.cola, this.coffee, this.hamburger, this.pizza, this.sandwich,
             this.plane, this.hamburger1, this.pizza1, this.sandwich1, this.foodGroup);
    }
    // 初始化拖动点
    initEvt() {
        this.sliderControlLine = new SliderControlLine(
            [this.cola, this.coffee, this.hamburger, this.pizza,
                 this.sandwich, this.hamburger1, this.pizza1, this.sandwich1]).initEvent(this.camera, this.renderer);
    }
    ...
    getMousePos1(MousePointX: number, MousePointY: number,  domWidth: number, domHeight: number): Vector2 {
      ...
      onDocumentMousedown(event: any) { 
        ...
        if (intersects2.length > 0) {
            ...
            thiz.scene.remove(thiz.selectline);
      ...
      onDocumentMouseUp(event: any) { 
        ...
        if (thiz.make && thiz.mousup_pos.x < -thiz.pos.x - 60 && dis > 10) {
               ...
               thiz.i++;
            //    thiz.scene.remove(thiz.lineGroup); 
    ...
    resetPos() {
        ...
        this.hamburger1.position.set(200, -10 , 0);
        this.pizza1.position.set(200, -50 , 0);
        this.sandwich1.position.set(200, -90 , 0);
    }
