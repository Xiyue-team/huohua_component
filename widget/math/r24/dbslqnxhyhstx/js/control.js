    ...
    function initSlider(){
        ...
        sliderTwo = new slider({
            ...
            ondrag:(obj)=>{
                ...
                if(obj.values[0] <= 0 || obj.values[0] === 1){
                    resetFormulaBtn();
                    if(obj.values[0] === 0){
                        setPointDisable(0);
                    }else{
    ...
    //设置公式
    function setFormula(){ 
        var value = -(sliderNumOne / (1 - sliderNumTwo));
        ...
        var formulaString = param + '\\times'+ sliderNumTwo +'^x' + formulaSymbol + Math.abs(param);
    ...
    function initDesmos(){
        ...
        if(window.innerHeight < 610 || window.innerWidth <610){
            ...
            formulaDetail.style.height  = parseInt(200 * scale * 1 / 2)  + 'px';
            formulaDetail.style.left    = parseInt(80 * scale)  + 'px';

            formulaBtn.style.transform  = 'scale('+ scale + ')';
            formulaBtn.style.bottom     = parseInt(-formulaBtn.clientHeight * (1- scale) / 2 + (200 * scale * 1 / 4))  + 'px';
    ...
    function createFormulaLine() {
        //函数1
        calculator.setExpression({id: "formula1",latex: "y=-\\frac{a}{1-q}q^{x\\ \\ }+\\frac{a}{1-q}",color: "#9BF23B",hidden:true});
        //滑条a
		    calculator.setExpression({id: "formula2",latex: "a=-1",sliderBounds: { min: "-10", max: "10", step: "0.1" }});
		    //滑条q
		    calculator.setExpression({id: "formula3",latex: "q=0.5",sliderBounds: { min: "-5", max: "5", step: "0.1" }});
        //函数1的点1'
		    calculator.setExpression({id: "point1",color: "#fff",latex: "\\left(1,-\\frac{a}{1-q}q+\\frac{a}{1-q}\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: false,showLabel: false});
		    //函数1的点2'
		    calculator.setExpression({id: "point2",color: "#fff",latex: "\\left(2,-\\frac{a}{1-q}q^2+\\frac{a}{1-q}\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点3'
		    calculator.setExpression({id: "point3",color: "#fff",latex: "\\left(3,-\\frac{a}{1-q}q^3+\\frac{a}{1-q}\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点4'
		    calculator.setExpression({id: "point4",color: "#fff",latex: "\\left(4,-\\frac{a}{1-q}q^4+\\frac{a}{1-q}\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点5'
		    calculator.setExpression({id: "point5",color: "#fff",latex: "\\left(5,-\\frac{a}{1-q}q^5+\\frac{a}{1-q}\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点6'
		    calculator.setExpression({id: "point6",color: "#fff",latex: "\\left(6,-\\frac{a}{1-q}q^6+\\frac{a}{1-q}\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点7'
		    calculator.setExpression({id: "point7",color: "#fff",latex: "\\left(7,-\\frac{a}{1-q}q^7+\\frac{a}{1-q}\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点8'
		    calculator.setExpression({id: "point8",color: "#fff",latex: "\\left(8,-\\frac{a}{1-q}q^8+\\frac{a}{1-q}\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点9'
		    calculator.setExpression({id: "point9",color: "#fff",latex: "\\left(9,-\\frac{a}{1-q}q^9+\\frac{a}{1-q}\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点10'
		    calculator.setExpression({id: "point10",color: "#fff",latex: "\\left(10,-\\frac{a}{1-q}q^{10}+\\frac{a}{1-q}\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
    }
    ...
    function initEvent(){
        formulaBtn.addEventListener("click",(event)=>{
            if(sliderNumTwo >0 &&  sliderNumTwo != 1){
              isClick = !isClick;
            }

			      if(isClick && sliderNumTwo >0 &&  sliderNumTwo != 1){
