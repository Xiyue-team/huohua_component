    ...
    //设置公式
    function setFormula(){ 
        var value1 = sliderNumTwo;
        var value2 = sliderNumOne - sliderNumTwo;
        var param2 = Math.round(value2 * 10) / 10;
        var formulaSymbol = '';

        if(param2 > 0 && value1 != 0){
            formulaSymbol = '+';
        }

        var formulaString1 = value1 + 'x';
        var formulaString2 = formulaSymbol + param2;
	  ...
	  function initDesmos(){
        ...
        if(window.innerHeight < 610 || window.innerWidth <610){
            ...
            sequenceImage.style.height  = parseInt(rightWidth * (61 / 282)) + 'px';
            sequenceImage.style.bottom  = parseInt(100 * scale) + 'px';
            formulaDetail.style.width   = parseInt(150 * scale) + 'px';
            formulaDetail.style.height  = parseInt(150 * scale * 8 / 15)  + 'px';
            formulaDetail.style.left    = parseInt(80 * scale)  + 'px';
            formulaDetail.children[0].style.width = parseInt(150 * scale * 80 / 150 * (3 / 2))  + 'px';

            
            formulaBtn.style.transform  = 'scale('+ scale + ')';
            formulaBtn.style.bottom     = parseInt(-formulaBtn.clientHeight * (1- scale) / 2 + (150 * scale * 8 / 30))  + 'px';
            formulaBtn.style.left       = parseInt(-formulaBtn.clientWidth * (1- scale) / 2 ) + 'px';

            formualInput.style.fontSize = parseInt(16 * scale) + 'px';
    ...
    function createFormulaLine() {
        //函数1
        calculator.setExpression({id: "formula1",latex: "y=dx+a-d",color: "#9BF23B",hidden:true});
        //滑条a
            ...
            //函数1的点1'
		    calculator.setExpression({id: "point1",color: "#fff",latex: "\\left(1,1d+a-d\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: false,showLabel: false});
		    //函数1的点2'
		    calculator.setExpression({id: "point2",color: "#fff",latex: "\\left(2,2d+a-d\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点3'
		    calculator.setExpression({id: "point3",color: "#fff",latex: "\\left(3,3d+a-d\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点4'
		    calculator.setExpression({id: "point4",color: "#fff",latex: "\\left(4,4d+a-d\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点5'
		    calculator.setExpression({id: "point5",color: "#fff",latex: "\\left(5,5d+a-d\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点6'
		    calculator.setExpression({id: "point6",color: "#fff",latex: "\\left(6,6d+a-d\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点7'
		    calculator.setExpression({id: "point7",color: "#fff",latex: "\\left(7,7d+a-d\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点8'
		    calculator.setExpression({id: "point8",color: "#fff",latex: "\\left(8,8d+a-d\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点9'
		    calculator.setExpression({id: "point9",color: "#fff",latex: "\\left(9,9d+a-d\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
		    //函数1的点10'
		    calculator.setExpression({id: "point10",color: "#fff",latex: "\\left(10,10d+a-d\\right)",pointStyle: "POINT",dragMode: "NONE",hidden: true,showLabel: false});
    }
