...
export default class CommonForThree {
    ...
    static drawDashOrLine(pointArr: any, {
        ...
        const line = this.dashLine.addLine(pointArr, color, width * 1000, false);
        return line;
    }
    ...
    static getVecPos(startPos: Array<number>, endPos: Array<number>, xishu = 10) {
    ...
    static getCirclePos(radius: number, len = 10) {
        const pos = [0, 0, 0];
    ...
    static lineAni(startPos: Array<number>, endPos: Array<number>, line: THREE.Mesh, arrow?: THREE.Mesh) {
        return new Promise((resolve, reject) => {
            ...
            function ani() {
                ...
                arrow && arrow.position.set(vecPos[0],vecPos[1],vecPos[2]);
                num += 0.02;
                if (num > 1) {
