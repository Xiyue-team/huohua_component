...
import { Pwxddy3DModel } from './Pwxddy3DModel';
const OBJLoader = require('three-obj-loader');
const TrackballControls = require('three-trackballcontrols');
const Interaction = require('three.interaction');
OBJLoader(THREE);

export class Pwxddy3DScene extends ThreeBase {
    private controls: any;

    pwxddy3DModel: Pwxddy3DModel;
    ...
    init3DModel() {
      this.pwxddy3DModel = new Pwxddy3DModel(this.scene, this.camera, this.renderer);
    }

    reset() {
        this.pwxddy3DModel.reset();
    }
}
