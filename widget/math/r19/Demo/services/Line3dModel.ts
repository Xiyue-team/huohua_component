...
import * as leftL1 from '../sub_static/L1@3x.png';
import * as rightL2 from '../sub_static/L2@3x.png';
import * as ParabolaZhunXianBiaoShi from '../sub_static/L@3x.png';
import * as ParabolaZhunXianBiaoShiY from '../sub_static/Ly轴@3x.png';
import { ThreeUtil } from '../../../../../src/three/util/ThreeUtil';

import * as tuotuan1 from '../sub_static/方程1@3x.png';
import * as tuoyuan2 from '../sub_static/方程2@3x.png';
import * as shuangquxian1 from '../sub_static/方程4@3x.png';
import * as shuangquxian2 from '../sub_static/方程4.png';
import * as puwuixan2 from '../sub_static/焦半径方程1@3x.png';
import * as puwuixan1 from '../sub_static/焦半径方程式2@3x.png';
import * as puwuixan3 from '../sub_static/焦半径方程式3@3x.png';
import * as P from '../sub_static/P(m,n)@3x.png';
...
export class Line3dModel extends ThreeBase {
  ...
  private EllipseCurve = common.drawEllipseCurve(50, 30, { color: '#000000' });
  ...
  private lineBeas = common.drawUnitLine({ width: 0.8, color: '#0199FF' });
  private lineArr: any = [];
  ...
  initCamera(): void {
    ...
    this.camera.position.set(45, 0, 270);
  }
  ...
  initLine() {
    let lineonea: any;
    for (let i = 0; i < 12; i++) {
      lineonea = this.lineBeas.clone();
      this.lineArr.push(lineonea);
    }
  }
  //创建一个坐标系
  createAxis() {
  ...
  initModel() {
    ...
    // const m = new THREE.MeshBasicMaterial({color: '#000'});
    // const M = new THREE.Mesh(geometry, m);
    // this.scene.add(M);
    const obj = new THREE.Group();
                    //TODO 线条
                    const line1 = common.scaleLine([-201, 201, -201], [-201, 201, 201], this.lineArr[0]);
                    const line2 = common.scaleLine([-201, 201, -201], [201, 201, -201], this.lineArr[1]);
                    const line3 = common.scaleLine([201, 201, -201], [201, 201, 201], this.lineArr[2]);
                    const line4 = common.scaleLine([-201, 201, 201], [201, 201, 201], this.lineArr[3]);
                    const line5 = common.scaleLine([-201, 201, 201], [-201, -201, 201], this.lineArr[4]);
                    const line6 = common.scaleLine([201, 201, 201], [201, -201, 201], this.lineArr[5]);
                    const line7 = common.scaleLine([201, 201, -201], [201, -201, -201], this.lineArr[6]);
                    const line8 = common.scaleLine([201, -201, -201], [201, -201, 201], this.lineArr[7]);
                    const line9 = common.scaleLine([-201, -201, 201], [201, -201, 201], this.lineArr[8]);
                    const line10 = common.scaleLine([-201, 201, -201], [-201, -201, -201], this.lineArr[9]);
                    const line11 = common.scaleLine([-201, -201, -201], [-201, -201, 201], this.lineArr[10]);
                    const line12 = common.scaleLine([-201, -201, -201], [201, -201, -201], this.lineArr[11]);
