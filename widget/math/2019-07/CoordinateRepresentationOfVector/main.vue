  ...
  <div class="aspectration bg_white root_div_container" data-ratio="16:9">
    <fullScreensLayout>
      <template slot="viewBox">
        ...
        <div class="buttonG">
          <div class="button_style1" @click="ButtonEvent()">
            <buttonPrimary
              style="width: 100%"
              v-bind:title="buttonTitle"
              v-bind:actived="buttonActived"
              type="ellipse"
            ></buttonPrimary>
          </div>
          <div class="button_style2" @click="ButtonEvent2()">
            <buttonPrimary
              style="width: 100%"
              v-bind:title="buttonTitle2"
              v-bind:actived="buttonActived2"
              type="ellipse"
            ></buttonPrimary>
          </div>
        </div>
        <div id="tip" :style="`background-image: url(${pictip})`"></div>
      </template>
