                ...
                <v-stage :config='configStage'>
                  <v-layer :config='configLayer'>
                    ...
                    <v-text :config='{x:configLine1.points[2] - 100,y:configLine1.points[3],
                        text: "3x + 2y - 9 = 0", fontFamily:"Times New Roman",
                        fill: "#8BC052", fontSize: 15,fontStyle:"italic"}' />
                    <v-arrow :config="{
                    ...
                    <v-text :config='{x:configLine2.points[2] - 70,y:configLine2.points[3],text: "x - y + 2 = 0",
                    ...
                    <v-text :config='{x:configLine3.points[2],y:configLine3.points[3],text: "2x + 3y -6 = 0",
                        fill: "#5F9BEE", fontSize: 15,fontStyle:"italic",fontFamily:"Times New Roman",}' />
                    <v-arrow :config="{
                    ...
                    <v-text :config='{x:circle1.x-20,y:circle1.y,fontSize: 15,text:"A",fontStyle:"italic"}'/>
                    <v-circle :config='circle2'/>
                    <v-text :config='{x:circle2.x-20,y:circle2.y,fontSize: 15,text:"C",fontStyle:"italic"}'/>
                    ...
                    <!-- 虚线 -->
                    <v-line :config='dotLine' />
                    <v-image :config='dragDot'
