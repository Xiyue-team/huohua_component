    ...
    (function() {
        ...
        function initStyle(){
            //初始化题目的高度
            var height = window.innerWidth * (276 / 1200 );
            topicContent.children[0].style.height = height + 'px';   
            topicContent.children[0].style.marginTop = window.innerHeight * 0.14 + 'px'; 
            //初始化解析模板每张图片的高度
            ...
            vueElement = new Vue({
                ...
                data: {
                    switchOption:{
                        datas: [switchDataText[0], switchDataText[1],switchDataText[2],switchDataText[3]]
                    },
        ...
        function adapterDesmos(){
            ...
            if(window.innerHeight < 610 || window.innerWidth < 610){   
                ...
                for(var index=11; index< calculator.getExpressions().length; index++){     
        ...
        function initSlider(){
            sliderOne = new slider({
                ...
                ondrag:(obj)=>{
                    ...
                    calculator.setExpression({id:'point3', hidden:(sliderNumOne != -0.5), showLabel: (sliderNumOne === -0.5)});
                },
                fixValue:true,
            });
        }
        ...
        function createFormulaLine() {  
            ...
            //函数区域1
            calculator.setExpression({id: "area1",color: "#FF5A5A",latex: "x+y-2\\ge0",hidden: false,});
            //函数区域2
            calculator.setExpression({id: "area2",color: "#8BC052",latex: "y\\ge0",hidden: false,});
            //函数区域3
            calculator.setExpression({id: "area3",color: "#00AAFF",latex: "kx-y+2\\ge0",hidden: false,});
            //函数区域4
            calculator.setExpression({id: "area4",color: "#ffffff",latex: "2-x<=y<=kx+2\\left\\{0<x<2\\right\\}",});
            //函数区域4
            calculator.setExpression({id: "area5",color: "#ffffff",latex: "0<=y<=kx+2\\left\\{x>2\\right\\}",});
            //函数区域4
            calculator.setExpression({id: "area6",color: "#ffffff",latex: "2-x<=y<=kx+2\\left\\{x<0\\right\\}",});
        
            //函数1
            calculator.setExpression({id: "function1",color: "#FF5A5A",latex: "x+y-2=0",lineStyle: "SOLID", hidden:false});
            //函数2
            calculator.setExpression({id: "function2",color: "#8BC052",latex: "y=0",lineStyle: "SOLID", hidden:false});
            //函数3
            calculator.setExpression({id: "function3",color: "#00AAFF",latex: "kx-y+2=0",lineStyle: "SOLID", hidden:false});
            //函数4
            calculator.setExpression({id: "function4",color: "#AC84FF",latex: "x-4=y",lineStyle: "SOLID", hidden:false});

            //公式点1
            calculator.setExpression({id: "functionPoint1",color: "#FF5A5A",latex: "\\left(-4.2,5\\right)",label:katex.renderToString('x+y-2=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点2
            calculator.setExpression({id: "functionPoint2",color: "#8BC052",latex: "\\left(-2,-0.6\\right)",label:katex.renderToString('y=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点3
            calculator.setExpression({id: "functionPoint3",color: "#00AAFF",latex: "\\left(3,2k+2\\right)",label:katex.renderToString('kx-y+2=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点4
            calculator.setExpression({id: "functionPoint4",color: "#AC84FF",latex: "\\left(6,1\\right)",label:katex.renderToString('x-4=y', {throwOnError: false}),hidden:true,showLabel: true});

            //圆点1
            calculator.setExpression({id: "point1",color: "#fff",latex: "\\left(0,2\\right)",label:katex.renderToString('A(0,2)', {throwOnError: false}),hidden:false,showLabel: true});
            //圆点2
            calculator.setExpression({id: "point2",color: "#fff",latex: "\\left(2,0\\right)",label:katex.renderToString('B(2,0)', {throwOnError: false}),hidden:false,showLabel: true});
            //圆点2
            calculator.setExpression({id: "point3",color: "#fff",latex: "\\left(4,0\\right)",label:katex.renderToString('C(4,0)', {throwOnError: false}),hidden:true,showLabel: false});
        }
