    ...
    (function() {
        ...
        function initStyle(){
            //初始化题目的高度
            var height = window.innerWidth * (265 / 1200 );
        ...
        function adapterDesmos(){
            ...
            if(window.innerHeight < 610 || window.innerWidth < 610){   
                ...
                for(var index=10; index< calculator.getExpressions().length; index++){     
        ...
        function initSlider(){
            sliderOne = new slider({
                ...
                ondrag:(obj)=>{
                    ...
                    calculator.setExpression({id:'area4', hidden:(sliderNumOne <= -1)});
                    if(sliderNumOne === 1){
                        calculator.setExpression({id: "point2",label:katex.renderToString('B(0,2)', {throwOnError: false})});
                        calculator.setExpression({id: "point3",label:katex.renderToString('C(\\frac{-2}3,\\frac{4}3)', {throwOnError: false})});
                    }else {
                        calculator.setExpression({id: "point2",label:katex.renderToString('B(1-m,m+1)', {throwOnError: false})});
                        calculator.setExpression({id: "point3",label:katex.renderToString('C(\\frac{2-4m}3,\\frac{2+2m}3)', {throwOnError: false})});
                    }    
                },
                fixValue:true,
            });
        ...
        function createFormulaLine() {  
            //滑条
            calculator.setExpression({id: "slider1",latex: "m=2",sliderBounds: { min: "-10", max: "10", step: "0.1" }});
        
            //函数区域1
            calculator.setExpression({id: "area1",color: "#FF5A5A",latex: "x+y-2\\le0",hidden: false,});
            //函数区域2
            calculator.setExpression({id: "area2",color: "#00AAFF",latex: "x+2y-2\\ge0",hidden: false,});
            //函数区域3
            calculator.setExpression({id: "area3",color: "#9BF23B",latex: "x-y+2m\\ge0",hidden: false,});
            //函数区域4
            calculator.setExpression({id: "area4",color: "#ffffff",latex: "\\operatorname{polygon}\\left(D,E,\\left(2,0\\right)\\right)",});
        
            //函数1
            calculator.setExpression({id: "function1",color: "#FF5A5A",latex: "x+y-2=0",lineStyle: "SOLID", hidden:false});
            //函数2
            calculator.setExpression({id: "function2",color: "#00AAFF",latex: "x+2y-2=0",lineStyle: "SOLID", hidden:false});
            //函数3
            calculator.setExpression({id: "function3",color: "#9BF23B",latex: "x-y+2m=0",lineStyle: "SOLID", hidden:false});
            //函数4 (直角)
            calculator.setExpression({id: "function4",color: "#FF5A5A",latex: "\\operatorname{polygon}\\left(B,A\\right)",fill: false,hidden:false});
            //函数5 (直角)
            calculator.setExpression({id: "function5",color: "#FF5A5A",latex: "\\operatorname{polygon}\\left(A,C\\right)",fill: false,hidden:false});

            //直角点A
            calculator.setExpression({id: "anglePoint1",color: "#fff",latex: "A=\\left(1-m,m+0.6\\right)",dragMode: "NONE",hidden:true});
            //直角点B
            calculator.setExpression({id: "anglePoint2",color: "#fff",latex: "B=\\left(0.8-m,m+0.8\\right)",dragMode: "NONE",hidden:true});
            //直角点C
            calculator.setExpression({id: "anglePoint3",color: "#fff",latex: "C=\\left(1.2-m,m+0.8\\right)",dragMode: "NONE",hidden:true});

            //公式点1
            calculator.setExpression({id: "functionPoint1",color: "#FF5A5A",latex: "\\left(-2,5\\right)",label:katex.renderToString('x+y-2=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点2
            calculator.setExpression({id: "functionPoint2",color: "#00AAFF",latex: "\\left(5.5,-1\\right)",label:katex.renderToString('x+2y-2=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点3
            calculator.setExpression({id: "functionPoint3",color: "#9BF23B",latex: "\\left(-5,-6+2m\\right)",label:katex.renderToString('x-y+2m=0', {throwOnError: false}),hidden:true,showLabel: true});

            //圆点1
            calculator.setExpression({id: "point1",color: "#fff",latex: "\\left(2,0\\right)",label:katex.renderToString('A(2,0)', {throwOnError: false}),hidden:false,showLabel: true});
            //圆点2
            calculator.setExpression({id: "point2",color: "#fff",latex: "D=\\left(1-m,m+1\\right)",label:katex.renderToString('B(1-m,m+1)', {throwOnError: false}),dragMode: "NONE",hidden:false,showLabel: true});
            //圆点3
            calculator.setExpression({id: "point3",color: "#fff",latex: "E=\\left(\\frac{2-4m}{3},\\frac{2+2m}{3}\\right)",
                                    label:katex.renderToString('C(\\frac{2-4m}3,\\frac{2+2m}3)', {throwOnError: false}),dragMode: "NONE",hidden:false,showLabel: true});
