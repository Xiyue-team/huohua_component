    ...
    (function() {
        ...
        function initStyle(){
            ...
            for(var index=0; index < leftContainer.children.length - 1; index++){
                ...
                leftContainer.children[index].style.marginTop = window.innerHeight * 0.02 + 'px';
            } 
            //desmos文字适配小屏尺寸
            if(window.innerHeight < 610 || window.innerWidth < 610){   
                var state = calculator.getState();
                for(var index=8; index< calculator.getExpressions().length; index++){     
        ...
        function initSlider(){
            sliderOne = new slider({
                ...
                ondrag:(obj)=>{
                    ...
                    var string = 'k=' + obj.values[0];
                    calculator.setExpression({id:'slider1', latex: string});
                    if(sliderNumOne === -10.1 || sliderNumOne === 10.1){
                        document.querySelector('.r-slider-number').innerHTML = slopeText;
                        calculator.setExpression({id: "function4",latex: "x=0"});
                        calculator.setExpression({id: "functionPoint4",label:katex.renderToString('x=0', {throwOnError: false}),hidden:true,showLabel: true});
                    } else {
                        calculator.setExpression({id: "function4",latex: "12=kx+y"});
                        calculator.setExpression({id: "functionPoint4",label:katex.renderToString('kx+y-12=0', {throwOnError: false}),});
                    }
                },
                fixValue:true,
            });
        ...
        function initButtonText(){ 
            ...
            slopeText = window.lang.slopeText;
        }
        ...
        function createFormulaLine() {  
            //滑条
            calculator.setExpression({id: "slider1",latex: "k=2",sliderBounds: { min: "-10", max: "10", step: "0.1" }});
        
            //函数区域1
            calculator.setExpression({id: "area1",color: "#AC84FF",latex: "x+y-2\\ge0",hidden: false,});
            //函数区域2
            calculator.setExpression({id: "area2",color: "#8BC052",latex: "2x-y-4\\le0",hidden: false,});
            //函数区域3
            calculator.setExpression({id: "area3",color: "#00AAFF",latex: "x-2y+4\\ge0",hidden: false,});
            //函数区域4
            calculator.setExpression({id: "area4",color: "#ffffff",latex: "\\operatorname{polygon}\\left(\\left(2,0\\right),\\left(4,4\\right),\\left(0,2\\right)\\right)",});
        
            //函数1
            calculator.setExpression({id: "function1",color: "#AC84FF",latex: "x+y-2=0",lineStyle: "SOLID", hidden:false});
            //函数2
            calculator.setExpression({id: "function2",color: "#8BC052",latex: "2x-y-4=0",lineStyle: "SOLID", hidden:false});
            //函数3
            calculator.setExpression({id: "function3",color: "#00AAFF",latex: "x-2y+4=0",lineStyle: "SOLID", hidden:false});
            //函数4
            calculator.setExpression({id: "function4",color: "#FF5A5A",latex: "12=kx+y",lineStyle: "SOLID", hidden:false});

            //公式点1
            calculator.setExpression({id: "functionPoint1",color: "#AC84FF",latex: "\\left(-5,6\\right)",label:katex.renderToString('x+y-2=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点2
            calculator.setExpression({id: "functionPoint2",color: "#8BC052",latex: "\\left(6,6.5\\right)",label:katex.renderToString('2x-y-4=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点3
            calculator.setExpression({id: "functionPoint3",color: "#00AAFF",latex: "\\left(8.3,5\\right)",label:katex.renderToString('x-2y+4=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点4
            calculator.setExpression({id: "functionPoint4",color: "#FF5A5A",latex: "\\left(2,12-3k\\right)",label:katex.renderToString('kx+y-12=0', {throwOnError: false}),hidden:true,showLabel: true});

            //圆点1
            calculator.setExpression({id: "point1",color: "#fff",latex: "\\left(2,0\\right)",label:katex.renderToString('C(2,0)', {throwOnError: false}),hidden:false,showLabel: true});
            //圆点2
            calculator.setExpression({id: "point2",color: "#fff",latex: "\\left(4,4\\right)",label:katex.renderToString('A(4,4)', {throwOnError: false}),hidden:false,showLabel: true});
            //圆点3
            calculator.setExpression({id: "point3",color: "#fff",latex: "\\left(0,2\\right)",label:katex.renderToString('B(0,2)', {throwOnError: false}),hidden:false,showLabel: true});
        }
