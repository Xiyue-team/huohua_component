     ...
     (function() {
        ...
        function initStyle(){
            ...
            for(var index=0; index < leftContainer.children.length - 1; index++){
                leftContainer.children[index].style.height = window.innerWidth * 0.38 * (350 / 460) + 'px';
        ...
        function createFormulaLine() {  
            ...
            //函数区域1
            calculator.setExpression({id: "area1",color: "#00AAFF",latex: "x-y+2\\ge0",hidden: false,});
            //函数区域2
            calculator.setExpression({id: "area2",color: "#8BC052",latex: "2x+3y-6\\ge0",hidden: false,});
            //函数区域3
            calculator.setExpression({id: "area3",color: "#FFD621",latex: "3x+2y-9\\le0",hidden: false,});
            //函数区域4
            calculator.setExpression({id: "area4",color: "#ffffff",latex: "\\operatorname{polygon}\\left(\\left(0,2\\right),\\left(3,0\\right),\\left(1,3\\right)\\right)",});
        
            //函数1
            calculator.setExpression({id: "function1",color: "#00AAFF",latex: "x-y+2=0",lineStyle: "SOLID", hidden:false});
            //函数2
            calculator.setExpression({id: "function2",color: "#8BC052",latex: "2x+3y-6=0",lineStyle: "SOLID", hidden:false});
            //函数3
            calculator.setExpression({id: "function3",color: "#FFD621",latex: "3x+2y-9=0",lineStyle: "SOLID", hidden:false});
            //函数4
            calculator.setExpression({id: "function4",color: "#FF5A5A",latex: "2x+5y=z",lineStyle: "DASHED", hidden:true});

            //公式点1
            calculator.setExpression({id: "functionPoint1",color: "#00AAFF",latex: "\\left(4,5\\right)",label:katex.renderToString('x-y+2=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点2
            calculator.setExpression({id: "functionPoint2",color: "#8BC052",latex: "\\left(-6,5\\right)",label:katex.renderToString('2x+3y-6=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点3
            calculator.setExpression({id: "functionPoint3",color: "#FFD621",latex: "\\left(0,6\\right)",label:katex.renderToString('3x+2y-9=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点4
            calculator.setExpression({id: "functionPoint4",color: "#FF5A5A",latex: "\\left(0,\\frac{z}{5}+1\\right)",label:katex.renderToString('2x+5y=z', {throwOnError: false}),hidden:true,showLabel: false});

            //圆点1
            calculator.setExpression({id: "point1",color: "#fff",latex: "\\left(0,2\\right)",label:katex.renderToString('A(0,2)', {throwOnError: false}),hidden:true,showLabel: false});
            //圆点2
            calculator.setExpression({id: "point2",color: "#fff",latex: "\\left(3,0\\right)",label:katex.renderToString('B(3,0)', {throwOnError: false}),hidden:true,showLabel: false});
            //圆点3
            calculator.setExpression({id: "point3",color: "#fff",latex: "\\left(1,3\\right)",label:katex.renderToString('C(1,3)', {throwOnError: false}),hidden:true,showLabel: false});
            //圆点4
            calculator.setExpression({id: "point4",color: "#fff",latex: "\\left(0,\\frac{z}{5}\\right)",hidden:true,showLabel: false});
        ...
        function checkSliderNumber(){
            ...
            sliderObject.observe("numericValue", function() {
                //为了突出答案，做吸附显示    
                if(sliderObject.numericValue > 5 && sliderObject.numericValue < 7){
                    calculator.setExpression({id: "slider1",latex: "z = 6"});
                }
