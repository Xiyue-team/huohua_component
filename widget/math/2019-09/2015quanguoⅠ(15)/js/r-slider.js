    ...
    var a = {
        ...
        render: function () {
            ...
            if (this.state.changable !== false) {
                ...
                this.eventHandler(container.find(".r-slider-button"), "touchstart", this.mousedown);
                this.eventHandler(container.find(".r-slider-space"), "touchstart", this.mousedown);
                this.eventHandler(container.find(".r-slider-label"), "touchstart", this.labelmousedown);
            }
        },
        ...
        mousedown: function (e) {
            ...
            if (index === 0 && clickMode === "r-slider-space") {
                ...
                if(e.type === 'mousedown' || e.type ==='mousemove' || e.type ==='mouseend'){
