    ...
    (function() {
        ...
        function createFormulaLine() {  
            //滑条
            calculator.setExpression({id: "slider1",latex: "k=0.5",sliderBounds: { min: "-10", max: "10", step: "0.1" }});
        
            //函数区域1
            calculator.setExpression({id: "area1",color: "#00AAFF",latex: "x-2y+4\\ge0",hidden: false,});
            //函数区域2
            calculator.setExpression({id: "area2",color: "#8BC052",latex: "2x+y-2\\ge0",hidden: false,});
            //函数区域3
            calculator.setExpression({id: "area3",color: "#FFD621",latex: "3x-y-3\\le0",hidden: false,});
            //函数区域4
            calculator.setExpression({id: "area4",color: "#ffffff",latex: "\\operatorname{polygon}\\left(\\left(0,2\\right),\\left(1,0\\right),\\left(2,3\\right)\\right)",});
        
            //函数1
            calculator.setExpression({id: "function1",color: "#00AAFF",latex: "x-2y+4=0",lineStyle: "SOLID", hidden:false});
            //函数2
            calculator.setExpression({id: "function2",color: "#8BC052",latex: "2x+y-2=0",lineStyle: "SOLID", hidden:false});
            //函数3
            calculator.setExpression({id: "function3",color: "#FFD621",latex: "3x-y-3=0",lineStyle: "SOLID", hidden:false});
            //函数4
            calculator.setExpression({id: "function4",color: "#FF5A5A",latex: "y=kx",lineStyle: "SOLID", hidden:false});

            //公式点1
            calculator.setExpression({id: "functionPoint1",color: "#00AAFF",latex: "\\left(5,4\\right)",label:katex.renderToString('x-2y+4=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点2
            calculator.setExpression({id: "functionPoint2",color: "#8BC052",latex: "\\left(-3,6\\right)",label:katex.renderToString('2x+y-2=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点3
            calculator.setExpression({id: "functionPoint3",color: "#FFD621",latex: "\\left(1.5,4.5\\right)",label:katex.renderToString('3x-y-3=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点4
            calculator.setExpression({id: "functionPoint4",color: "#FF5A5A",latex: "\\left(3,2k\\right)",label:katex.renderToString('y=kx', {throwOnError: false}),hidden:true,showLabel: true});
            ...
            //圆点2
            calculator.setExpression({id: "point2",color: "#fff",latex: "\\left(1,0\\right)",label:katex.renderToString('B(1,0)', {throwOnError: false}),hidden:false,showLabel: true});
            //圆点3
            calculator.setExpression({id: "point3",color: "#fff",latex: "\\left(2,3\\right)",label:katex.renderToString('C(2,3)', {throwOnError: false}),hidden:false,showLabel: true});
        }
