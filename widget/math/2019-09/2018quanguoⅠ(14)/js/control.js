     ...
     (function() {
        ...
        function initStyle(){
            //初始化题目的高度
            var height = window.innerWidth * (165 / 1200 );
            ...
            for(var index=0; index < leftContainer.children.length - 1; index++){
                leftContainer.children[index].style.height = window.innerWidth * 0.38 * (175 / 460) + 'px';
        ...
        function createFormulaLine() {  
            ...
            //函数区域1
            calculator.setExpression({id: "area1",color: "#FFD621",latex: "x-y+1\\ge0",hidden: false,});
            //函数区域2
            calculator.setExpression({id: "area2",color: "#00AAFF",latex: "x-2y-2\\le0",hidden: false,});
            //函数区域3
            calculator.setExpression({id: "area3",color: "#9BF23B",latex: "y\\le0",hidden: false,});
            //函数区域4
            calculator.setExpression({id: "area4",color: "#ffffff",latex: "\\operatorname{polygon}\\left(\\left(2,0\\right),\\left(-1,0\\right),\\left(-4,-3\\right)\\right)",});
        
            //函数1
            calculator.setExpression({id: "function1",color: "#FFD621",latex: "x-y+1=0",lineStyle: "SOLID", hidden:false});
            //函数2
            calculator.setExpression({id: "function2",color: "#00AAFF",latex: "x-2y-2=0",lineStyle: "SOLID", hidden:false});
            //函数3
            calculator.setExpression({id: "function3",color: "#9BF23B",latex: "y=0",lineStyle: "SOLID", hidden:false});
            //函数4
            calculator.setExpression({id: "function4",color: "#FF5A5A",latex: "3x+2y=z",lineStyle: "DASHED", hidden:true});

            //公式点1
            calculator.setExpression({id: "functionPoint1",color: "#FFD621",latex: "\\left(5,5\\right)",label:katex.renderToString('x-y+1=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点2
            calculator.setExpression({id: "functionPoint2",color: "#00AAFF",latex: "\\left(6,1.5\\right)",label:katex.renderToString('x-2y-2=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点3
            calculator.setExpression({id: "functionPoint3",color: "#9BF23B",latex: "\\left(-4,0.5\\right)",label:katex.renderToString('y=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点4
            calculator.setExpression({id: "functionPoint4",color: "#FF5A5A",latex: "\\left(0,\\frac{z}{2}+1\\right)",label:katex.renderToString('3x+2y=z', {throwOnError: false}),hidden:true,showLabel: false});

            //圆点1
            calculator.setExpression({id: "point1",color: "#fff",latex: "\\left(2,0\\right)",label:katex.renderToString('A(2,0)', {throwOnError: false}),hidden:true,showLabel: false});
            //圆点4
            calculator.setExpression({id: "point4",color: "#fff",latex: "\\left(0,\\frac{z}{2}\\right)",hidden:true,showLabel: false});
