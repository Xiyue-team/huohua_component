    ...
    (function() {
        ...
        function createFormulaLine() {  
            //滑条
            calculator.setExpression({id: "slider1",latex: "a=2",sliderBounds: { min: "-10", max: "10", step: "0.1" }});
    
            //函数区域1
            calculator.setExpression({id: "area1",color: "#FF5A5A",latex: "x-y\\ge0",hidden: false,});
            //函数区域2
            calculator.setExpression({id: "area2",color: "#8BC052",latex: "x+y\\le2",hidden: false,});
            //函数区域3
            calculator.setExpression({id: "area3",color: "#00AAFF",latex: "y\\ge0",hidden: false,});
            //函数区域4
            calculator.setExpression({id: "area4",color: "#ffffff",latex: "\\operatorname{polygon}\\left(\\left(1,1\\right),\\left(2,0\\right),\\left(0,0\\right)\\right)",});
        
            //函数1
            calculator.setExpression({id: "function1",color: "#FF5A5A",latex: "x-y=0",lineStyle: "SOLID", hidden:false});
            //函数2
            calculator.setExpression({id: "function2",color: "#8BC052",latex: "x+y=2",lineStyle: "SOLID", hidden:false});
            //函数3
            calculator.setExpression({id: "function3",color: "#00AAFF",latex: "y=0",lineStyle: "SOLID", hidden:false});
            //函数4
            calculator.setExpression({id: "function4",color: "#AC84FF",latex: "ax+y=4",lineStyle: "SOLID", hidden:false});

            //公式点1
            calculator.setExpression({id: "functionPoint1",color: "#FF5A5A",latex: "\\left(-4.2,5\\right)",label:katex.renderToString('x-y=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点2
            calculator.setExpression({id: "functionPoint2",color: "#8BC052",latex: "\\left(3,2\\right)",label:katex.renderToString('x+y=2', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点3
            calculator.setExpression({id: "functionPoint3",color: "#00AAFF",latex: "\\left(-2,-0.6\\right)",label:katex.renderToString('y=0', {throwOnError: false}),hidden:true,showLabel: true});
            //公式点4
            calculator.setExpression({id: "functionPoint4",color: "#AC84FF",latex: "\\left(-2,4+a\\right)",label:katex.renderToString('ax+y=4', {throwOnError: false}),hidden:true,showLabel: true});

            //圆点1
            calculator.setExpression({id: "point1",color: "#fff",latex: "\\left(1,1\\right)",label:katex.renderToString('A(1,1)', {throwOnError: false}),hidden:false,showLabel: true});
            //圆点2
            ...
            //圆点2
            calculator.setExpression({id: "point3",color: "#fff",latex: "\\left(0,0\\right)",label:katex.renderToString('C(0,0)', {throwOnError: false}),hidden:false,showLabel: true});
        }
