...
import * as analytic3Img from './sub_static/analytic3Img.png';
const viewOptionConfig = require('./meta.json');

@Component
export class ViewModel extends Vue {
    step = 1;
    styleContainer3d = { width: window.innerWidth * 0.55 + 'px', height: '100%' };
    exerciseOption = {
        exercise: {
            question: {
    ...
    resize() {
        this.styleContainer3d = { width: window.innerWidth * 0.55 + 'px', height: '100%' };
        if (this.assemble) {
