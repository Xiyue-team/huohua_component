...
import {ZshsdtxViewHandler} from './services/ZshsdtxViewHandler';

const viewOptionConfig = require('./meta.json');

import * as formula1 from './sub_static/formulas/y=2x.png';
import * as formula2 from './sub_static/formulas/y=3x.png';
import * as formula3 from './sub_static/formulas/y=1-2x.png';
import * as formula4 from './sub_static/formulas/y=1-3x.png';


import * as graphic1 from './sub_static/graphics/y=2x.png';
import * as graphic2 from './sub_static/graphics/y=3x.png';
import * as graphic3 from './sub_static/graphics/y=1-2x.png';
import * as graphic4 from './sub_static/graphics/y=1-3x.png';

import * as point1 from './sub_static/points/y=2x.png';
import * as point2 from './sub_static/points/y=3x.png';
import * as point3 from './sub_static/points/y=1-2x.png';
import * as point4 from './sub_static/points/y=1-3x.png';
...
export class ViewModel extends Vue {
    ...
    created() {
        ...
        ViewController.getInstance(new ZshsdtxViewHandler(this), viewOption);
