...
export class ThreejsViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    reset():  void {
      this.viewModel.$data.domainActived = false;
      this.viewModel.$data.symmetryAxisActived = false;
      this.viewModel.$data.monotonicActived = false;
      this.viewModel.$data.symmetricCenterActived = false;
      this.viewModel.$data.parityActived = false;
      this.viewModel.$data.periodicActived = false;
      this.three3dModel.hideAll();
    }
