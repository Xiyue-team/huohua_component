...
function maxEvent() {
  ...
  state.expressions.list[3].latex = 'a = 0';
  calculator.setState(state);
  checkValueA();
}
...
function checkValueA() {
  ...
  a.observe("numericValue", function() {
    ...
    if (numberA === 0) {
      ...
      xNumbers = Number.parseFloat(numberA.toFixed(2));
    }
    var slopeValues = Number.parseFloat((3 * Math.pow(numberA, 2)).toFixed(2));
    if (slopeValues != 0) {
...
function createDefaultFormulaLine() {
  ...
  calculator.setExpression({
    id: "formulaLine4",
    latex: "y-a^3=3a^2\\left(x-a\\right)",
    color: "#FF5A5A",
    lineStyle: "DASHED",
  });
  ...
  calculator.setExpression({
    id: "formulaLine5",
    latex: "x=a\\left\\{0\\le y\\le a^3\\right\\}",
    color: "#FFFFFF",
    lineStyle: "DASHED",
    hidden: false,
  });
  ...
  calculator.setExpression({
    id: "formulaLine6",
    latex: "x=a\\left\\{a^3\\le y\\le0\\right\\}",
    color: "#FFFFFF",
    lineStyle: "DASHED",
    hidden: false,
  });
  ...
  calculator.setExpression({
    id: "formulaLine7",
    latex: "x=a\\left\\{0\\le y\\le3a^2\\right\\}",
    color: "#FFFFFF",
    lineStyle: "DASHED",
    hidden: true,
  });
  ...
  calculator.setExpression({
    id: "formulaLine8",
    latex: "y=3a^2\\left\\{0\\le x\\le a\\right\\}",
    color: "#FFD621",
    hidden: true,
    lineStyle: "DASHED",
    dragMode: "AUTO",
  ...
  calculator.setExpression({
    id: "formulaLine9",
    latex: "y=3a^2\\left\\{a\\le x\\le0\\right\\}",
    color: "#FFD621",
    hidden: true,
    lineStyle: "DASHED",
    dragMode: "AUTO",
...
function adapterMobile() {
    if (width <= 610 || height <= 610) {
        document.getElementsByClassName('titleText')[0].style.fontSize = '14px';
