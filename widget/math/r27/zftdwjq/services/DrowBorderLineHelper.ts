...
export class DrowBorderLineHelper {
    ...
    // 画三棱柱的边框
    createTriangularPrismBorder(pointArray: any, color: any) {
      let line1;
      let line2;
      ...
      for (let i = 0; i < 2; i++) {
        ...
        line3 = this.createLineMesh([pointArray[i + 3], pointArray[i + 4]], color, 1);
        obj1.add(line3);
        line4 = this.createLineMesh([pointArray[i + 3], pointArray[i + 4]], color, 2);
        obj2.add(line4);

        line5 = this.createLineMesh([pointArray[i], pointArray[i + 3]], color, 1);
        obj1.add(line5);
        line6 = this.createLineMesh([pointArray[i], pointArray[i + 3]], color, 2);
        obj2.add(line6);
      }

      line1 = this.createLineMesh([pointArray[0], pointArray[2]], color, 1);
      obj1.add(line1);
      line2 = this.createLineMesh([pointArray[0], pointArray[2]], color, 2);
      obj2.add(line2);

      line3 = this.createLineMesh([pointArray[3], pointArray[5]], color, 1);
      obj1.add(line3);
      line4 = this.createLineMesh([pointArray[3], pointArray[5]], color, 2);
      obj2.add(line4);

      line5 = this.createLineMesh([pointArray[2], pointArray[5]], color, 1);
      obj1.add(line5);
      line6 = this.createLineMesh([pointArray[2], pointArray[5]], color, 2);
      obj2.add(line6);
