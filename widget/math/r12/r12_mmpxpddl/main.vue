           ...
           <div style="display: flex;height: 100%">
               <div style="margin: auto;">
                   ...
                   <label for="checkbox-1" id="s1" class="control-block_div_border switch enableAnim" v-on:mouseover="shou" v-on:mouseout="shubiao" style="margin-top:10px;">
                       ...
                       <label for="checkbox-1">面面平行判定定理</label>
                   </label>
               </div>

               <div class="xmdingli" style="" v-show="gongshi">
                   <!--<img v-show="gongshi" src="./sub_static/mmdingli.png"/>-->
                   一个平面内两条相交直线与另一个平面平行，则这两个平面平行。
               </div>
           </div>
        </div>

        <span class="title">面面平行判定定理</span>
