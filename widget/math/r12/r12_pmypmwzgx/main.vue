    ...
    <div class="aspectration bg_white root_div_container">
        ...
        <div class="control-panel_div_rt">
            ...
            <div class="control-block_div_border edge_height_slider background_scale" style="position: relative" v-bind:class="{'set_scale': isMobile}">
                    ...
                    <span class="text_style" style="left: 12px">平行</span>
                    <span class="text_style" style="left: 200px;">垂直</span>
            ...
            <label class="control-block_div_border switch" style="margin-top: 20px;" id="s1" v-on:mouseover="shou" v-on:mouseout="shubiao">
                <input type="checkbox" name="checkbox-cats[]" id="checkbox-1" v-model="atlas" checked >
                <label for="checkbox-1">知识图谱</label>
            </label>
            <div style="margin-top: 20px">
                <img src="./sub_static/pmypmwzgx.png" style="width: 245px " v-show="atlas">
            </div>


        </div>
        <span class="title_text">空间中平面与平面的位置关系</span>
