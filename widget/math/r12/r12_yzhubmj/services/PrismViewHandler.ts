...
export class PrismViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.cylinder3dModel = new Prism3dModel(document.getElementById('3dContainer'), fov, width, height, near, far);
        // const d3Helper = new D3Helper(this.cylinder3dModel);
    ...
    resize(): void {
        ...
        const width = document.getElementById('3dContainer').clientWidth;
        const height = document.getElementById('3dContainer').clientHeight;
        this.cylinder3dModel.resize(width, height);
    }
