    ...
    <fullScreens_layout>
      <template slot="viewBox" slot-scope="viewBox">
        <div id="3dContainer">
          ...
          <div id="mxFormula">
            <p v-for="(f, index) in formula" v-bind:style="{color:f.color}" v-html="f.desc" v-bind:key="index"></p>
          </div>
        ...
        <div id="controlPanel">
          <div id="mxControls">
            <div class="params" :style="{opacity: opacity}">
              <p><label>a</label><VueSliderComponent v-model.number="params.a" v-bind:min="-5" v-bind:max="5" v-bind:interval="0.1"></VueSliderComponent></p>
