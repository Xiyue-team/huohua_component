...
export class Game {
  ...
  constructor(canvas: HTMLCanvasElement, formula: any) {
    ...
    //初始化参数
    this.params.addParam('a', new Param(-5, 5, 1));
    this.params.addParam('b', new Param(-5, 5, 3));
    this.params.addParam('c', new Param(-5, 5, 4));
    this.params.addParam('m', new Param(0, 5, 5));
    //绑定事件
    this.bindEvents();
  }
