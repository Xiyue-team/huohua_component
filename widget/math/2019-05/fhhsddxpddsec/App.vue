      ...
      <template slot="viewBox" slot-scope="viewBox">
        <div id="3dContainer">
          ...
          <div id="fcCanvasContainer">
            <canvas id="fcCanvas" v-touch:longtap="longtapHandler" v-touch:start="touchStart" v-touch:moving="touchMove" v-touch:end="touchEnd"></canvas>
          </div>
        </div>
      </template>
        ...
        <div id="controlPanel">
          <div id="mxControls">
            <div class="params" :style="{opacity: opacity}">
              <p><label>a</label>
                <VueSliderComponent v-model.number="params.a" v-bind:min="-5" v-bind:max="5" v-bind:interval="0.1">

                </VueSliderComponent></p>
              <p><label>b</label>
                <VueSliderComponent v-model.number="params.b" v-bind:min="-5" v-bind:max="5" v-bind:interval="0.1">

                </VueSliderComponent></p>
              <p><label>c</label><VueSliderComponent v-model.number="params.c" v-bind:min="-5" v-bind:max="5" v-bind:interval="0.1"></VueSliderComponent></p>
            ...
            <div class="buttons" :style="{opacity: opacity}">
              ...
              <p><button v-bind:class="{ active: absLine }" @click="toggleAbs">对称轴</button></p>
...
<style>
  ...
  #mxControls .params label input[type=range]:focus {
    outline: none;
  }
