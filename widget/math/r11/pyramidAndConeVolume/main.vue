<template>
    <div class="aspectration bg_white root_div_container" data-ratio="16:9">
        ...
        <span class="title_text">棱锥及圆锥的体积</span>
        <div class ="title_img">
            <img src="./sub_static/pyramidAndCone.png" alt="" style="width: 170px;">
        </div>
...
//Returned expression tcype   is not assignable to type Data
