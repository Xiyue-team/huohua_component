...
export class JsxViewHandler extends CommonViewHandler {
    ...
    createLine() {
        //指北方向线
        this.board.create('line', [[0, -13], [0, 13]], { straightFirst: false, straightLast: false, strokeWidth: 4, strokeColor: '#000000', fixed: true, highlight: false, });
        //水平线
        this.board.create('line', [[-13, 0], [13, 0]], { straightFirst: false, straightLast: false, strokeWidth: 4, strokeColor: '#000000', fixed: true, highlight: false, });
    }
    //纵轴上的文字
    createText() {
        ...
        this.glider.on('drag', () => {
            ...
            if (this.angle < 90 && this.angle > 0) {
                ...
                if (this.sector1 == null) {
                    ...
                    //画扇形角
                    this.sector1 = this.board.create('sector', [this.startPoint, endSector, startSector], { strokeWidth: 2, strokeColor: '#1B8b72', fillColor: '#75B9AA', fillOpacity: 0.6, highlight: false });
                }
            }
                ...
                if (this.sector2 == null) {
                    ...
                    //画扇形角
                    this.sector2 = this.board.create('sector', [this.startPoint, startSector, endSector], { strokeWidth: 2, strokeColor: '#1B8b72', fillColor: '#75B9AA', fillOpacity: 0.6, highlight: false });
                }
            }
                ...
                if (this.sector3 == null) {
                    ...
                    let endSector = this.board.create('glider', [-2, -2, this.gliderLine], { fixed: true, visible: false });
                    //画扇形角
                    this.sector3 = this.board.create('sector', [this.startPoint, endSector, startSector], { strokeWidth: 2, strokeColor: '#1B8b72', fillColor: '#75B9AA', fillOpacity: 0.6, highlight: false });
                }
            }
                ...
                if (this.sector4 == null) {
                    ...
                    let endSector = this.board.create('glider', [-1.2, 1.2, this.gliderLine], { fixed: true, visible: false });
                    //画扇形角
                    this.sector4 = this.board.create('sector', [this.startPoint, startSector, endSector], { strokeWidth: 2, strokeColor: '#1B8b72', fillColor: '#75B9AA', fillOpacity: 0.6, highlight: false });
                }
            }
