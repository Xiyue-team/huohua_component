...
export class JsxViewHandler extends CommonViewHandler implements ViewHandler{
    ...
    createLine(){
        //指北方向线
        this.board.create('line', [[0,-10.2],[0,10.1]],
            {straightFirst:false, straightLast:false, strokeWidth:4,strokeColor:'#000000',fixed:true,highlight:false,});
        //水平线
        this.board.create('line', [[-10.2,0],[10.1,0]],
            {straightFirst:false, straightLast:false, strokeWidth:3,strokeColor:'#4A90E2',fixed:true,highlight:false,});
    }
    ...
    private drawSector(){
        ...
        //画扇形角
        let sector     = this.board.create('sector', [this.startPoint, endSector , startSector],
