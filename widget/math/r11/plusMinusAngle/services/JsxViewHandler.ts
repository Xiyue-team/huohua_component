...
import loadTexture = ImageUtils.loadTexture;
...
export class JsxViewHandler extends CommonViewHandler implements ViewHandler{
    ...
    public yaxis:any;
    //轴上的刻度
    private arrayAxisScale:any;
    //线段横轴上的终点
    private endPointX:any;
    //轨迹圆
    private circle:any;
    //原点和可移动点连线
    private line:any;
    //角度文字
    private angleTxet:any;
    //当前角度
    private angle:any;
    //上一个角度
    ...
    private XYAxes(){
        ...
        this.xaxis = this.board.create('arrow',[[-10,0],[10,0]],
            {strokeWidth:4,strokeColor:'#000000',fixed:true,highlight:false,visible:false,layer: 5});

        this.yaxis = this.board.create('arrow',[[0,-10],[0,10]],
            {strokeWidth:4,strokeColor:'#000000',fixed:true,highlight:false,visible:false,layer: 5});
    ...
    private drawLine(){
        ...
        //起始点和终点的连线
        this.board.create('line',[this.startPoint,this.endPointX],
            {straightFirst:false, straightLast:false, strokeWidth:4, strokeColor:'#FF5D00',layer: 7,highlight:false});
        ...
        //画可移动点
        this.endPoint = this.board.create('glider',[5,5,this.circle],
            {name:'', size:9, showInfobox:false, face:"o", strokeColor:"#C0C0C0", fillColor:'#FFFFFF',highlight:false});
        //画原点和可移动点的连线
        this.line = this.board.create('line',[this.startPoint,this.endPoint],
            {straightFirst:false, straightLast:false, strokeWidth:4, strokeColor:'#0094FF',highlight:false,});
    ...
    drawSector(){
        ...
        //画扇形角
        this.sector     = this.board.create('sector', [this.startPoint, this.startSector, this.endSector],
    ...
    negative(){
        ...
        this.angleTxet = this.board.create('text',[1.2,-1,'-45°'],
            {fontSize:24,strokeColor:'#3494E9',fixed:'true',highlightStrokeColor:'#3494E9',highlight:false,});
    ...
    zeroAngle(){
        ...
        //画可移动点
        this.endPoint = this.board.create('glider',[Math.sqrt(50),0,this.circle],
            {name:'', size:9, showInfobox:false, face:"o", strokeColor:"#C0C0C0", fillColor:'#FFFFFF',highlight:false,});
    ...
    //判断顺时针还是逆时针旋转
    duration(point1:any, point2:any, point3:any) {
