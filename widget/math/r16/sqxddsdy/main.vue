    ...
    <div class="aspectration bg_white root_div_container">
        <fullScreensLayout>
            <template slot="viewBox" slot-scope="viewBox" >
                <span class="title_style" v-bind:class="{'set_scale1': isMobile}">双曲线的第三定义</span>
                <transition name="fade">
                    <div v-show="showEquation"  >
                        <div class="equation" v-if="!initEquation"  v-bind:class="{'set_scale': isMobile}">
                            <div class="klImg "><img src="./sub_static/fang1.png"/></div>
                            <div class="point">=</div>
            ...
            <template slot="controlPanel" slot-scope="controlPanel">
                <div id="controlPanel" style="height: 100%">
                    ...
                    <div  style="bottom: 71px;right:24px;position: absolute " @click="button1" v-bind:class="{ event_disabled: disable }">
                        <h_button  title="绘制" style="width:72px;height: 42px;border-radius: 21px;" v-bind:class='{active: gaoliang}' ></h_button>
                    </div>
