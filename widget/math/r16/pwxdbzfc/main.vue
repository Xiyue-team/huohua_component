    ...
    <div class="aspectration bg_white root_div_container" data-ratio="16:9">
        <fullScreensLayout>
            <template slot="viewBox" slot-scope="viewBox">
                <span id="title" class="title_text">抛物线的标准方程</span>
                <transition name="fade">
                    <!-- <div v-show="showEquation">
                        | MF<sub>1</sub> | + | MF<sub>2</sub> | = 2a > | F<sub>1</sub>F<sub>2</sub> |
                    </div> -->
                </transition>
...
export default Vue.extend({
    ...
    watch: {
        isActive(v) {
            // (ViewController.getInstance().viewHandler as LineTestViewHandler).threeModel.drawEllipseHandle(v);
        }
    },
    computed: {},
    created() {
