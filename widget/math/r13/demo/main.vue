<template>
    <div class="aspectration bg_white root_div_container" data-ratio="16:9">
        <div class="control-panel_div_rt">
            <div class="button_border " style="width:48px;height: 40px;margin-left: 200px;"  >
                <img style="width: 25px;height: 24px;  margin-top: 8px;margin-left: 12px" src="../../../../static/images/chongzhi.png" alt="" @click="resetEvent">
            </div>
...
export default Vue.extend({
    ...
    methods: {
        ...
        resetEvent(){
            ...
            (ViewController.getInstance().viewHandler as any).lineFace3dModel.reset();
        }
    },
    watch:{
