    ...
    <div class="aspectration bg_white root_div_container" data-ratio="16:9">
        <fullScreensLayout>
            <template slot="viewBox" slot-scope="viewBox">
                <span id="title" class="title_text">平面中两点间的距离 </span>
                <img src="./sub_static/equation.png" class="equation" v-show="isActive">
...
export default Vue.extend({
    ...
    watch: {
        isActive(v) {
            (ViewController.getInstance().viewHandler as LineTestViewHandler).threeModel.showSubline(v);
        }
    },
    computed: {},
    created() {
