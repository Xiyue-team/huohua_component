    ...
    <div class="aspectration bg_white root_div_container" data-ratio="16:9">
        <fullScreensLayout>
            <template slot="viewBox" slot-scope="viewBox">
                <span id="title" class="title_text">点与圆的位置关系</span>
...
export default Vue.extend({
    ...
    watch: {
        a(v) {
            (ViewController.getInstance().viewHandler as LineTestViewHandler).threeModel.changePosByVue({ x: -v * 10, y: -this
                    .b * 10 });
        },
        b(v) {
            (ViewController.getInstance().viewHandler as LineTestViewHandler).threeModel.changePosByVue({ x: -this.a * 10, y:
                    -v * 10 });
        },
        r(v) {
