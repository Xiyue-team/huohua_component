...
export default class CommonForThree {
    ...
    // 画角度 
    static drawAngle(startAngle: number, endAngle: number, { color = '#000', opacity = 1, size = 10, zIndex = 0, isAngle = true} = {}) {
        const group = new THREE.Group();
    ...
    static createText(text: string, position: any, { color = '#000' } = {}) {
