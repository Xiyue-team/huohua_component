       ...
       const parameterOption = _.assign(new AxisOption(), axisOption);
        ...
        if (parameterOption.isTicks) {
            XAxis = ThreeUtil.createLine(parameterOption.width + parameterOption.XtickDistance,
                parameterOption.strokeWidth, parameterOption.axisColor);
            YAxis = ThreeUtil.createLine(parameterOption.strokeWidth, parameterOption.height +
                parameterOption.YtickDistance, parameterOption.axisColor);
            arrowX = ThreeUtil.createTriangle((parameterOption.width / 4) + parameterOption.XtickDistance / 4,
                (parameterOption.arrowHeight / 2), (parameterOption.width / 4) + parameterOption.XtickDistance / 4,
                -(parameterOption.arrowHeight / 2), (parameterOption.width / 4) + parameterOption.XtickDistance / 4
                + parameterOption.arrowWidth, 0 , parameterOption.axisColor);
            arrowY = this.createTriangle((parameterOption.arrowHeight / 2), (parameterOption.height / 4)
                + parameterOption.YtickDistance / 4 + 1, -(parameterOption.arrowHeight / 2), (parameterOption.height / 4)
                + parameterOption.YtickDistance / 4 + 1, 0, (parameterOption.height / 4)
                + parameterOption.YtickDistance / 4 + parameterOption.arrowWidth + 1 , parameterOption.axisColor);
            //创建坐标轴上的刻度
            for (i = 0; i < (parameterOption.width / 2 / parameterOption.XtickDistance) + 1; i++) {
                const a = ThreeUtil.createLine(parameterOption.tickWidth,  parameterOption.tickHeight, parameterOption.axisColor);
                const b = ThreeUtil.createLine(parameterOption.tickWidth,  parameterOption.tickHeight, parameterOption.axisColor);
            ...
            for (k = 0; k < (parameterOption.height / 2 / parameterOption.YtickDistance) + 1; k++) {
                const a = ThreeUtil.createLine(parameterOption.tickHeight, parameterOption.tickWidth, parameterOption.axisColor);
                const b = ThreeUtil.createLine(parameterOption.tickHeight, parameterOption.tickWidth, parameterOption.axisColor);
            ...
            arrowY = ThreeUtil.createTriangle((parameterOption.arrowHeight / 2), (parameterOption.height / 2)
                ...
                + parameterOption.YtickDistance / 2 + parameterOption.arrowWidth , parameterOption.axisColor);
            group.add(XAxis);
            group.add(YAxis);
            group.add(arrowX);
            group.add(arrowY);
        ...
        const textY = ThreeUtil.createNewRomanText('y', -parameterOption.width / 45,
            ...
            1, parameterOption.fontColor , parameterOption.fontScale);
...
class AxisOption {
    ...
    tickHeight = this.height / (200 / 1.1);
    XtickDistance = this.width / 50;
