...
export default class CommonForThree {
    ...
    // 画圆线
    static createStrokeCircle(radius: number) {
    ...
    static createText(text: string, position: Array<number> = [0, 0, 0], { color = '#000', isItalic = true } = {}) {
        ...
        const textStyle = { font: `${str} 58px "Times New Roman"`, fillStyle: color, antialias: true };
    ...
    // 下标文字的特殊处理
    static createText1(text: string, position: Array<number> = [0, 0, 0], { color = '#000'} = {}) {
