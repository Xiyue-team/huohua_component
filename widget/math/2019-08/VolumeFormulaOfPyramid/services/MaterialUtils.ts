...
export class MaterialUtils {
    ...
    static CreateCloseMaterial(diffuseTextureString: string, scene: Scene): StandardMaterial {
        const mat = new StandardMaterial('dog', scene);
        mat.diffuseTexture = new Texture(diffuseTextureString, scene);
        mat.specularColor = new Color3(0, 0, 0);
    ...
    static CreateMetal2Material(scene: Scene): PBRMaterial {
        const metal2 = new PBRMaterial('metal', scene);
        metal2.reflectionColor = new Color3(0.1, 0.1, 0.1);
        metal2.microSurface = 0.96;
        metal2.reflectivityColor = new Color3(0.85, 0.85, 0.85);
        metal2.albedoColor = new Color3(0.01, 0.01, 0.01);
        metal2.freeze();
        return metal2;
    }
    ...
    static CreateRedHeartMaterial(scene: Scene): StandardMaterial {
        ...
        redheartMaterial.emissiveColor = new Color3(0.2, 0, 0);
        redheartMaterial.diffuseColor = new Color3(0.4, 0, 0);
