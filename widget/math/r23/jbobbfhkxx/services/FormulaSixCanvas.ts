...
export default class FormulaFourCanvas {
    ...
    async initText() {
      ...
      this.paiText = await FabricUtil.loadImage(pai as any, this.config.pai);
      this.group.push(this.paiText);
    }
    ...
    updateLine(angle: number) {
      ...
      this.helper.updateBlueLine(this.blueLine, angle - 90, this.config.circleLine.radius);
      this.helper.updateYellowLine(this.yellowLine, angle - 90, this.config.circleLine.radius);
      this.helper.updateVioletLine(this.violetDottedLine, angle - 90, this.config.circleLine.radius * 5);

      this.rightAngle.rotate(angle - 135);
    }
    ...
    updateText(angle: number) {
      ...
      this.helper.updateText(this.paiText, angle - 55, 60 * this.config.scale);
    }
