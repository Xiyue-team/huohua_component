...
export class ViewModel extends Vue {
  ...
  buttonEvent() {
    ...
    if (this.symmetry === false) {
      (ViewController.getInstance().viewHandler as ThreejsViewHandler).three3dModel.pauseAnimation();
    }
  ...
  selectOption1() {
    ...
    // (imgDom as any).style.top =
    imgDom1.setAttribute('src', (func2 as any));
    selectImage.setAttribute('src', (func1 as any));
    (selectImage as any).style.width = '78px';
    (selectImage as any).style.marginLeft = '20px';
    ...
    (ViewController.getInstance().viewHandler as ThreejsViewHandler).three3dModel.selectPauseAnimation(2);
  }
  ...
  selectOption2() {
    ...
    (imgDom1 as any).style.top = '14px';
    selectImage.setAttribute('src', (func2 as any));
    (selectImage as any).style.width = '61px';
    (selectImage as any).style.marginLeft = '35px';
    (optionDiv1 as any).style.background = '#EBEBEB';
    (optionDiv2 as any).style.background = '#00AAFF';
    this.selectValue = 2;
    (ViewController.getInstance().viewHandler as ThreejsViewHandler).three3dModel.resetTextPosition();
    (ViewController.getInstance().viewHandler as ThreejsViewHandler).three3dModel.selectPauseAnimation(1);
  }
