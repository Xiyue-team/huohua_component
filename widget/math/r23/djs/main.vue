  ...
  <div class="aspectration bg_white covered root_div_container ">
      <fullScreensLayout>
              <template slot="viewBox" slot-scope="viewBox">
                  <div class="title_text">倒计时</div>
                  <div id="3dContainer" style="margin: auto">
                      <div class='wrapper' style="text-align: center;">
                          <div class='time-part-wrapper'>
                              ...
                              <div id="m" class='time-part  ones' v-bind:class="{minutes: isStart}">
                                  <div class='digit-wrapper'>
                                      <!--<span class='digit'>0</span>
                          ...
                          <div class='time-part-wrapper'>
                              <div id="ts" class='time-part seconds ' v-bind:class="{tens: isStart}">
                                  <div class='digit-wrapper'>
                                      <span class='digit'>0</span>
                                      <span class='digit'>5</span>
                                      <span class='digit'>4</span>
                              ...
                              <div id="s" class='time-part  ones' v-bind:class="{seconds: isStart}">
                                  <div class='digit-wrapper'>
                                      <span class='digit'>0</span>
                                      <span class='digit'>9</span>
                                      <span class='digit'>8</span>
                          ...
                          <!--<div class='time-part-wrapper'>
                           &lt;!&ndash;   <div class='time-part hundredths tens'>
                                  <div class='digit-wrapper'>
                                      <span class='digit'>0</span>
                                      <span class='digit'>9</span>
                                      <span class='digit'>8</span>
                            ...
                            &lt;!&ndash;  <div class='time-part hundredths ones'>
                                  <div class='digit-wrapper'>
                                      <span class='digit'>0</span>
                                      <span class='digit'>9</span>
                                      <span class='digit'>8</span>
                    ...
                    <img v-if="!isStart" @click="begin" src="./sub_static/timer@2x.png" style="width: 123px;height: 123px;position: absolute;right: 32px;bottom: 32px;">
                  </div>

                  <!--<video controls="" autoplay="" name="media" style="display: none">-->
                      <!--<source src="./sub_static/didi.mp3" type="audio/mp3">-->
                  <!--</video>-->
              </template>
