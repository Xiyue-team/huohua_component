...
//拖拽事件(结束)
  ...
  complete11() {
    const op = (window as any).viewHandler.viewModel.$data;
    if (op.ishave >= 2) {
      if (op.xuankuangArr[0] === '0' && op.xuankuangArr[1] === '1' && op.xuankuangArr[2] === '6' && op.xuankuangArr[3] === '2' &&
        op.xuankuangArr[4] === '3' && op.xuankuangArr[5] === '5' && op.xuankuangArr[6] === '4') {
        op.tishi_right = true;
        op.ishave = 3;
        setTimeout(() => {
      ...
      } else if (op.xuankuangArr[0] === '1' && op.xuankuangArr[1] === '6' && op.xuankuangArr[2] === '2' && op.xuankuangArr[3] === '3' &&
        op.xuankuangArr[4] === '5' && op.xuankuangArr[5] === '4' && op.xuankuangArr[6] === '0') {
        op.tishi_right = true;
        op.ishave = 3;
        setTimeout(() => {
          op.tishi_right = false;
      ...
      } else if (op.xuankuangArr[0] === '2' && op.xuankuangArr[1] === '3' && op.xuankuangArr[2] === '5' && op.xuankuangArr[3] === '4' &&
        op.xuankuangArr[4] === '0' && op.xuankuangArr[5] === '1' && op.xuankuangArr[6] === '6') {
        op.tishi_right = true;
        op.ishave = 3;
        setTimeout(() => {
          op.tishi_right = false;
      ...
      } else if (op.xuankuangArr[0] === '3' && op.xuankuangArr[1] === '5' && op.xuankuangArr[2] === '4' && op.xuankuangArr[3] === '0' &&
        op.xuankuangArr[4] === '1' && op.xuankuangArr[5] === '6' && op.xuankuangArr[6] === '2') {
        op.tishi_right = true;
        op.ishave = 3;
        setTimeout(() => {
          op.tishi_right = false;
      ...
      } else if (op.xuankuangArr[0] === '4' && op.xuankuangArr[1] === '0' && op.xuankuangArr[2] === '1' && op.xuankuangArr[3] === '6' &&
      ...
      } else if (op.xuankuangArr[0] === '5' && op.xuankuangArr[1] === '4' && op.xuankuangArr[2] === '0' && op.xuankuangArr[3] === '1' &&
        op.xuankuangArr[4] === '6' && op.xuankuangArr[5] === '2' && op.xuankuangArr[6] === '3') {
        op.tishi_right = true;
        op.ishave = 3;
        setTimeout(() => {
          op.tishi_right = false;
      ...
      } else if (op.xuankuangArr[0] === '6' && op.xuankuangArr[1] === '2' && op.xuankuangArr[2] === '3' && op.xuankuangArr[3] === '5' &&
        op.xuankuangArr[4] === '4' && op.xuankuangArr[5] === '0' && op.xuankuangArr[6] === '1') {
        op.tishi_right = true;
        op.ishave = 3;
        setTimeout(() => {
          op.tishi_right = false;
