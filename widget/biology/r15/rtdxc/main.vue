            ...
            <template slot="viewBox" slot-scope="viewBox">
                ...
                <div id="3dContainer" style="width: 100%;height: 100%;   display: flex;flex-direction: column;justify-content: space-between;align-items: center;">
                    ...
                    <div class="imgContain" v-bind:class="{'imgContainMobile': isMobile}">
                        <img src="./sub_static/banrutang.png" class="img1Style" v-bind:style="img2style" v-bind:class="{'img1StyleMobile': isMobile, 'img1StyleIpad': isIpad}"/>
                        <img src="./sub_static/putaotang.png"  class="img2Style" v-bind:style="img2style" v-bind:class="{'img2StyleMobile': isMobile, 'img2StyleIpad': isIpad}"/>
                        <img src="./sub_static/rutanggongshi.png" v-bind:style="imgstyle" class="img3Style" v-bind:class="{'img3StyleMobile': isMobile}">
                    </div>
    ...
    watch: {
      ...
      sliderNum: function(sliderNum: number) {
        ...
        (ViewController.getInstance().viewHandler as RtdxcViewHandler).
          mytdsj.modelanimation.action.time = sliderNum / 60.9;
      ...
      isPlay:function(isPlay: boolean){
        (ViewController.getInstance().viewHandler as RtdxcViewHandler).PlayAnimation(isPlay);
      },
