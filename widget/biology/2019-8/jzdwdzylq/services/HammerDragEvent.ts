...
export class HammerDragEvent {
  ...
  constructor(vm: any, id: string, hitCall?: any) {
    ...
    mc.on('rotatestart rotatemove', (evt) => { // this.onRotate(evt);

    });
    mc.on('pinchstart pinchmove', (evt) => { // this.onPinch(evt);
  ...
  onPanend(vm: any) {
    ...
    if (x > two_l - this.obj * 0.6 && x < two_r - this.obj * 0.4 && y > two_t - this.obj * 0.8 && y < two_b - this.obj * 0.4 &&
      ~['image0', 'image1', 'image2', 'image3', 'image5', 'image6', 'image7'].indexOf(this.el.id)) {
    ...
    if (x > three_l - this.obj * 0.6 && x < three_r - this.obj * 0.4 && y > three_t - this.obj * 0.6 && y < three_b - this.obj * 0.4 &&
      ~[ 'image1','image2', 'image3', 'image4', 'image5', 'image6', 'image7'].indexOf(this.el.id)) {
    ...
    if (x > four_l - this.obj * 0.6 && x < four_r - this.obj * 0.4 && y > four_t - this.obj * 0.6 && y < four_b - this.obj * 0.4 &&
      ~['image1', 'image2'].indexOf(this.el.id)) {
    ...
    if (x > four_l - this.obj * 0.6 && x < four_r - this.obj * 0.4 && y > four_t - this.obj * 0.6 && y < four_b - this.obj * 0.4 &&
      ~['image0', 'image3', 'image4', 'image5', 'image6', 'image7'].indexOf(this.el.id)) {
    ...
    if (x > five_l - this.obj * 0.6 && x < five_r - this.obj * 0.4 && y > five_t - this.obj * 0.6 && y < five_b - this.obj * 0.4 &&
      ~['image5', 'image7'].indexOf(this.el.id)) {
    ...
    if (x > five_l - this.obj * 0.6 && x < five_r - this.obj * 0.4 && y > five_t - this.obj * 0.6 && y < five_b - this.obj * 0.4 &&
      ~['image0','image1', 'image2', 'image3', 'image4', 'image6' ].indexOf(this.el.id)) {
    ...
    if (x > six_l - this.obj * 0.6 && x < six_r - this.obj * 0.4 && y > six_t - this.obj * 0.6 && y < six_b - this.obj * 0.4 &&
      ~['image3', 'image6'].indexOf(this.el.id)) {
    ...
    if (x > six_l - this.obj * 0.6 && x < six_r - this.obj * 0.4 && y > six_t - this.obj * 0.6 && y < six_b - this.obj * 0.4 &&
      ~[ 'image0','image1', 'image2', 'image4', 'image5', 'image7'].indexOf(this.el.id)) {
  ...
  //
  onPinch(ev: any) {  //内容注释后代码审查不通过后删除了

  }
  //
  onRotate(ev: any) { //内容注释后代码审查不通过后删除了
