var ModelControl = function (option) {
    ...
    var initElement = function () {
        ...
        loadHtml('<div class="title_text">地球上的经线与经度</div>');
    ...
    var initEvent = function () {
        ...
        stopEvent(resetBtn, () => {
            ...
            if(window.modelSite){
                window.modelSite.initModelScale();
            }
            if(window.scenceId === 752543){
                window.orbitCamera.reset(0,0, 17.38);
            }
            option.modelBtnArry[0].changeModelCall();
