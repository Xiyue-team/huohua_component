var ModelControl = function (option) {
    ...
    var initCss = function () {
        ...
        loadCssCode(' .rightControl-div-modelBtn {user-select: none; font-size: 16px; color: #525252;  width: 88px; height: 40px; font-weight: 500;text-align: center; background: #FFFFFF;' +
    ...
    var initElement = function () {
        ...
        loadHtml('<div class="title_text">三种血管</div>');
    ...
    var initEvent = function () {
        ...
        for (let i = 0; i < changeModelBtns.length; i++) {
            stopEvent(changeModelBtns[i],(event) => {
                ...
                if(window.modelSite){
                    window.modelSite.textEnabled(textEnabled);
                }
            });  
        }
        stopEvent(resetBtn, () => {
            ...
            textEnabled = false;
            window.modelSite.textEnabled(textEnabled);
            window.orbitCamera.pitch = 3.255;
        });
    };
