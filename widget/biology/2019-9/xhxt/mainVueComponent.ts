...
export class MainVueComponent extends Vue {
  ...
  btn8 = window.env.browserInfo.lang.btn8;
  btn9 = window.env.browserInfo.lang.btn9;
  btn10 = window.env.browserInfo.lang.btn10;
  ...
  btntext8 = window.env.browserInfo.lang.btntext8;
  btntext9 = window.env.browserInfo.lang.btntext9;
  btntext10 = window.env.browserInfo.lang.btntext10;
  ...
  created() {
    ...
    // let size = document.getElementById("btntext4").style.fontSize;
    // console.log(size);
