...
import {FenZi3DModel} from './FenZi3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class FenZiViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.model = new FenZi3DModel(document.getElementById('3dModel'), null, width, height);
