...
import {Dxzh3DModel} from './Dxzh3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class DxzhViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new Dxzh3DModel(document.getElementById('3dModel'), null, width, height);
