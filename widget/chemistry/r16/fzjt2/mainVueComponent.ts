            ...
            analyticArray:  [{
                ...
                stepArray : [
                    ...
                    { coverImage: analytic4Img , call: () => {
                            console.log('解析4');
                            (ViewController.getInstance().viewHandler as FenZiViewHandler).model.hideModel();
                            (ViewController.getInstance().viewHandler as FenZiViewHandler).model.obj4.visible = true;
                        }},
                    { coverImage: analytic5Img , call: () => {
                            console.log('解析5');
                            (ViewController.getInstance().viewHandler as FenZiViewHandler).model.hideModel();
                            (ViewController.getInstance().viewHandler as FenZiViewHandler).model.obj5.visible = true;
                        }},
                ]
            }],
