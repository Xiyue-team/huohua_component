...
import * as jingti1 from '../sub_static/model/jingti1.fbx';
import * as jingti2 from '../sub_static/model/jingti2.fbx';
import * as jingti3 from '../sub_static/model/jingti3.fbx';
import * as jingti4 from '../sub_static/model/jingti4.fbx';
import * as jingti5 from '../sub_static/model/jingti1.fbx';

import * as tietu01 from '../sub_static/model/tietu01.png';
import * as tietu02 from '../sub_static/model/tietu02.png';
import * as tietu03 from '../sub_static/model/tietu03.png';
import * as tietu04 from '../sub_static/model/tietu04.png';
...
export class FenZi3DModel extends ThreeBase {
    ...
    static preload() {
        const modelArray = [jingti1, jingti2, jingti3, jingti4, jingti5, tietu01, tietu02, tietu03, tietu04];
    ...
    async initFbx()  {
        ...
        const model5: any = await this.fbxLoader(jingti5 as any);
        model5.rotation.x = Math.PI / 2;
