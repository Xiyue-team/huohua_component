...
import {Jdjx3DModel} from './Jdjx3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class JdjxViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new Jdjx3DModel(document.getElementById('3dModel'), null, width, height);
