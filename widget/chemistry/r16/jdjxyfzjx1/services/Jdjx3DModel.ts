...
import * as h2oFBX from '../sub_static/model/1.fbx';
import * as nh3FBX from '../sub_static/model/2.fbx';
import * as p4FBX from '../sub_static/model/3.fbx';
import * as ch4FBX from '../sub_static/model/4.fbx';

import * as D1Img from '../sub_static/model/0001.png';

export class Jdjx3DModel extends ThreeBase {
    ...
    static preload() {
        const modelArray = [h2oFBX, nh3FBX, p4FBX, ch4FBX, D1Img];
