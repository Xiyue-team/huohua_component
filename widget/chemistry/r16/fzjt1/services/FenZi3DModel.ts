...
import * as jingti1 from '../sub_static/model/fenzijingti1.fbx';
import * as jingti2 from '../sub_static/model/fenzijingti2.fbx';
import * as jingti3 from '../sub_static/model/fenzijingti3.fbx';

import * as hImg from '../sub_static/model/H1.png';
...
export class FenZi3DModel extends ThreeBase {
    ...
    static preload() {
        const modelArray = [jingti1, jingti2, jingti3, hImg];
