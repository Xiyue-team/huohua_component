...
import {Zhgd3DModel} from './Zhgd3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class ZhgdViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new Zhgd3DModel(document.getElementById('3dModel'), null, width, height);
