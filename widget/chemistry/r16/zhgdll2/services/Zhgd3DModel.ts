...
import * as f3FBX from '../sub_static/model/3.fbx';
import * as f4FBX from '../sub_static/model/4.fbx';

import * as dzImg from '../sub_static/model/tietu.png';
...
export class Zhgd3DModel extends ThreeBase {
    ...
    static preload() {
        const modelArray = [f1FBX, f2FBX, f3FBX, f4FBX, dzImg];
    ...
    async initGltfLoader()  {
          ...
          const g3_FBX: any = await this.fbxLoader(f3FBX as any);
          g3_FBX.scale.set(0.5, 0.5, 0.5);
          this.obj3.add(g3_FBX);

          const g4_FBX: any = await this.fbxLoader(f4FBX as any);
          g4_FBX.scale.set(0.7, 0.7, 0.7);
