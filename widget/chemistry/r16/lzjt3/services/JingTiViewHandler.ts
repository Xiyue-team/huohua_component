...
import {JingTi3DModel} from './JingTi3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class JingTiViewHandler extends CommonViewHandler implements ViewHandler {
    gltf: JingTi3DModel;
    ...
    domReady(): void {
        ...
        this.gltf = new JingTi3DModel(document.getElementById('3dModel'), null, width, height);
