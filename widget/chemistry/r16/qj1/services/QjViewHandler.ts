...
import {Qj3DModel} from './Qj3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class QjViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new Qj3DModel(document.getElementById('3dModel'), null, width, height);
