...
import {Yzjgmx23DModel} from './Yzjgmx23DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class Yzjgmx2ViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new Yzjgmx23DModel(document.getElementById('3dModel'), null, width, height);
