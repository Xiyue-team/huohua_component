...
import {GjjLi3DModel} from './GjjLi3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';


export class GjjLlViewHandler extends CommonViewHandler implements ViewHandler {
    gltf: GjjLi3DModel;
    ...
    domReady(): void {
        ...
        this.gltf = new GjjLi3DModel(document.getElementById('3dModel'), null, width, height);
