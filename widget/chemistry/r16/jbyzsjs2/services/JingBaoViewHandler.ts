...
import {JingBao3DModel} from './JingBao3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class JingBaoViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new JingBao3DModel(document.getElementById('3dModel'), null, width, height);
