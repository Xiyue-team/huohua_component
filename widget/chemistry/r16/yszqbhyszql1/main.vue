    ...
    <exerciseLayout v-bind="exerciseOption">
      <template slot="box" slot-scope="box">
        <div  id="box" style="width: 100%;height: 100%;display: flex">
            <div class="model_content" style="width: 100%;height: 100%;">
                <div  id="3dModel" class="model3d_content transtaion_animation2" style="width: 100%;height: 100%;">
...
<script lang="ts">
import Vue from 'vue';
import buttonEllipse from '../../../../src/component/ui/buttonEllipse.vue';
...
@Component({
    components: {
        buttonEllipse, exerciseLayout, switch2, p_button,
    },
