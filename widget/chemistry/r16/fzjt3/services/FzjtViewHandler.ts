...
import {Fzjt3DModel} from './Fzjt3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class FzjtViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new Fzjt3DModel(document.getElementById('3dModel'), null, width, height);
