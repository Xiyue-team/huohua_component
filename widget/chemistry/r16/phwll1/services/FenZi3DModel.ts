...
import * as jingti1 from '../sub_static/model/peihewulilun1.fbx';
import * as jingti2 from '../sub_static/model/peihewulilun2.fbx';
import * as image01 from '../sub_static/model/co.png';
...
export class FenZi3DModel extends ThreeBase {
    ...
    static preload() {
        const modelArray = [jingti1, jingti2, image01];
