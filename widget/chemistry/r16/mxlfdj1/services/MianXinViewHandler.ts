...
import {MianXin3DModel} from './MianXin3DModel';
import {Detector} from '../../../../../src/util/Detector';
import {ViewController} from '../../../../../src/core/ViewController';

export class MianXinViewHandler extends CommonViewHandler implements ViewHandler {
    ...
    domReady(): void {
        ...
        this.gltf = new MianXin3DModel(document.getElementById('3dModel'), null, width, height);
