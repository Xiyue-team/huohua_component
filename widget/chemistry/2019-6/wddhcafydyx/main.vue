        ...
        <fullScreensLayout>
            <template slot="viewBox" slot-scope="viewBox">
                ...
                <div class="reactionBox" >
                    ...
                    <img class="pressureBig" src="./sub_static/UI/temHigh.png" v-bind:style="{zIndex:1}" v-show="active1">
                    <img class="pressureSmall" src="./sub_static/UI/temLow.png" v-bind:style="{zIndex:1}" v-show="active2">
                    <img class="endBig" src="./sub_static/UI/endHigh.png" v-bind:style="{zIndex:3}" v-show="show1" >
                    <img class="endSmall" src="./sub_static/UI/endLow.png" v-bind:style="{zIndex:3}" v-show="show2" >
