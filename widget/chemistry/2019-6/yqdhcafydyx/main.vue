    ...
    <div class="aspectration bg_white root_div_container" data-ratio="16:9">
        <fullScreensLayout>
            <template slot="viewBox" slot-scope="viewBox">
                ...
                <img id="text2" :src="tipImg"
                     style="width: 11vw;position: absolute;left: 50%;top: 13%;transform: translateX(-50%);" v-show="show4" >
                <div class="buttonBox">
                ...
                <div class="reactionBox" >
                    <img class="pictureBg" src="./sub_static/UI/pictureBg.png" v-bind:style="{zIndex:1}">
                    <img class="pressureBig" src="./sub_static/UI/pressureBig.png" v-bind:style="{zIndex:1}" v-show="active1">
                    <img class="pressureSmall" src="./sub_static/UI/pressureSmall.png" v-bind:style="{zIndex:1}" v-show="active2">
                    <img class="endBig" src="./sub_static/UI/endBig.png" v-bind:style="{zIndex:3}" v-show="show1" >
                    <img class="endSmall" src="./sub_static/UI/endSmall.png" v-bind:style="{zIndex:3}" v-show="show2" >
                    <img id="text1" :src="textImg" v-bind:style="{zIndex:3}"
                         style="width: 68px;position: absolute;left: 215px;top: 14px;" v-show="show3" >
                    <div id="blackCover" v-bind:style="{zIndex:2}"></div>
                </div>
