            ...
            <template slot="viewBox" slot-scope="viewBox">
                <div id="3dContainer" style="width: 100%;height: 100%; display: flex;">
                    <div style="margin: auto; position: relative; width: 700px; height: 360px;top: 0px"  v-if="!isMobile">
                        ...
                        <div style="width: 680px; height: 360px; background: #ffffff; position: absolute; top: 0;left: 0px;" v-show="imgCtrl">
                            <img src="./sub_static/02.png" alt=""  style="width: 680px;hight: 360px">
                        </div>
                    </div>
                    <div style="margin: auto; position: relative; width: 700px; height: 360px;top: 40px"  v-else>
                        <keyFrameAnimation v-bind="animationOption1" v-model="frameNum1" ref="functionUse1" style="">
                        </keyFrameAnimation>
                        <div style="width: 340px; height: 144px; background: #ffffff; position: absolute; top: -20px;left: 170px;" v-show="imgCtrl">
                            <img src="./sub_static/02.png" alt=""  style="width: 340px;hight: 144px">
                        </div>
                    </div>
                </div>
                <div class="title_text">乙醛的羟醛缩合反应</div>
            </template>
...
<script lang="ts">
  ...
  import { YqfyViewHandler } from './service/YqfyViewHandler';
  ...
  export default Vue.extend({
    ...
    data() {
      return{
        ...
        animationOption1:{
            ...
            height: BrowserUtil.getBrowserInfo().isSmallDevice ? 160: 360
        },
      };
    ...
    created() {
        ...
        ViewController.getInstance(new YqfyViewHandler(this), viewOption);
