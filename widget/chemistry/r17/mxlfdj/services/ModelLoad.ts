...
import * as mianxin1_1 from '../sub_static/model/mianxin1_1.fbx';
import * as mianxin1_2 from '../sub_static/model/mianxin1_2.fbx';
import * as mianxin1_3 from '../sub_static/model/mianxin1_3.fbx';

import * as mianxin2_1 from '../sub_static/model/mianxin2_1.fbx';
import * as mianxin3_1 from '../sub_static/model/mianxin3_1.fbx';
import * as mianxin4_1 from '../sub_static/model/mianxin4_1.fbx';
import * as mianxin4_2 from '../sub_static/model/mianxin4_2.fbx';
import * as mianxin4_3 from '../sub_static/model/mianxin4_3.fbx';

import * as mianxin5_1 from '../sub_static/model/mianxin5_1.fbx';
import * as mianxin5_2 from '../sub_static/model/mianxin5_2.fbx';

import * as mianxin6_1 from '../sub_static/model/mianxin6_1.fbx';
import * as mianxin6_2 from '../sub_static/model/mianxin6_2.fbx';

import * as mianxin7_1 from '../sub_static/model/mianxin7_1.fbx';
import * as mianxin7_2 from '../sub_static/model/mianxin7_2.fbx';
...
export class ModelLoad extends ThreeBase {
  ...
  static preload() {
    const modelArray = [
      mianxin1_1, image01, image02, image03, mianxin2_1,
      mianxin3_1, mianxin4_1, mianxin4_2, mianxin4_3, mianxin5_1,
      mianxin5_2, mianxin6_1, mianxin6_2, mianxin7_1, mianxin7_2,
      xianFbx
    ];
  ...
  // 添加文字
  addText() {
    const rText = ModelLoad.createText('4r', 0, 0, 30, '#000000');
    const aText = ModelLoad.createText('a', 0, -25, 30, '#000000');
    this.obj7.add(rText);
    this.obj7.add(aText);
    rText.visible = false;
    aText.visible = false;
  ...
  scene6Animation() {
    ...
    const tween2 = {
      ...
      angleZ: 0,
      x1: 0,
      y1: this.obj6.children[1].position.y,
      z1: 0,
      x2: 0,
      y2: 0,
      z2: 0,
    ...
    this.animationScene6_2 = TweenMax.to(tween2, 1, {
      angleX: Math.PI / 4,
      angleZ: Math.PI / 5,
      x1: this.obj6.children[1].position.x + 42 - 13,
      y1: this.obj6.children[1].position.y + 25,
      z1: this.obj6.children[1].position.z - 5 - 40,
      x2: -13,
      z2: -40,
      onUpdate: () => {
        (this.obj6.children[1]).rotation.z = tween2.angleZ;
        (this.obj6.children[1]).rotation.x = tween2.angleX;

        (this.obj6.children[1]).position.x = tween2.x1;
        (this.obj6.children[1]).position.y = tween2.y1;
        (this.obj6.children[1]).position.z = tween2.z1;
  ...
  scene7Animation() {
    ...
    this.animationScene7_2 = TweenMax.to(tween2, 1, {
      ...
      onComplete: () => {
        ...
        this.obj7.children[4].visible = true;
      },
      paused: true
    });
  }
  ...
  scene7AuxiliaryLine2() {
    ...
    this.obj7.children[4].visible = false;
  }
