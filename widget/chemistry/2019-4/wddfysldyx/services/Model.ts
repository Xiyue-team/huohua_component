...
export class Model extends ThreeBase {
    ...
    private circleBg2 = common.drawCircle(170, {color: '#4c4949'});
    private circleBg3 = common.drawCircle(170, {color: '#817a7a'});
    // 创建分子组及分子变量
    ...
    initObject() {
        this.initialMoveAni(7, 3);
        this.runAnimation(0.7);
        this.decomposeEvent(2000);
        this.scene.add(this.circle, this.equation, this.circleBg, this.circleBg2, this.circleBg3, );
        this.circleBg.visible = false;
        this.circleBg3.visible = false;
    }
    // 设置碰撞反应柱状图样式
    histogram1() {
    ...
    lowTemperatureEvent() {
        this.clearTimer();
        this.anewMolecule();
        this.initialMoveAni(5, 5);
        this.runAnimation(0.5);
    ...
    mediumTemperatureEvent() {
        ...
        this.circleBg2.visible = true;
    }
    // 高温度条件下反应情况
    highTemperatureEvent() {
        this.clearTimer();
        this.anewMolecule();
        this.initialMoveAni(9, 1);
        this.runAnimation(0.9);
        this.decomposeEvent(1000);
        this.changeEchartData(9, 9, 6000);
        this.circleBg3.visible = true;
    }
