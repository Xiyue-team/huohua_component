  ...
  watch:{
    mark1(val){
        if(val){
          ...
          this.text = '多层磁感线'
          this.src1='./static/11111.png'
        }else{
          this.obj2.visible = false;
          this.obj1.visible = true;
          this.text = '单层磁感线'
          this.src1='./static/11.png'
        }
...
return
    ...
    bp(){
        ...
        if(this.obj1.rotation.y !=0){
          this.obj1.rotation.y = 0 ;
          this.obj2.rotation.y = 0

        }else{

          this.obj1.rotation.y = Math.PI
    ...
    init() {
      ...
      var initScene = (url, url2) => {
        ...
        loader.load( url, function ( object ) {
          ...
          scene.add(  thiz.obj1 );
          thiz.obj1.children[2].children[0].material.side = 1;
          thiz.obj1.children[2].children[0].material.depthWrite = false
          object.scale.set(1.02,1.02,1.02);
          setTimeout(()=>{
            thiz.maker11 = false
            thiz.nv = false
          },1500)
        ...
        loader.load( url2, function ( object ) {
          object.mixer = new THREE.AnimationMixer( object );
          console.log( thiz.mixer2)
          thiz.mixer2.push( object.mixer );
          var action = object.mixer.clipAction( object.animations[ 0 ] );
          action.loop = THREE.LoopRepeat
          console.log(object);
          action.play();
          thiz.loadModelF = true;
          thiz.obj2 = object
          thiz.obj2.children[0].children[0].material.side = 1;
          thiz.obj2.children[0].children[0].material.depthWrite = false
          scene.add( thiz.obj2 );
      ...
      initScene('./static/cgx1/luoxuan_dantao.fbx','./static/cgx2/3125.fbx');
      var mark =()=>{
