...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      initScene('./static/FBX/huluxian.fbx');
      var mark =()=>{
        ...
        this.bxM = new THREE.Mesh(new THREE.PlaneGeometry(10,5),new THREE.MeshBasicMaterial( { map:new THREE.TextureLoader().load("./static/baoX.png"),transparent:true} ));
        this.jiagenM = new THREE.Mesh(new THREE.PlaneGeometry(10,5),new THREE.MeshBasicMaterial( { map:new THREE.TextureLoader().load("./static/jiagen.png"),transparent:true} ));
        this.jingM = new THREE.Mesh(new THREE.PlaneGeometry(10,5),new THREE.MeshBasicMaterial( { map:new THREE.TextureLoader().load("./static/jing.png"),transparent:true} ));
        this.yeM = new THREE.Mesh(new THREE.PlaneGeometry(10,5),new THREE.MeshBasicMaterial( { map:new THREE.TextureLoader().load("./static/ye.png"),transparent:true} ));


        var textps = tools.createText('孢蒴', -1, -1, 0.1, '#7d7d7d', 1000);
        this.bxM.scale.set(0.2,0.2,0.2);
        this.bxM.position.set(-1.8,5.15,0.1);

        var textye = tools.createText('叶', -1, -1, 0.1, '#7d7d7d', 1000);
        this.yeM.scale.set(0.2,0.2,0.2);
        this.yeM.position.set(3.2,-2.45,0.1);

        var textjing = tools.createText('茎', -1, -1, 0.1, '#7d7d7d', 1000);
        this.jingM.scale.set(0.2,0.2,0.2);
        this.jingM.position.set(-2.5,-3.65,0.1);

        var textjiagen = tools.createText('假根', -1, -1, 0.1, '#7d7d7d', 1000);
        this.jiagenM.scale.set(0.2,0.2,0.2);
        this.jiagenM.position.set(2.7,-4.1,0.1);

        this.group.add(ps, ye, jing, jiagen,this.bxM,this.yeM,this.jingM,this.jiagenM);
      ...
      var render = () => {
        ...
        this.bxM.lookAt(camera.position)
        this.jiagenM .lookAt(camera.position)
        this.jingM .lookAt(camera.position)
        this.yeM .lookAt(camera.position)
