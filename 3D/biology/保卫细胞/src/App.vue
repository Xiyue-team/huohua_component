  ...
  methods: {
    ...
    init() {
      ...
      var initScene = (url) => {
        ...
        this.light1 = new THREE.HemisphereLight('#37DEEF', '#EFC537',0.7);
        this.light2 = new THREE.HemisphereLight('#37DEEF', '#EFC537',0.7);
        this.light1.position.set(70, 100, 100);
        this.light2.position.set(-50, -100, -100);

        camera.add(this.light1);
        camera.add(this.light2);
        ...
        loader.load( url, function ( object ) {
          ...
          // scene.add(object.children[0],object.children[1],object.children[3],object.children[4],object.children[5],object.children[6],object.children[11],this.group);
          scene.add( object);
          object.children[3].material.depthWrite = false;
          object.children[11].material.depthWrite = false;
          object.children[4].material.depthWrite = false;
          object.children[10].material.depthWrite = false;
          // object.remove( obj7)
          // // scene.add( obj7)
      ...
      initScene('./static/FBX/baoweixibao.fbx ');
     var bm =() =>{
      ...
      var changeSence = function() {
        ...
        if (index == 0 && thiz.cameraF) {
          ...
          console.log(thiz.light1)
          thiz.light1.intensity =0.23
          thiz.light2.intensity =0.23
        } else if (index == 2) {
          renderer.setClearColor(0x000000);
          thiz.light1.intensity =0.53
          thiz.light2.intensity =0.53
        }
      }
      if (isMob) {
