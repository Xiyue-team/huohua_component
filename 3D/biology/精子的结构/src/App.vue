<template>
  <div id="app" class="noselect">
    ...
    <video v-show="cameraF&&srcObjectF" :class="{videoH:WH,videoW:!WH}" autoplay="autoplay" id="video" muted="muted" poster="./static/fff.png" playsinline="playsinline"  style="display: none;"></video>
    <div class="wxtip" id="JweixinTip" :style="'background-image: url(./static/UI/weixin-tip.png);'"></div>
    <div class="btnG">
      <button :class="{active: mark1}" @click="bm()" > 标记</button>
    </div>
  ...
  watch:{
    mark1(val){
        if(val){
          ...
          this.obj1.children[10].visible = true;

        }else{

            this.obj1.children[10].visible = false;
    ...
    init() {
      ...
      var initScene = (url, url2) => {
        ...
        loader.load( url, function ( object ) {
          ...
          console.log( thiz.mixer)
          thiz.mixer.push( object.mixer );
          ...
          thiz.obj1 = object;
          console.log(object);
            thiz.obj1.children[10].visible = false
            thiz.obj1.children[10].children[3].geometry.computeBoundingBox();
            thiz.obj1.children[10].children[3].geometry.center();
            thiz.obj1.children[10].children[3].position.set(3,4.3,0);
            //
            thiz.obj1.children[10].children[2].geometry.computeBoundingBox();
            thiz.obj1.children[10].children[2].geometry.center();
            thiz.obj1.children[10].children[2].position.set(7,5.1,0);
            //
            thiz.obj1.children[10].children[1].geometry.computeBoundingBox();
            thiz.obj1.children[10].children[1].geometry.center();
            thiz.obj1.children[10].children[1].position.set(5.5,-0.8,0);
            // thiz.obj1.children[16].up=camera.position

            thiz.obj1.children[10].children[0].geometry.computeBoundingBox();
            thiz.obj1.children[10].children[0].geometry.center();
            thiz.obj1.children[10].children[0].position.set(8.2,-0.8,0);

            thiz.obj1.children[10].children[4].material = thiz.obj1.children[10].children[0].material;
            thiz.obj1.children[10].children[5].material = thiz.obj1.children[10].children[0].material;
            thiz.obj1.children[10].children[6].material = thiz.obj1.children[10].children[0].material;
            thiz.obj1.children[10].children[7].material = thiz.obj1.children[10].children[0].material;
            thiz.obj1.children[10].children[0].rotation.set(Math.PI+camera.rotation.x,Math.PI ,Math.PI )
            thiz.obj1.children[10].children[1].rotation.set(Math.PI+camera.rotation.x,Math.PI ,Math.PI )
            thiz.obj1.children[10].children[2].rotation.set(Math.PI+camera.rotation.x,Math.PI ,Math.PI )
            thiz.obj1.children[10].children[3].rotation.set(Math.PI+camera.rotation.x,Math.PI ,Math.PI )
          // object.rotation.set(Math.PI /3,-1.3*Math.PI/2,-Math.PI /1.2);
          // //   object.position.x = -1
        ...
        orbitControls.addEventListener( 'change',  ()=>{
            ...
            thiz.obj1.children[10].children[0].lookAt(camera.position)
            thiz.obj1.children[10].children[1].lookAt(camera.position)
            thiz.obj1.children[10].children[2].lookAt(camera.position)
            thiz.obj1.children[10].children[3].lookAt(camera.position)
            // thiz.obj1.children[10].children[0].rotation.set(Math.PI+camera.rotation.x,Math.PI ,Math.PI )
            // thiz.obj1.children[10].children[1].rotation.set(Math.PI+camera.rotation.x,Math.PI ,Math.PI )
            // thiz.obj1.children[10].children[2].rotation.set(Math.PI+camera.rotation.x,Math.PI ,Math.PI )
            // thiz.obj1.children[10].children[3].rotation.set(Math.PI+camera.rotation.x,Math.PI ,Math.PI )
            // thiz.obj1.children[10].children[4].rotation.set(Math.PI+camera.rotation.x,Math.PI ,Math.PI )
            // console.log(camera.rotation.x)
            // thiz.obj1.children[15].lookAt(camera.position)
            // thiz.obj1.children[14].lookAt(camera.position)
              })
      };
      initScene('./static/fbx/jingxi.fbx');
      var mark =()=>{
      ...
      var render = () => {
        ...
        if(0){
          if ( this.mixer2.length > 0 ) {
            for ( var w = 0; w < this.mixer2.length; w ++ ) {
              this.mixer2[ w ].update( clock.getDelta() );
            }
          }
        }else{
          if ( this.mixer.length > 0 ) {
            for ( var i = 0; i < this.mixer.length; i ++ ) {
              this.mixer[ i ].update( clock.getDelta() );
            }
          }
        }
