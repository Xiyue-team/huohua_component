...
<script>
import { Math, TextureFilter } from 'three';
...
export default {
  ...
  methods: {
    ...
    bxbb(){
       this.bxb.children[1].visible = !this.bxb.children[1].visible
       this.bxb.children[2].visible = !this.bxb.children[2].visible
       if(this.bxb.children[2].visible){
         this.bj='隐藏'
       }else{
          this.bj='标记'
       }
 ...
 this.bxbV =!this.bxbV
      this.hxbV = !this.bxbV
      this.xxbV = !this.bxbV
      this.hxb.visible = this.hxbV
      this.bxb.visible = this.bxbV
      this.xxb.visible = this.xxbV 
    ...
    init() {
      ...
      var initScene = (url) => {
        ...
        this.camera.position.set(50, 50,70);
    ...
    this.camera.add(light2);
        ...
        loader.load(url, (data) => {
          ...
          this.orbitControls.maxDistance = 300;
              ...
              this.hxb.scale.set(1.7,1.7,1.7);
        ...
        loader.load('./static/qyj/baixibao.gltf', (data) => {
          gltf = data;
          this.bxb = gltf.scene;
  
          let img = new THREE.TextureLoader().load("./static/qyj/baixibaomap_normals.bmp");
          // this.bxb.children[1].visible = !this.bxb.children[1].visible
          // this.bxb.children[2].visible = !this.bxb.children[2].visible
          this.bxb.scale.set(1.7,1.7,1.7);
             console.log( this.bxb)
          this.bxb.traverse((node) => {
           if(node.name == "waimo"){
          ...
          console.error(error);
                  ...
                  loader.load('./static/qyj/xxb/xuexiaoban.gltf', (data) => {
          gltf = data;
          this.xxb = gltf.scene;
  
              this.xxb.scale.set(0.5,0.5,0.5);
             
          this.xxb.traverse((node) => {
...
node.geometry.computeBoundingBox();
  node.material.color = this.xxb.children[1].children[0].material.color
