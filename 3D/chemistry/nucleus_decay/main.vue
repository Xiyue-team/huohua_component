...
export default Vue.extend({
    ...
    watch:{
        uniformMagnetic:(val)=>{
            // 开启/关闭 匀强磁场
            if(val == true){
                (ViewController.getInstance().viewHandler as NucleusViewHandler).nucleusModel.enableUniformMagneticAnimation();
            }else{
                (ViewController.getInstance().viewHandler as NucleusViewHandler).nucleusModel.disableUnformMagneticAnimation();
            }
