<template>
  <div class="container">
    ...
    >
      <!-- <div
        style="background: #fff;box-shadow: 0 0 10px rgba(0,0,0,0.3);color: #333;"
        v-text="button_text"
      ></div> -->
    </div>
    <div
...
<script>
      ...
      createScene(engine) {
        ...
        function clickButtonEvent() {
          ...
          if (num == 1) {
            ...
            materialPlane.diffuseTexture = new BABYLON.Texture("static/image/earth_bankuai.jpg", scene);
 ...
 thiz.bb = true
        ...
        if (isMob) {
          ...
          $('#imageShow').on('touchstart', onCloseClick);
