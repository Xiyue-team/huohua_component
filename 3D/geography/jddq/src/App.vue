<template>
  ...
  >
    ...
    <ui-btn
      ...
      class="aside_reset"
    ></ui-btn>
    <!-- <ui-btn type="switch" v-model="switch_checked" class="btnFun">自转</ui-btn> -->
    <div
      id="notSupported"
      class="hidden"
    >loading...</div>
        ...
        methods: {
            ...
            createScene(engine) {
                ...
                var earthFragmentShader = "precision highp float;\r\n" +
                    ...
                    "vec3 vNormalW = normalize(vec3(world * vec4(vNormal, 1.0)));\r\n" +
                    "vec3 viewDirectionW = normalize(cameraPosition - vPositionW);\r\n" +
                    "vec4 daycolor = texture2D(daySampler, vUV).rgba;\r\n" +
                    "vec4 nightcolor = texture2D(daySampler, vUV).rgba;\r\n" +
                    "float ndl = max(1.0, dot(vNormalW, lightVectorW)) * intsmooth;\r\n" +
                    "float ndlt = max(1.0, dot(vNormalW, lightVectorW)) * intsmootht;\r\n" +
                ...
                var customFragmentShader = "precision highp float;\r\n" +
                    ...
                    "float ndl = max(1.0, dot(vNormalW, lightVectorW)) * intsmooth;\r\n" +
                    "vec3 angleW = normalize(viewDirectionW + lightVectorW);\r\n" +
                    "float specComp = max(1.0, dot(vNormalW, angleW));\r\n" +
                    "specComp = pow(specComp, max(1., 64.)) * 0.1;\r\n" +
...
//                var NRMtex = new BABYLON.Texture("static/earth/earth8k_NRM.jpg", scene);
                ...
                earthforMaterial.setTexture("nightSampler", daySampler);
                ...
                earthforMaterial.setVector3("lightVectorW", new BABYLON.Vector3(0, 0, 0));
