                ...
                <div class="main-content">
                    <div class="videoBox">
                        <video id="microVideo" class="video-js VideoStyle vjs-default-skin vjs-big-play-none"
                            ...
                            <source id="sourceId1" ref="icon" :src="videoSrc" type="video/mp4">
                        </video>
                    </div>
                    ...
                    <div class="contatiner">
                        ...
                        <div id="navigatorBar" v-show="showNavigatorBar">
                            ...
                            <div @href="void(0)" :id="'naviTab'+index" class="naviTab" v-for=" (navigatorStep,index) in navigatorSteps" @click="initbuttonClickEvent(index)">
                                ...
                                <img class="csImg" :id="'csImg' + index" style="display: inline" src="../../../../static/dldh/csbfan.svg">
                            </div>
                        </div>
                        ...
                        <div id="controlBar" v-show="showControlBar">
                            ...
                            <div v-bind:id="'controlTab'+index" class="controlTab"
                                ...
                                <img v-bind:id="'playBtn'+index" class="bfztImg " src="../../../../static/dldh/bfan.svg" v-bind:class="{'animate-fall-down': typefall[index],'animate-bounce-up': typebounce[index] }" v-show="!controlSteps[index].isPlaying">
                                <img v-bind:id="'stopBtn'+index" class="bfztImg " src="../../../../static/dldh/ztan.svg" v-bind:class="{'animate-fall-down': typefall[index],'animate-bounce-up': typebounce[index]  }" v-show="controlSteps[index].isPlaying">
