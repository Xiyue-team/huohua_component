    ...
    <div id="app" class="noselect">
        <div class="container">
            ...
            <div class="footerTrue">
                ...
                <div class="footer">
                    <ui-slider id='slider' class="footerSlider" :min="0" :max="102" :title="false" :box="false"
    ...
    export default {
        ...
        data() {
            return {
                ...
                sliderPoint: [0, 46, 69, 102],
                sliderPoint1: [0, 48, 73, 102],
                index: 0,
                f: "",
                store: "",
                mark: 0,
        ...
        methods: {
            ...
            setSliderPonint() {
                ...
                $('#sliderP span').each(function () {
                    $(this).index();
                    $(this).css("left", sliderW * vm.sliderPoint[$(this).index()] / 102 - 7)
                });
                $('.ui-label li').each(function () {
                    $(this).index();
                    $(this).css("left", sliderW * vm.sliderPoint[$(this).index()] / 102 + 22)
                })
            },
