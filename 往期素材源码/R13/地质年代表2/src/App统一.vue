    ...
    export default {
        ...
        methods: {
            ...
            inits() {
                ...
                mtlLoader.load(mtl, function(materials) {
                  ...
                  objLoader.load(obj, function(object) {
                    ...
                    for (let i in materials.materials) {
                      ...
                      materials.materials[i].wireframe = true;
                    }
              ...
              modelPut('zed.obj', 'zed.mtl', model, 8, (O) => {
                model = O;
                if (!model == null) {
                  scene.remove(model);
                }
              ...
              var show1 = (f) => {
                if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('beizizhiwu') != -1) {
              ...
              var show2 = (f) => {
                if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('dunpiyu') != -1) {
                      model.children[i].visible = true;
                    }
                  }
                }
              ...
              var show3 = (f) => {
               if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('hongzao') != -1) {
                      model.children[i].visible = true;
                    }
                  }
                }
              ...
              var show4 = (f) => {
                if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('jianchihu') != -1) {
                      model.children[i].visible = true;
                    }
                  }
                }
              ...
              var show5 = (f) => {
                if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('lanzao') != -1) {
                      model.children[i].visible = true;
                    }
                  }
                }
              ...
              var show6 = (f) => {
                if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('sanjiaolong') != -1) {
                      model.children[i].visible = true;
                    }
                  }
                }
              ...
              var show7 = (f) => {
                if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('shisong') != -1) {
                      model.children[i].visible = true;
                    }
                  }
                }
              ...
              var show8 = (f) => {
                if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('xiyi') != -1) {
                      model.children[i].visible = true;
                    }
                  }
                }
              ...
              var show9 = (f) => {
               if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('xijun') != -1) {
                      model.children[i].visible = true;
                    }
                  }
                }
              ...
              var show10 = (f) => {
               if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('yinxinshu') != -1) {
                      model.children[i].visible = true;
                    }
                  }
                }
              ...
              var show11 = (f) => {
                if (f) {
                  for (var i in model.children) {
                    if (model.children[i].name.indexOf('zhiren') != -1) {
                      model.children[i].visible = true;
                    }
                  }
                }
