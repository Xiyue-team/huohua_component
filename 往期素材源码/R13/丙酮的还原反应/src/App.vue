    ...
    <div id="app" class="noselect">
        <div class="container">
            ...
            <div class="footerTrue">
                ...
                <div class="footer">
                    <ui-slider id='slider' class="footerSlider" :min="0" :max="113" :title="false" :box="false"
    ...
    export default {
        ...
        data() {
            return {
                ...
                sliderPoint: [0, 25, 76, 113],
                sliderPoint1: [0, 27, 82, 113],
                index: 0,
                f: "",
                store: "",
                mark: 0,
        ...
        methods: {
            ...
            setSliderPonint() {
                ...
                $('#sliderP span').each(function () {
                    $(this).index();
                    $(this).css("left", sliderW * vm.sliderPoint[$(this).index()] / 113 - 7)
                });
                $('.ui-label li').each(function () {
                    $(this).index();
                    $(this).css("left", sliderW * vm.sliderPoint[$(this).index()] / 113 + 22)
                })
            },
            //计算区块大小
            getViewSize() {
