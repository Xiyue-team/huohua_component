    ...
    <div id="app" class="noselect">
        <div class="container">
            ...
            <div class="footerTrue">
                ...
                <div class="footer">
                    <ui-slider id='slider' class="footerSlider" :min="0" :max="120" :title="false" :box="false"
        ...
        methods: {
            ...
            setSliderPonint() {
                ...
                $('#sliderP span').each(function () {
                    $(this).index();
                    $(this).css("left", sliderW * vm.sliderPoint[$(this).index()] / 120 - 7)
                });
                $('.ui-label li').each(function () {
                    $(this).index();
                    $(this).css("left", sliderW * vm.sliderPoint[$(this).index()] / 120 + 22)
                })
            },
            //计算区块大小
            getViewSize() {
