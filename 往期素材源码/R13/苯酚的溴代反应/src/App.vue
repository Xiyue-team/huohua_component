    ...
    <div id="app" class="noselect">
        <div class="container">
            ...
            <div class="footerTrue">
                <div class="cz"></div>
                <div class="footer">
                    <ui-slider id='slider' class="footerSlider" :min="0" :max="110" :title="false" :box="false"
        ...
        methods: {
            ...
            setSliderPonint() {
                ...
                $('#sliderP span').each(function () {
                    $(this).index();
                    $(this).css("left", sliderW * vm.sliderPoint[$(this).index()] / 110 - 7)
                });
                $('.ui-label li').each(function () {
                    $(this).index();
                    $(this).css("left", sliderW * vm.sliderPoint[$(this).index()] / 110 + 22)
                })
            },
            //计算区块大小
            getViewSize() {
