    ...
    export default {
        ...
        methods: {
            ...
            init() {
                ...
                //黑色底板
                var geometry = new THREE.PlaneGeometry(76,502, 1, 1);
                var material = new THREE.MeshBasicMaterial({color:'#000'});
                var bgp=new THREE.Mesh(geometry, material);
                bgp.position.x=365;
                scene.add(bgp);

                //加载粒子发射器模型
                var loaderGLTF = new THREE.GLTFLoader();
                loaderGLTF.load('./static/obj/dinengdianziqiang.gltf', (data) => {
                ...
                Text.position.set(-430, 100, 5);
                scene.add(Text);

                //电子
                var DZ = createP(100, 100, './static/UI/fire.png');
                DZ.material.depthTest=false;
                DZ.position.set(-330, 0, -10);
