...
var createLineMesh = (vertices, style = 3, width = 1, color = '#000',opacity=1) => {
  var lineMesh = null,
...
var createStraightLine = (arr, style = 3, width = 1, color = '#000',opacity =1) => {
  let vertices = [];
  for (let value of arr) {
    vertices.push(vec3(...value));
  }
  let line = createLineMesh(vertices, style, width, color,opacity);
  return line;
}
