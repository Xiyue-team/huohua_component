        ...
        <div ref="elem" aria-hidden="true"
            ...
            <template v-if="valueIsArray">
                <div ref="dot0"
                    ...
                    <span v-text="dotTxt && dotTxt[0]" class="dotTxt" :style="'background:url(static/UI/hua.png) 50% 50% no-repeat;backgroundSize:80% 80%;'"></span>
                    <!--tip-->
            ...
            {{ formatter ? formatting(val[0]) : val[0] }}
                ...
                >
                    <span v-text="dotTxt && dotTxt[1]" class="dotTxt" :style="'background:url(static/UI/hua.png) 50% 50% no-repeat;backgroundSize:80% 80%;'"></span>
                    <!--tip-->
            ...
            <template v-else>
                ...
                >
                    <span v-text="dotTxt" class="dotTxt" :style="'background:url(static/UI/hua.png) 50% 50% no-repeat;backgroundSize:80% 80%;'"></span>
                    <!--tip-->
            ...
            <!--滑条及滑条上的圆点、文字-->
            <ul class="ui-piecewise" :style="'opacity:0'">
            ...
            <!--蓝色滑条-->
            <div ref="process" class="vue-slider-process" :style="'opacity:0'"></div>
        </div>
        <!--无穷大样式-->
            ...
            * */
            getPos (e) {
              ...
              if(this.direction === 'vertical'){
                if(this.reverse){
                  return (e.clientY/this.zoom - this.offset)*this.zoom;
                }else{
