...
window.resolution = new THREE.Vector2(window.innerWidth - 348, window.innerHeight - 144);
...
var drawCircleLine = (radius, { style = 3, color = '#000', line_width = 2, isLay = false, position = [0, 0, 0] } = {}) => {
  ...
  let line = createLineMesh(vertices, '#FFF', style, line_width);
...
var createText = (texts, x, y, z, color = '#000', size = 48,sub=false) => {
