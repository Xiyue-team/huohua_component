<template>
    <div ref="wrap"
         :class="['uiSlider',isBox, flowDirection,  { 'ui-has-piecewise': piecewiseLabel,timeLine:timeLine,'noBlueProcess':noBlueProcess?noBlueProcess:noBlue }]"
         :style="wrapStyles"
         @click="wrapClick">
        <!--标题-->
        ...
        <!--滑条上的文字-->
        <ul v-if="timeLine && label"
            ref="label"
            :style="{width:infinity?'53%':''}"
            :class="'label'+labelRows.length"
            class="ui-label">
      ...
      <ul v-if="!timeLine && label"
        ...
        <div ref="elem" aria-hidden="true"
            ...
            <ul class="ui-piecewise">
                <li v-for="(obj, index) in piecewiseDotWrap"
                    ...
                    <span v-if="piecewiseLabel"
                          ...
                          :style="{fontSize:title&&!obj.inRange?'12px':'',lineHeight:title&&!obj.inRange?'18px':''}"
            ...
            <div id="dotD" style="width: 73px;height:381px;position: absolute;top:0px;left:-2px;">
                <div style="width: 9px;height:381px;position: absolute;top:0px;left:0px;">
                    <span :style="'top:0;'" :class="{b1:value>=200}">
                        <span>3000km</span>
                    </span>
                    <span :style="'top:57px;'" :class="{b1:value>=170}">
                        <span>1500km</span>
                    </span>
                    <span :style="'top:114px;'" :class="{b1:value>=140}">
                        <span>500km</span>
                    </span>
                    <span :style="'top:171px;'" :class="{b1:value>=110}">
                        <span>85km</span>
                    </span>
                    <span :style="'top:228px;'" :class="{b2:value>=80}">
                        <span>55km</span>
                    </span>
                    <span :style="'top:284px;'" :class="{b3:value>=50}">
                        <span>12km</span>
                    </span>
                </div>
            </div>
            ...
            getPos (e) {
                ...
                if(this.direction === 'vertical'){
                    if(this.reverse){
                        ...
                        return (this.size - (e.clientY - this.offset)/this.zoom)
                    }
                }else{
                    if(this.reverse){
            ...
            setTransform (val) {
              ...
              this.getActiveLabel(value)
                ...
                if (this.valueIsArray) {
                    ...
                    if (this.direction === 'vertical') {
                        this.$refs.process.style.height = `${381-val}px`
                        this.$refs.process.style[this.reverse ? 'bottom' : 'top'] = 0
                    }
                    else {
...
<style>
    ...
    .uiSlider.vue-slider-vertical .vue-slider::after{
        border-radius: 15px;
        background: -webkit-linear-gradient(to top,#5FD7E6 95px,#5CAEFD 57px,#B96CEC 229px); /* Safari 5.1 - 6.0 */
        background: -o-linear-gradient(to top,#5FD7E6 95px,#5CAEFD 57px,#B96CEC 229px); /* Opera 11.1 - 12.0 */
        background: -moz-linear-gradient(to top,#5FD7E6 95px, #5CAEFD 57px,#B96CEC 229px); /* Firefox 3.6 - 15 */
        background: linear-gradient(to top,#5FD7E6 95px,#5CAEFD 57px,#B96CEC 229px); /* 标准的语法 */
        /*content: '';*/
        position: absolute;
        z-index: 1;
        /*left: -3px;*/
