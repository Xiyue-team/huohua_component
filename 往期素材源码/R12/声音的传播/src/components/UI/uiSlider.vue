      ...
      <ul v-if="!timeLine && label"
        ...
        <div ref="elem" aria-hidden="true"
            ...
            <template v-else>
                ...
                >
                    <img src="static/UI/move.png" id="moveI" draggable="false" style="'pointer-events:none;width:155px;height:41px;position:absolute;top:3px;left:-130px;'">
...
<script>
    export default {
        ...
        props: {
            ...
            //外框宽度
            boxWidth: {type: [Number, String],default: 165},
            //外框高度
