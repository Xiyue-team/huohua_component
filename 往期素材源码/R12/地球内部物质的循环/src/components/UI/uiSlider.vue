      ...
      <ul v-if="!timeLine && label"
        ...
        <div ref="elem" aria-hidden="true"
            ...
            <template v-else>
                ...
                >
                    <div :style="'width:2px;height:450px;background-color: #fff;background-color: #ffffff;box-shadow:rgba(0, 0, 0, 0.24) 0px 0px 2px 0px;border: solid 0.5px rgba(0, 0, 0, 0.06);position:absolute;left:21px;bottom:30px;z-index:1;'"></div>
            ...
            <ul class="ui-piecewise">
                <li v-for="(obj, index) in piecewiseDotWrap"
                    ...
                    <span v-if="piecewiseLabel"
                          class="ui-piecewise-label ui-piecewise-label-bottom"
                          :style="{fontSize:title&&!obj.inRange?'12px':'',lineHeight:title&&!obj.inRange?'18px':''}"
                          :class="{labelActiveStyle:obj.inRange}">
                            {{ obj.label[1] }}
                    </span>
...
<script>
    export default {
        ...
        props: {
            ...
            //外框宽度
            boxWidth: {type: [Number, String],default: 708},
            //外框高度
...
<style>
    ...
    .uiSlider.vue-slider-horizontal .ui-piecewise-label-bottom{
        top:20px;
    }
