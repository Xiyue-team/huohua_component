<template>
  <div class="UI-btn" :class="classObj" :value="value" @click="clickEvent">
    ...
    <img src="static/UI/back@2x.png" v-if="type==='reset3'" alt="">
    <!--允许自定义内容-->
    ...
    <span :class="{checked:value}" v-if="this.type==='switch'"><em :class="{checked:value}" ></em></span>
  </div>
</template>
...
<script>
  export default{
    ...
    computed:{
      ...
      classObj(){
        return {
          'btn-48':this.type==='reset1' || this.type==='reset2' || this.type==='reset3',
...
<style>
  ...
  .btn-switch span.checked>em.checked{
    float: right;
    margin-top: 3px;
    margin-left: 0;
    margin-right: 3px;
