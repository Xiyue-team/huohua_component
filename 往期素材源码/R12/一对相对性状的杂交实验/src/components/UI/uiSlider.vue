  ...
  <div ref="elem" aria-hidden="true" class="vue-slider" :style="[elemStyles,infinityStyle]">
    ...
    <ul class="ui-piecewise">
      <li v-for="(obj, index) in piecewiseDotWrap" class="ui-piecewise-item" :style="[piecewiseDotStyle, obj.style]" :key="index">
        ...
        <!--滑条上方的文字-->
        <span v-if="piecewiseLabel" class="ui-piecewise-label" :style="{fontSize:title&&!obj.inRange?'12px':'',lineHeight:title&&!obj.inRange?'18px':''}" :class="{labelActiveStyle:obj.inRange,currentText:value==obj.label}">
							{{ obj.label }}
						</span>
      </li>
    </ul>
