<template>
  <div class="UI-btn" :class="classObj" :value="value" >
    <!--重置按钮-->
    ...
    <p v-if="this.type==='switch'" @click="clickEvent"><slot></slot></p>
    <div v-if="this.type==='switch'&&value" class="prove">
      <p>1. 向沸腾的蒸馏水中逐滴加入1~2mL饱和FeCl<sub>3</sub>溶液</p>
      <p>2. 继续煮沸至液体呈红褐色</p>
      <p>3. 停止加热</p>
      <p>原理：</p>
      <p>FeCl<sub>3</sub>+3H<sub>2</sub>O=Fe(OH)<sub>3</sub>(胶体)+3HCl</p>
    </div>
  </div>
</template>
