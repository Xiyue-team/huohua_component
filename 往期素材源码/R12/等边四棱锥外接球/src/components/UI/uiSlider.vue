...
export default {
  ...
  if(this.direction === 'vertical'){
    if(this.reverse){
      return (e.clientY - this.offset)*this.zoom;
    }else{
      return this.size - (e.clientY/this.zoom- this.offset);
    }
  }else{
    if(this.reverse){
      return this.size*this.zoom- (e.clientX- this.offset)/this.zoom;
    }else{
      return (e.clientX - this.offset)/this.zoom;
    }
  }
},
    /*
