...
var selectFunction = 6,valueA=2,valueB=1;
var opened=0;
...
function ThreeDimensional() {
    ...
    var axis={},funcs=[null,null,null,null,null,null];
    ...
    function countFunction(){
        ...
        geometry = new THREE.Geometry();
        geometry.vertices = curve.getPoints(100);
        material = new THREE.LineBasicMaterial({color : '#ff00c0'});
...
$('#slider2').bind('change',sliderChange);

function returnRange(){
    $('#slider1').attr('value',''+2+'|0');
    $('.slider1 .xdsoft_slider_label').text(''+2);

    var perLength = 410/30;
    var value = 2;
    ...
    $('.slider2 .xdsoft_range2dslider_runner ').css('left',0);
    $('.slider2 .sliderLeft').css('width',0);
