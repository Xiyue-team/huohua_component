...
var shadeText =['<p><img src="images/1.png" class=""/></p>','<p><img src="images/2.png" class=""/></p>','<p><img src="images/3.png" class=""/></p>','<p><img src="images/4.png" class=""/></p>'];
...
function ThreeDimensional() {
    ...
    var axis={},funcyx=null,func1 = null,func4=null,funcs=[null,null,null,null,null,null,null,null,null,null],funcsM=[null,null,null,null,null,null,null,null,null,null];
    ...
    this.rolioEve = function(){
        ...
        if(radioSelect == 1){
            ...
            if(selectFunction == 4){
                funcs[2*selectFunction].rotation.x = 0;
                funcs[2*selectFunction].rotation.y =  Math.PI;
                funcs[2*selectFunction+1].rotation.x = 0;
                funcs[2*selectFunction+1].rotation.y =  Math.PI;
            }
            ...
            if(selectFunction == 1 || selectFunction == 3){
                funcsM[2*selectFunction-2].visible = false;
                funcsM[2*selectFunction-2].visible =  false;
                funcsM[2*selectFunction-1].visible =  false;
                funcsM[2*selectFunction-1].visible =  false;
            }else if(selectFunction == 2){
                funcs[2*selectFunction-2].position.x += 100;
                funcs[2*selectFunction-2].position.y += 100;
                funcs[2*selectFunction-1].position.x += 100;
                funcs[2*selectFunction-1].position.y += 100;
    ...
    function countFunction(){
        ...
        geometry.vertices = curve.getPoints(100);
        material = new THREE.LineBasicMaterial({color : '#1161c8'});
        func1 = new THREE.Line(geometry, material);
        thiz.scene.add(func1);
        func1.visible = false;
        ...
        vertices.push(new THREE.Vector3(-500,-500,0));
        funcyx = createLineMesh(vertices,'#666',2);
        thiz.scene.add(funcyx);
        funcyx.visible =false;


        array=[];
        func4= new THREE.Group();
        for(i=-4;i<=10;){
            y=Math.sqrt(i+4)+1;
            if(y<=10&&y>=-10){
                array.push(new THREE.Vector3(i*50, y*50, 0));
...
function radioChoose(){
    ...
    if(radioSelect == value){
        ...
        $('.turnShade ').html(shadeText[radioSelect-1]);
        threeDimensional.funcMH();
