...
function ThreeDimensional() {
        ...
        a1=setInterval(function(){
            ...
            if(num1>=400){
                ...
                a2=setInterval(function(){
                    num2r+=Math.PI/180*cc/10;
                    if(num2r>=Math.PI/180*cc){
                        clearInterval(a2);
                        line2.rotation.z=cc*Math.PI/180;
                        changeline2();
                        return;
                    }
                    line2.rotation.z=num2r;
                },50)
            }
            group1.position.x=0;
    ...
    function changeline2(){
        var result=bb*Math.sin(Math.PI/180*cc)/aa;
        var B=Math.asin(result)*180/Math.PI;
        var x1=bb*25-bb*25*Math.cos(Math.PI/180*cc);
        var y1=150-bb*25*Math.sin(Math.PI/180*cc);
        var changex=x1;
        var changey=y1-(-400);
        var num1=0;
        var num2=0;
        ...
        a3=setInterval(function(){
            ...
            if(num2>changey){
                ...
                a4=setInterval(function(){
                    num3+=Math.PI/180*B/10;
                    if(num3>=Math.PI/180*B){
                        clearInterval(a4);
    ...
    function changeline1(){
        ...
        var B=Math.asin(result)*180/Math.PI;
        var C=180-B-cc;
        var result1=Math.pow(aa,2)+Math.pow(bb,2)-2*aa*bb*Math.cos(Math.PI/180*C);
        var resultc=Math.pow((result1),1/2)*50;
        ...
        a5=setInterval(function(){
            ...
            if(num2>=changeyy){
                clearInterval(a5);
                line1.position.x=aa*25+changexx;
                line1.position.y=300-changeyy;
                createLineC();
                createLastText();
                return;
            }
    ...
    function createLastText(){
        ...
        var resultc=Math.pow((result1),1/2)*50;
        var x2=resultc;
        var x1=(x2+10+(bb*50*Math.cos(Math.PI/180*cc)-20))/2;
        var y1=(-400+(-400+bb*50*Math.sin(Math.PI/180*cc)))/2;
        lastTexta=createText("a",x1,y1,0,"#000000");
        lastTextb=createText("b",bb*25*Math.cos(Math.PI/180*cc)-20,-400+bb*25*Math.sin(Math.PI/180*cc),0,"#000000");
        lastTextc=createText("c",resultc/2,-400,0,"#000000");
        lastTextA=createText("A",0,-400,0,"#000000");
        lastTextB=createText("B",x2+10,-400,0,"#000000");
        lastTextC=createText("C",bb*50*Math.cos(Math.PI/180*cc)-10,-400+bb*50*Math.sin(Math.PI/180*cc)+20,0,"#000000");
...
function reset(){
    ...
    $('.slider1 .sliderLeft').css('width','80px');
    $('.slider2 .sliderLeft').css('width','40px');
...
function dynamic(){
    ...
    var B=Math.asin(result)*180/Math.PI;
    if(cc<90){
        if(aa<bb*Math.sin(Math.PI/180*cc)){
            $('.showtruth').css('display','block');
            $('.showtruth').html("当a< bsinA，无解，不构成三角形");
        }
        else if(bb>aa&&aa>(bb*Math.sin(Math.PI/180*cc))){
            $('.showtruth').css('display','block');
            $('.showtruth').html("当b>a，且b>a> bsinA时，有两解，可构成两个三角形");
        }
        else if(aa>=bb&&cc>=B){
            $('.showtruth').css('display','none');
