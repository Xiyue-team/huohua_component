...
function ThreeDimensional() {
    ...
    this.createCir = function(){
        ...
        var vertices2 = [];
        vertices2.push(vec3(-(2*radius+100),radius,0),vec3(2*radius+100,radius,0));
        this.line2 = createLineMesh(vertices2,0x000000,2);

        var vertices3 = [];
        vertices3.push(vec3(-(2*radius+100),-radius,0),vec3(2*radius+100,-radius,0));
        this.line3 = createLineMesh(vertices3,0x000000,2);

        this.scene.add(this.cir,this.line1,this.line2,this.line3);
    };
    this.formula = function(){
        var a = text("sinα",44,"#000000");
        var b = text("=",44,"#000000");
        var c = text("y",44,"#000000");
        var d = text("—",44,"#000000");
        var e = text("r",44,"#000000");
    ...
    this.dynamicalLine = function(value){
        ...
        // |
        vertices2.push(vec3(linex,liney,0),vec3(linex,0,0));
        var line2 = createLineMesh(vertices2,0xcc0000,3);
        var yt = text("y",33,"#000000");
        yt.position.set(linex+20,liney/2+22,0);

        // 正弦图
        vertices3.push(vec3(0,0,0));
        vertices6.push(vec3(20,0,0));
        for(var i=1;i<angle/9+1;i++){
            x = 10*i;
            y = Math.sin(Math.PI/180*9*i)*radius;
        ...
        // :|
        var linex1 = vertices3[vertices3.length-1].x;
        vertices4.push(vec3(linex1,liney,0),vec3(linex1,0,0));
        var line4 = createLineMesh(vertices4,0xd43f3f,3);

        // 虚线
        vertices5.push(vec3(linex,liney,0),vec3(linex1,liney,0));
        var line5 = createLineMesh(vertices5,0x000000,2);
        ...
        this.lineGroup.add(line1,line2,line3,line4,line5,line6,r,yt,af);
