...
(function(){
    ...
    var text={
        t1:{
            1:'间期',
            2:'卵原细胞的体积增大，染色体复制，成为初级卵母细胞。复制后的每条染色体都由两条姐妹染色单体构成。这两条姐妹染色单体由同一个着丝点连接。'
        },
        t2:{
            1:'前期',
            2:'同源染色体两两配对，四分体中的非姐妹染色单体之间经常发生缠绕，并交换一部分片段。',
            3:'<strong>同源染色体：</strong>配对的两条染色体，形状和大小一般都相同，一条来自父方，一条来自母方。<strong>联会：</strong>同源染色体两两配对的现象。<strong>四分体：</strong>联会后的每对同源染色体含有四条染色单体。'
        },
        t3:{
            1:'中期',
        ...
        t5:{
            1:'末期',
            2:'一个初级卵母细胞分裂成了两个大小不同的细胞，大的叫次级卵母细胞，小的叫极体。染色体数目减少一半。'
        },
        t6:{
            1:'前期',
            2:'核膜核仁消失，染色体不复制。'
        ...
        t9:{
            1:'末期',
            2:'次级卵母细胞分裂为一个大的卵细胞和一个小的极体；在减数第一次分裂过程中形成的极体也分裂为两个极体。'
        }
    }
   function choose1(){
