...
var marginTop = (controlHeight - h2Height - h2MarginTop - conHeight - 100)/2+150;
...
var r1=1,x1=0,y1=0,r2=1,x2=2,y2=2;
...
function ThreeDimensional() {
    ...
    this.createCircle=function(){
        ...
        circle2=new THREE.Group();

        var circle11 = createMesh(new THREE.TorusGeometry(r1*50,0.1,2,200),"#F39800");
        var circle111 = createMesh(new THREE.TorusGeometry(5,5,20,20),"#60B6F1");
        text1=createText("A",x1*50-20,y1*50+20,0,"#000000");
        circle1.add(circle11,circle111);

        var circle22 = createMesh(new THREE.TorusGeometry(r2*50,0.1,2,200),"#F55B23");
        var circle222 = createMesh(new THREE.TorusGeometry(5,5,20,20),"#7ED321");
        text2=createText("B",x2*50-20,y2*50+20,0,"#000000");
        circle2.add(circle22,circle222);


        this.scene.add(circle1,circle2,text1,text2);
        circle1.position.x=x1*50;
        circle1.position.y=y1*50;
        circle2.position.x=x2*50;
        circle2.position.y=y2*50;
    ...
    this.createLine=function(){
        ...
        vertices1.push(vec3(x2*50,y2*50,0));
        ...
        text3=createText("d",(x1+x2)*25,(y1+y2)*25,0,"#ff0000");
    ...
    this.showresult=function(){
        $('#result2').html(r1);
        $('#result3').html(r2);
        var d=Math.pow((Math.pow((x1-x2),2)+Math.pow((y1-y2),2)),1/2);
        $('#result1').html(parseFloat(d).toFixed(2));
        if(d>(r1+r2)){
            $('#result4').html("相离");
        }else if(d==(r1+r2)){
            $('#result4').html("外切");
...
function renew(){
    ...
    $('.slider4').find('.sliderLeft').css({'width':'0px'});
    $('.slider4').find('.xdsoft_range2dslider_runner').css({'left':'0px'});
    $('.slider4').find('.xdsoft_slider_label').text('1');
    $('.slider4').attr('value',''+1+'|0');
    $('.slider5').find('.sliderLeft').css({'width':'286px'});
    $('.slider5').find('.xdsoft_range2dslider_runner').css({'left':'286px'});
    $('.slider5').find('.xdsoft_slider_label').text('2');
    $('.slider5').attr('value',''+2+'|0');
    $('.slider6').find('.sliderLeft').css({'width':'286px'});
    $('.slider6').find('.xdsoft_range2dslider_runner').css({'left':'286px'});
    $('.slider6').find('.xdsoft_slider_label').text('2');
    $('.slider6').attr('value',''+2+'|0');
