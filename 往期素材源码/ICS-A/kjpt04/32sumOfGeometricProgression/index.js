...
var value1=0.1,value2=0.5,value3=1;
...
function ThreeDimensional() {
    ...
    function createFunction(){
        ...
        for(i=1;i<=value3;i++){
            y = value1*(1-Math.pow(value2,i))/(1-value2);
    ...
    function createCircle(position){
        ...
        var materia = new THREE.MeshBasicMaterial({'color':'#60b6f1'});
    ...
    function createGrid(){
        ...
        for(i=-64;i<65;i++){
            ...
            vertices=[];
            vertices.push(new THREE.Vector3(-100, i*50,0));
            vertices.push(new THREE.Vector3(150,i*50,0));
            line = createLineMesh(vertices,'#afb0ae',3);
            group.add(line);
        }
...
function renew(){
    ...
    $('.slider2').find('.sliderLeft').css({'width':'256px'});
    $('.slider2').find('.xdsoft_range2dslider_runner').css({'left':'256px'});
    $('.slider2').find('.xdsoft_slider_label').text('0.5');
    $('#slider2').attr('value',''+0.5+'|0');
    $('.slider1').find('.sliderLeft').css({'width':'215px'});
    $('.slider1').find('.xdsoft_range2dslider_runner').css({'left':'215px'});
    $('.slider1').find('.xdsoft_slider_label').text('0.1');
    $('#slider1').attr('value',''+0.1+'|0');
    three.reback();
}
var fullScreen=0;
function scalef(){
