...
function ThreeDimensional() {
    ...
    this.createLine=function(){
        ...
        var vertices1=[];
        vertices1.push(vec3(-500,(k*(-10-x)+y)*50,0));
        vertices1.push(vec3(500,(k*(10-x)+y)*50,0));
    ...
    this.createsphere=function(){
        ...
        text1=createText("P("+x+","+y+")",x*50-80,y*50+30,0,"#000000");
...
function renew(){
    ...
    $('.slider1').find('.sliderLeft').css({'width':'225px'});
    $('.slider1').find('.xdsoft_range2dslider_runner').css({'left':'225px'});
    ...
    $('.slider3').find('.sliderLeft').css({'width':'225px'});
    $('.slider3').find('.xdsoft_range2dslider_runner').css({'left':'225px'});
