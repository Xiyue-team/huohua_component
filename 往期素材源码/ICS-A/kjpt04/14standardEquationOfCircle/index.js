...
var threeDimension = {
    ...
    createObj:function(){
        ...
        var R=Math.pow(getParameter.r,2);
        var absA=Math.abs(getParameter.a);
        var absB=Math.abs(getParameter.b);
        if(getParameter.a==0&&getParameter.b!=0){
            if(getParameter.b>0){
                $('.result').html('x<sup>2</sup>&nbsp;&nbsp;+&nbsp;(y&nbsp;-&nbsp;'+absB+')<sup>2</sup>&nbsp;&nbsp;=&nbsp;'+R) 
            }else{
                $('.result').html('x<sup>2</sup>&nbsp;&nbsp;+&nbsp;(y&nbsp;+&nbsp;'+absB+')<sup>2</sup>&nbsp;&nbsp;=&nbsp;'+R) 
            }
        }else if(getParameter.b==0&&getParameter.a!=0){
            if(getParameter.a>0){
                $('.result').html('(x&nbsp;-&nbsp;'+absA+')<sup>2</sup>&nbsp;&nbsp;+&nbsp;y<sup>2</sup>&nbsp;&nbsp;=&nbsp;'+R) 
            }else{
                $('.result').html('(x&nbsp;+&nbsp;'+absA+')<sup>2</sup>&nbsp;&nbsp;+&nbsp;y<sup>2</sup>&nbsp;&nbsp;=&nbsp;'+R) 
            }
        }else if(getParameter.b==0&&getParameter.a==0){
            $('.result').html('x<sup>2</sup>&nbsp;&nbsp;+&nbsp;y<sup>2</sup>&nbsp;&nbsp;=&nbsp;'+R) 
        }else{
            if(getParameter.a>0&&getParameter.b>0){
                $('.result').html('(x&nbsp;-&nbsp;'+absA+')<sup>2</sup>&nbsp;&nbsp;+&nbsp;(y&nbsp;-&nbsp;'+absB+')<sup>2</sup>&nbsp;&nbsp;=&nbsp;'+R) 
            }else if(getParameter.a<0&&getParameter.b<0){
                $('.result').html('(x&nbsp;+&nbsp;'+absA+')<sup>2</sup>&nbsp;&nbsp;+&nbsp;(y&nbsp;+&nbsp;'+absB+')<sup>2</sup>&nbsp;&nbsp;=&nbsp;'+R) 
            }else if(getParameter.a>0&&getParameter.b<0){
                $('.result').html('(x&nbsp;-&nbsp;'+absA+')<sup>2</sup>&nbsp;&nbsp;+&nbsp;(y&nbsp;+&nbsp;'+absB+')<sup>2</sup>&nbsp;&nbsp;=&nbsp;'+R)
            }else{
        ...
        //圆环
        vertices=[]
        vertices.push(getParameter.a*40,getParameter.b*40,0)
        var line=threeDimension.createCircle(vertices,getParameter.r*40,'#000',false);

        //圆心
        vertices=[]
        vertices.push(getParameter.a*40,getParameter.b*40,0)
        var O=threeDimension.createCircle(vertices,7,'#F35A27',true);
        var textO=threeDimension.createText('A('+getParameter.a+','+getParameter.b+')',getParameter.a*40+50,getParameter.b*40+30,0,'#000',24);

        threeDimension.Obj.add(line,O,textO);
...
$("#slider1").change(function(){
    ...
    if(val == 0){
        ...
        getParameter.a=(val/10).toFixed(1);
    } 
    threeDimension.createObj();
});
$("#slider2").change(function(){
    ...
    if(val == 0){
        ...
        getParameter.b=(val/10).toFixed(1);
    } 
    threeDimension.createObj();
});
...
function renew(){
	$('.slider1,.slider2').find('.sliderLeft').css({'width':'205px'});
    $('.slider1,.slider2').find('.xdsoft_range2dslider_runner').css({'left':'205px'});
    $('.slider1,.slider2').find('.xdsoft_slider_label').text('0');
    $('.slider1,.slider2').attr('value',''+0+'|0');
