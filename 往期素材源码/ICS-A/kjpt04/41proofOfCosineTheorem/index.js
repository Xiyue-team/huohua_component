...
function ThreeDimensional() {
    ...
    var axis={},mousedownflag = false,triangleObj=null,changeSphere=null,changeSphere1=null,startObj=null;
    ...
    var arrO5 =[[-4,-2],[4,-2],[2,2]], arr5 = [[-4,-2],[4,-2],[2,2]];
    ...
    this.int = function () {
        ...
        changeSphere = this.createSphere([0,0,0],'#60b6f1',15);
        changeSphere1 = this.createSphere([0,0,0],'#60b6f1',40);
        changeSphere1.material.transparent = true;
        changeSphere1.material.opacity = 0;
        thiz.scene.add(changeSphere,changeSphere1);
        selectobjs.push(changeSphere1);
        ...
        if(mousedownflag){
            if ( raycaster.ray.intersectPlane( plane, intersection ) ) {
                ...
                if(selectFun == 1){
                    ...
                    changeSphere1.position.x = x*50;
                    changeSphere1.position.y = 2*50;
    ...
    this.onDocumentMouseUp = function(event){
        ...
        if(selectobj!=undefined){
            mousedownflag = false;
            changeSphere.material.opacity = 0.8;
        }
        selectobj = null;
    ...
    this.createSphere = function (coordinate,color,r) {
        var sphereG = new THREE.CircleBufferGeometry(r,32);
    ...
    function createObj1(){
        ...
        changeSphere1.position.x = arr3[2][0]*50;
        changeSphere1.position.y = arr3[2][1]*50;
    ...
    function createMoveObj1(){
        ...
        if(arr3[2][0] > arr3[1][0]){
            ...
            line = createText("bcosC-a",24,'#000');
            line.position.x =50*((arr3[2][0]-arr3[1][0])/2+arr3[1][0]);
            line.position.y = -100;
            moveObj1.add(line);
            ...
            line = createText("ccosB-a",24,'#000');
            line.position.x =50*((arr3[2][0]-arr3[0][0])/2+arr3[0][0]);
            line.position.y = -100;
            moveObj1.add(line);

        }else{

            line = createText("a-bcosC",24,'#000');
            line.position.x =50*((arr3[2][0]-arr3[1][0])/2+arr3[1][0]);
            line.position.y = -100;
            moveObj1.add(line);

            line = createText("bcosC",24,'#000');
            line.position.x =50*((arr3[2][0]-arr3[0][0])/2+arr3[0][0]);
            line.position.y = -100;
            moveObj1.add(line);
        ...
        if(arr3[2][0] != arr3[1][0] && arr3[2][0] != arr3[0][0]){
        ...
        if(arr3[2][0] > arr3[0][0]){
            line = createText("bsinC",24,'#000');
            line.position.x = arr3[2][0]*50;
            line.position.y = 0;
            moveObj1.add(line);
        }else{
            line = createText("csinB",24,'#000');
            line.position.x = arr3[2][0]*50;
            line.position.y = 0;
            moveObj1.add(line);
        }
    ...
    function createObj2(){
        ...
        line = createLineMesh(vertices1,'#000',2);
        obj2.add(line);
        changeSphere.position.x = arr5[2][0]*50;
        changeSphere.position.y = arr5[2][1]*50;
        changeSphere1.position.x = arr5[2][0]*50;
        changeSphere1.position.y = arr5[2][1]*50;
        line = createText("C",30,'#000');
        line.position.x = arr5[0][0]*50-10;
        line.position.y = arr5[0][1]*50;
        obj2.add(line);

        line = createText("B",30,'#000');
        line.position.x = arr5[1][0]*50+10;
        line.position.y = arr5[1][1]*50;
        obj2.add(line);

        line = createText("a",30,'#000');
        line.position.x = (arr5[1][0]*50 +arr5[0][0]*50)/2;
        line.position.y = arr5[1][1]*50 - 10;
        obj2.add(line);

        line = createText("(a,0)",25,'#000');
        line.position.x = arr5[1][0]*50+50;
        line.position.y = arr5[1][1]*50 -5;
        obj2.add(line);

        vertices1=[];
        vertices1.push(new THREE.Vector3(arr5[1][0]*50, arr5[1][1]*50, 0));
        vertices1.push(new THREE.Vector3(arr5[0][0]*50, arr5[0][1]*50, 0));
        line = createLineMesh(vertices1,'#000',3);
        obj2.add(line);


        vertices1=[];
        vertices1.push(new THREE.Vector3(6*50, -2*50, 0));
        vertices1.push(new THREE.Vector3(-6*50, -2*50, 0));
        line = createLineMesh(vertices1,'#000',3);
        obj2.add(line);

        vertices1=[];
        vertices1.push(new THREE.Vector3(arr5[0][0]*50, -6*50, 0));
        vertices1.push(new THREE.Vector3(arr5[0][0]*50, 6*50, 0));
        line = createLineMesh(vertices1,'#000',3);
        obj2.add(line);

        line = createArrow('#000');
        line.rotation.z = 0;

        line.position.x = 6*50;
        line.position.y = -2*50;
        obj2.add(line);

        line = createArrow('#000');
        line.rotation.z = Math.PI/2;

        line.position.x = arr5[0][0]*50;
        line.position.y = 6*50;
        obj2.add(line);
    ...
    function createMoveObj2(){
        ...
        vertices1=[];
        vertices1.push(new THREE.Vector3(arr5[1][0]*50, arr5[1][1]*50, 0));
        vertices1.push(new THREE.Vector3(arr5[2][0]*50, arr5[2][1]*50, 0));
        line = createLineMesh(vertices1,'#000',3);
        moveObj2.add(line);
        ...
        line = createText("c",25,'#000');
        line.position.x = (arr5[2][0] + arr5[1][0])*25+20;
        line.position.y = (arr5[2][1] + arr5[1][1])*25;
        moveObj2.add(line);

        line = createText("b",25,'#000');
        line.position.x = (arr5[2][0] + arr5[0][0])*25+20;
        line.position.y = (arr5[2][1] + arr5[0][1])*25;
        moveObj2.add(line);

        line = createText("A",30,'#000');
        line.position.x = arr5[2][0]*50;
        line.position.y = arr5[2][1]*50+40;
        moveObj2.add(line);



        if(arr5[2][0] == arr5[1][0]){
            vertices1=[];
            vertices1.push(new THREE.Vector3(arr5[1][0]*50, -90, 0));
            vertices1.push(new THREE.Vector3(arr5[1][0]*50-10, -90, 0));
            line = createLineMesh(vertices1,'#000',3);
            moveObj2.add(line);

            vertices1=[];
            vertices1.push(new THREE.Vector3(arr5[1][0]*50-10, -90, 0));
            vertices1.push(new THREE.Vector3(arr5[1][0]*50-10, -100, 0));
            line = createLineMesh(vertices1,'#000',3);
            moveObj2.add(line);

            line = createText("(a,y)",25,'#000');
            line.position.x = arr5[2][0]*50+40;
            line.position.y = arr5[2][1]*50+40;
            moveObj2.add(line);
        }else{
            line = createText("(x,y)",25,'#000');
            line.position.x = arr5[2][0]*50+40;
            line.position.y = arr5[2][1]*50+40;
            moveObj2.add(line);
            ...
            vertices1=[];
            vertices1.push(new THREE.Vector3(arr5[2][0]*50, arr5[2][1]*50, 0));
            vertices1.push(new THREE.Vector3(arr5[2][0]*50, -100, 0));
            line = createLineMesh(vertices1,'#000',2);
            moveObj2.add(line);
        }
    ...
    function createObj3(){
        ...
        changeSphere1.position.x = arr4[2][0]*50;
        changeSphere1.position.y = arr4[2][1]*50;
    ...
    function createMoveObj3(){
        ...
        if(arr4[2][0] == arr4[0][0]){
            ...
            vertices1=[];
            vertices1.push(new THREE.Vector3(arr4[0][0]*50, -90, 0));
            vertices1.push(new THREE.Vector3(arr4[0][0]*50+10, -90, 0));
            line = createLineMesh(vertices1,'#000',3);
            moveObj3.add(line);

            vertices1=[];
            vertices1.push(new THREE.Vector3(arr4[0][0]*50+10, -90, 0));
            vertices1.push(new THREE.Vector3(arr4[0][0]*50+10, -100, 0));
            line = createLineMesh(vertices1,'#000',3);
            moveObj3.add(line);

        }else if(arr4[2][0] == arr4[1][0]){

            vertices1=[];
            vertices1.push(new THREE.Vector3(arr4[1][0]*50, -90, 0));
            vertices1.push(new THREE.Vector3(arr4[1][0]*50-10, -90, 0));
            line = createLineMesh(vertices1,'#000',3);
            moveObj3.add(line);

            vertices1=[];
            vertices1.push(new THREE.Vector3(arr4[1][0]*50-10, -90, 0));
            vertices1.push(new THREE.Vector3(arr4[1][0]*50-10, -100, 0));
            line = createLineMesh(vertices1,'#000',3);
            moveObj3.add(line);
        }
