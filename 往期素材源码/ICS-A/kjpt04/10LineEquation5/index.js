...
function ThreeDimensional() {
    ...
    this.createLine=function(){
        ...
        if(x1==x2){
            ...
            vertices1.push(vec3(x1*50,-500,0));
            vertices1.push(vec3(x1*50,500,0));
        }
        else{
            vertices1.push(vec3(-500,((y2-y1)*(-10-x1)/(x2-x1)+y1)*50,0));
            vertices1.push(vec3(500,((y2-y1)*(10-x1)/(x2-x1)+y1)*50,0));
        }
    ...
    this.createsphere=function(){
        ...
        var sphereM = new THREE.MeshBasicMaterial({color: '#F39800'});
        sphere1= new THREE.Mesh(sphereG, sphereM);
        sphere1.position.x = x1*50;
        sphere1.position.y = y1*50;
        this.scene.add(sphere1);

        text1=createText("P1("+x1+","+y1+")",x1*50+50,y1*50,0,"#000000");
        this.scene.add(text1);

        sphereM = new THREE.MeshBasicMaterial({color: '#60B6F1'});
        sphere2= new THREE.Mesh(sphereG, sphereM);
        sphere2.position.x = x2*50;
        sphere2.position.y = y2*50;
        this.scene.add(sphere2);

        text2=createText("P2("+x2+","+y2+")",x2*50-50,y2*50-20,0,"#000000");
...
function renew(){
    ...
    $('.slider2').find('.sliderLeft').css({'width':'225px'});
    $('.slider2').find('.xdsoft_range2dslider_runner').css({'left':'225px'});
    $('.slider2').find('.xdsoft_slider_label').text('1');
    $('.slider2').attr('value',''+1+'|0');
    $('.slider3').find('.sliderLeft').css({'width':'184px'});
    $('.slider3').find('.xdsoft_range2dslider_runner').css({'left':'184px'});
