...
function ThreeDimensional() {
    ...
    this.createLine=function(){
        ...
        if(B==0){
            ...
            vertices1.push(vec3(-500,((-A*(-10)/B)-C/B)*50,0));
            vertices1.push(vec3(500,((-A*(10)/B)-C/B)*50,0));
        }
...
$("#slider1").change(function(){
    ...
    if(A==0&&B==0){
        C=0;
        three.showfangchen();
        $('.slider3 .xdsoft_range2dslider_runner').css('left','200px');
        $('.slider3 .sliderLeft').css('width','200px');
...
function renew(){
    ...
    three.createLine();
    three.showfangchen();
    $('.slider1 .sliderLeft').css('width','245px');
    $('.slider2 .sliderLeft').css('width','164px');
    $('.slider3 .sliderLeft').css('width','245px');
