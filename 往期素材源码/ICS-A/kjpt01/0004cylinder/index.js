...
var twoDimension={
    ...
    getJson:function(){
        ...
        arrayAll[2] = [polygon.radius,0,-polygon.height];
    ...
    getArcJson:function(){
        ...
        arcJson[2] = [Math.round(radius*Math.cos(angle)),polygon.height,Math.round(radius*Math.sin(angle))];
...
var threeDimensional ={
    ...
    createCylinder:function(){
        ...
        var meshG = new THREE.CylinderGeometry(polygon.radius,polygon.radius,polygon.height,20,20);
    ...
    createClyinderLine:function(){
        ...
        var radius = polygon.radius;
        for(i=0;i<37;i++){
            vertices1.push(new THREE.Vector3(radius*Math.cos(i*10*Math.PI/180),0,radius*Math.sin(i*10*Math.PI/180)));
            vertices2.push(new THREE.Vector3(radius*Math.cos(i*10*Math.PI/180),polygon.height,radius*Math.sin(i*10*Math.PI/180)));
        }
    ...
    drawRectangle:function(){
        ...
        shape.lineTo(polygon.radius,polygon.height,0);
    ...
    createShape:function(angle){
        ...
        var m = new THREE.MeshBasicMaterial({color:'#F39800',side:THREE.DoubleSide,transparent:false,wireframe:false});
        ...
        m = new THREE.MeshBasicMaterial({color:'#F39800',side:THREE.DoubleSide,transparent:false,wireframe:false});
...
$('#slider1').change(function(){
    ...
    polygon.radius = getParameter.radius= polygon.angleJson[2][0]=polygon.angleJson[3][0]=parseInt(getParameter.radius);
    threeDimensional.repaintMesh();
