...
function drawRectangle(h,r1,r2,ang){
    var shape = new THREE.Shape();
    shape.moveTo(0,-h/2,0);
    shape.lineTo(0,h/2,0);
    shape.lineTo(r1,h/2,0);
    shape.lineTo(r2,-h/2,0);
...
var h=150,r=100,a=0,r1=50,r2=100;
//中轴线
function create1() {
    var vertices=[];
...
function draw(){
    ...
    var meshPlan=drawRectangle(h,r1,r2,ang);
    model.add(meshPlan);

    if(a!=0){
        var vertices1=[],vertices2=[];
        for(i=0;i<=a;i++){
            vertices1.push(new THREE.Vector3(r1*Math.cos(i*P),h/2,-r1*Math.sin(i*P)));
            vertices2.push(new THREE.Vector3(r2*Math.cos(i*P),-h/2,-r2*Math.sin(i*P)));
        }
        var line1=createLineMesh(vertices1, '#4990E2', 3);
        var line2=createLineMesh(vertices2, '#4990E2', 3);
        model.add(line1,line2);

        var geometry = new THREE.CylinderBufferGeometry( r1, r2, h, 36,1,false,0,ang );
...
$('#slider1').change(function(){
    ...
    var value1 = parseInt(split[0].split('|')[0]);
    ...
    r1 = parseInt(value1)*10;
    r2 = parseInt(value2)*10;
    draw();
