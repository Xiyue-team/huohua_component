...
function ThreeDimensional() {
    ...
    this.createObj=function(){
        ...
        for(var i=20;i>=0;i-=0.01){
            vertices.push(vec3(i*50,Math.pow(4*i,1/2)*50,1))
        }
        for(var m=0;m<=20;m+=0.01){
            vertices.push(vec3(m*50,-Math.pow(4*m,1/2)*50,1))
        }
        ...
        vertices.push(vec3(20*50,k*(20+1)*50,1));
        ...
        if(k<-1||k>1){
            ...
            $('#result3').text('相交');
            var x1=(-2*k*k+4+Math.sqrt(Math.pow((2*k*k-4),2)-Math.pow(k,4)*4))/(2*k*k);
            var y1=k*(x1+1);
            var x2=(-2*k*k+4-Math.sqrt(Math.pow((2*k*k-4),2)-Math.pow(k,4)*4))/(2*k*k);
            var y2=k*(x2+1);
            ...
            $('#result3').text('相切');
            var x=(-2*k*k+4-Math.sqrt(Math.pow((2*k*k-4),2)-Math.pow(k,4)*4))/(2*k*k);
            var y=k*(x+1);
...
$('#slider1').change(function(){
    ...
    if(k>=-1.03&&k<=-0.97){
        k=-1;
        $('.slider1').find('.sliderLeft').css({'width':'102px'});
        $('.slider1').find('.xdsoft_range2dslider_runner').css({'left':'102px'});
        $('.slider1').find('.xdsoft_slider_label .xdsoft_slider_label_top').text('-1')
        $('.slider1').attr('value',''+-100+'|0');
    }else if(k>=0.97&&k<=1.03){
        k=1;
