...
var a=3,b=4,radioSelect=1;
var demo=0;
var line1=null,line2=null,dashline1=null,dashline2=null,dashline3=null,dashline4=null;
var sphere1=null,sphere2=null,sphereP1=null,sphereP2=null;
var text1=null,text2=null,texta1=null,texta2=null,textb1=null,textb2=null;
var show=false;
...
//        this.createsphereP();
    ...
    this.createLine=function(){
        if(line1!=null){
            this.scene.remove(line1,line2,dashline1,dashline2,dashline3,dashline4);
        }
        if(texta1!=null){
            this.scene.remove(texta1,texta2,textb1,textb2);
        }
        var point1=[],vertices1=[],vertices2=[],vertices3=[],vertices4=[];
        var resulty= 0,resulty1=0;
        var c=Math.pow((Math.pow(a,2)+Math.pow(b,2)),1/2);
        ...
        if(b<=2){
            for(var i=-c-4;i<=-a;i+=0.01){
                resulty=((Math.pow(i,2)/Math.pow(a,2))-1)*(Math.pow(b,2));
                resulty1=Math.pow(resulty,1/2);
                point1.push(new THREE.Vector3(i*50,resulty1*50,0));
            }
            for(var k=-a;k>=-c-4;k-=0.01){
                resulty=((Math.pow(k,2)/Math.pow(a,2))-1)*(Math.pow(b,2));
                resulty1=Math.pow(resulty,1/2);
                point1.push(new THREE.Vector3(k*50,-resulty1*50,0));
            }
            ...
            for(var i=-c-2;i<=-a;i+=0.01){
                resulty=((Math.pow(i,2)/Math.pow(a,2))-1)*(Math.pow(b,2));
                resulty1=Math.pow(resulty,1/2);
                point1.push(new THREE.Vector3(i*50,resulty1*50,0));
            }
            for(var k=-a;k>=-c-2;k-=0.01){
                resulty=((Math.pow(k,2)/Math.pow(a,2))-1)*(Math.pow(b,2));
                resulty1=Math.pow(resulty,1/2);
                point1.push(new THREE.Vector3(k*50,-resulty1*50,0));
            }
        ...
        if(radioSelect==1){
            ...
            vertices1.push(vec3((-a)*50,b*50,0));
            vertices1.push(vec3(a*50,b*50,0));
            vertices2.push(vec3(a*50,b*50,0));
            vertices2.push(vec3(a*50,(-b)*50,0));
            vertices3.push(vec3(a*50,(-b)*50,0));
            vertices3.push(vec3((-a)*50,(-b)*50,0));
            vertices4.push(vec3((-a)*50,(-b)*50,0));
            vertices4.push(vec3((-a)*50,b*50,0));

            texta1=createText("A1",-a*50,30,0,"#000000");
            texta2=createText("A2",a*50,30,0,"#000000");

            textb1=createText("B1",30,-b*50,0,"#000000");
            textb2=createText("B2",30,b*50,0,"#000000");

        }else{
            line2.rotation.z=Math.PI/2;
            line1.rotation.z=-Math.PI/2;

            vertices1.push(vec3((-b)*50,a*50,0));
            vertices1.push(vec3(b*50,a*50,0));
            vertices2.push(vec3(b*50,a*50,0));
            vertices2.push(vec3(b*50,(-a)*50,0));
            vertices3.push(vec3(b*50,(-a)*50,0));
            vertices3.push(vec3((-b)*50,(-a)*50,0));
            vertices4.push(vec3((-b)*50,(-a)*50,0));
            vertices4.push(vec3((-b)*50,a*50,0));

            texta1=createText("A1",30,-a*50,0,"#000000");
            texta2=createText("A2",30,a*50,0,"#000000");

            textb1=createText("B1",-b*50,30,0,"#000000");
            textb2=createText("B2",b*50,30,0,"#000000");
        }
    ...
    this.createsphereF=function(){
        ...
        if(radioSelect==1){
            ...
            vertices1.push(0,-c*50,1);
            vertices2.push(0,c*50,1);
            text1=createText("F1",30,-c*50,0,"#000000");
            text2=createText("F2",30,c*50,0,"#000000");
        }
        sphere1=createCircle(vertices1,10,'#65B2EE');
        sphere2=createCircle(vertices2,10,'#65B2EE');
...
function reset(){
    ...
    $('.slider2').find('.sliderLeft').css({'width':'307px'});
    $('.slider2').find('.xdsoft_range2dslider_runner').css({'left':'307px'});
    $('.slider2').find('.xdsoft_slider_label').text('4');
    $('.slider2').attr('value',''+40+'|0');
}
