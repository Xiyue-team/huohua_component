...
function ThreeDimensional() {
    ...
    this.createLine=function(){
        if(line1!=null){
            this.scene.remove(line1,line2,textl);
        }
        var point1=[];
        var num=((p/2)+1)/100;
        var resultx=0;
        ...
        if(radioSelect==1){
            vertices1.push(vec3((-p/2)*50,400,0));
            vertices1.push(vec3((-p/2)*50,-400,0));
            textl=createText("l",-p*25+20,350,0,"#000000");
            ...
            vertices1.push(vec3(-400,(-p/2)*50,0));
            vertices1.push(vec3(400,(-p/2)*50,0));
            textl=createText("l",-350,-p*25+20,0,"#000000");
        ...
        line2 = new THREE.LineSegments(geometryLine2, new THREE.LineBasicMaterial({color: 0x1161c8}));
        this.scene.add(line2,textl);
    };
    this.createsphereF=function(){
        ...
        if(radioSelect==1){
            ...
            vertices1.push(0,p*25,1);
            text1=createText("F",30,p*25,0,"#000000");
        }else if(radioSelect==4){
            vertices1.push(0,-p*25,1);
            text1=createText("F",30,-p*25,0,"#000000");
        }
