...
(function () {
    ...
    if(tyW/tyH>18/9.1){
        $('#tableM').height(tyH).width(tyH/9.1*18);
    }else{
        $('#tableM').height(tyW/18*9.1).width(tyW);
    }
    var w=$('#tableM').width()/18.2;
    $('#tableM>div').width(w).height(w-2).css({'top':w+'px','right':3*w+1+'px'});
