  ...
  <div id="app" class="noselect">
    <div class="container">
      ...
      <div class="prove-wrap" v-if="checked1">
        <p class="prove">sin(-α)=-sinα</p>
        <p class="prove">cos(-α)=cosα</p>
        <p class="prove">tan(-α)=-tanα</p>
      </div>
      <!--视图区-->
    ...
    <div class="ctrl">
      <ui-btn type="switch" v-model="checked">-α</ui-btn>
  ...
  methods: {
    ...
    init() {
      ...
      var initLine = () => {
        ...
        lineObj.pp1 = common.unitLine({ color: "#F89A00" });
      ...
      var secLine = (startangle, endangle) => {
        let copyP = common.countPos(TOUCH_RADIUS, startangle);
        ...
        //弧度
        let angle = drawAngle(startangle, endangle, ANGLE_SIZE, '#F5A623', '#F8E71C', -1, lineObj.texta1);
      ...
      var lineAnimate = (v) => {
        ...
        function rotateLine() {
          ...
          that.beta -= 4;
          if (that.beta <= min_limit_radius) {
            that.point_event['pointer-events'] = 'auto';
            that.isClick = true;
            that.isShow = true;
            cancelAnimationFrame(timer);
            that.beta = min_limit_radius;
      ...
      var drawSubline = (P) => {
        ...
        lineObj.pp1 = common.scaleLine([P.x, P.y, 0], [P.x, -P.y, 0], lineObj.pp1);
        group.add(lineObj.pp1);
