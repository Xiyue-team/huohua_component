<template>
    <div ref="wrap"
      ...
      <ul v-if="!timeLine && label"
          ...
          class="ui-label">
        <li v-for="(la,index) in label" v-text="la" :style="{width:100+'%'}"></li>
      </ul>
        <!--滑块-->
        ...
        computed: {
            ...
            wrapStyles () {
                return {
                    ...
                    padding: this.direction === 'vertical'?`5px ${this.dotSize / 3}px`:(this.piecewiseLabel?`0 ${this.dotSize / 2+10}px`:`0 ${this.dotSize / 2}px`)
                }
            },
...
<style>
    ...
    .uiSlider .ui-dot .dotTxt{
        ...
        box-shadow: 0 2px 6px 0 rgba(224,224,224,0.24);
        margin-top: 10px;
        font-size: 14px;
        color: #4D4D4D;
        text-align: center;
