<template>
  <div id="app" class="noselect">
    ...
    <div class="center">
      <ui-slider :zoom="zoomF" :label="['0°','180°']"
      :min="0"
      :max="180"
      title="二面角<h5>θ</h5>"
      v-model="value"
...
//禁止选择
    ...
    this.loopInit();
      ...
      //   });
      // };
     // this.isMob = /(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/g.test(navigator.userAgent);
