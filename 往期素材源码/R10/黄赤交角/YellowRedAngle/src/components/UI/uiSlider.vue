            ...
            <ul class="ui-piecewise">
                <li v-for="(obj, index) in piecewiseDotWrap"
                    ...
                    <span v-if="piecewise"
                          ...
                          :class="{piecewiseActiveStyle:obj.inRange,background1:style1(index)}"></span>
                    <!--滑条上方的文字-->
    ...
    export default {
        ...
        computed: {
            ...
            piecewiseDotWrap () {
                ...
                let arr = [];
                for (let i = 0; i <= this.total; i+=300) {
...
<style>
    ...
    .uiSlider .ui-piecewise-dot.background1{
      background: #5caefd;
    }
</style>
