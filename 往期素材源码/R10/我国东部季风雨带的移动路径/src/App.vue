    ...
    <div id="app" class="noselect">
        ...
        <div class="app_aside">
            ...
            <div class="btn_space" id="btn_space" :style="{display:BtnSpaceStyle}">
                <div style='width: 244px;height: 372px;margin:0 auto;'>
                    <img src="../static/image/bj.png" style='width: 244px;height: 372px;'/>
                </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.setSideStyle();
            $('#slider').append('<div id="sliderP"><span id="s1"><h5>10月</h5></span><span id="s2"><h5>9月</h5></span><span id="s3"><h5>8月</h5></span><span id="s4"><h5>7月</h5></span><span id="s5"><h5>6月</h5></span><span id="s6"><h5>5月</h5></span><span id="s7"><h5>4月</h5></span></div>');
        ...
        methods: {
            ...
            setSideStyle() {
                ...
                if(H<=540){
                    $('#btn_space').css('zoom','0.8');
                }else {
                    $('#btn_space').css('zoom','1');
                }
                var zoom;
                if (W / H > 740 / 440) {
                    zoom = H / 440;
...
<style>
    * {
    ...
    #slider > div#sliderP > span#s6 {
        left: 2px;
        top: 300px;
    }

    #slider > div#sliderP > span#s7 {
        left: 2px;
        top: 363px;
    }
