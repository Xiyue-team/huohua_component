...
//暂时只实现2维
var unitLine = ({width=3,color="#000"}={})=>{
  let line = createStraightLine([[1,0,0],[-1,0,0]],3,width,color);
  return line;
}
var scaleLine = (startPos,endPos,line) =>{
  let [x,y,z] =startPos;
  let [x1,y1,z1] = endPos;
  //获取线段长度
  let len  = Math.hypot(x1-x,y1-y,z1-z);
  // 获得中点坐标
