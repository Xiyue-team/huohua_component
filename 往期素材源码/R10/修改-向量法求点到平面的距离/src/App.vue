  ...
  export default {
    ...
    methods: {
      init() {
        ...
        camera = new THREE.PerspectiveCamera(70, mainWidth / mainHeight, 1, 10000);
        camera.position.x = 0;
        ...
        let vectorBA = () => {
          ...
          dashlinetop = createLineMesh(vertices, '#000', 2, 1);
          if (this.drag_ && this.radio_checked2) {
            ARC2.visible = true;
            dashlinetop.visible = true;
          } else {
        ...
        let createObj = () => {
          ...
          dashlineAO = createLineMesh(vertices, '#000', 2, 1);
        ...
        var setSideStyle = () => {
          ...
          if (mainWidth <= 800) {
            $('.top_img').css('left', mainWidth / 2 + 27 + 'px');
          };
        };
        var TO = function () {
          return {
