    ...
    methods: {
      ...
      init() {
        ...
        let createLinePM = (x, y) => {
          ...
          let vertices = [], vertices1 = [];
          vertices.push(x, 0, 2, x, y, 2);
          let line = createLineMesh(vertices, '#000000', 3, 3);

          vertices1.push(0, 0, 5, x, 0, 5);
          let line1 = createLineMesh(vertices1, '#ff1f3a', 3, 4);

          let text = createText('M', x, y >= 0 ? '-10' : '40', 0, '#000', 25);
          let textcos = createText('cosα', x/2, -8, 0, '#000', 25);

          linePM.add(line, text, line1,textcos);
        ...
        var createObj = () => {
          ...
          textP = createText('P(x,y)', r*Math.cos(Math.PI/3)+50,r*Math.sin(Math.PI/3)+30, 4, '#000', 28);
          ...
          scene.add(circle, touchP, pointP, textP, angleA);
        };
        createObj();
        ...
        var TO = function () {
          return {
            reset: resetWidget,
            linePMShow: linePMShow,
            linePMHide: linePMHide
          }
        };
        return TO();
      },
