  ...
  <div id="app" class="noselect">
    ...
    <div class="app_aside">
      ...
      <div class="btn_space" id="btn_space" :style="{display:BtnSpaceStyle}">
        ...
        <ui-btn type="switch"  v-model="checked" style="margin-bottom: 50px;" @click.native="btnClick">
          三视图
        </ui-btn>
        <ui-group type="radio"
                  :margin="12"
    ...
    methods: {
      ...
      setSideStyle(){
        ...
        if (height>300&&height < 580) {
          zoom = 0.5;
          zoom1 = 1.8;
          $('.app_aside').css('zoom', zoom);
          $('.aside_reset').css('zoom', zoom1);
        } else if (height<300){
          zoom = 0.45;
          zoom1 = 1.5;
          $('.app_aside').css('zoom', zoom);
        ...
        $('#renderCanvas').width(width - 280 * zoom);
      },
      ...
      createScene(){
        ...
        if (W < 800) {
          this.camera = new THREE.OrthographicCamera(mainWidth/-0.6,mainWidth/0.6,mainHeight/0.6,mainHeight/-0.6,-100,10000);
        } else {
      ...
      createObj() {
        ...
        //三棱锥 连线
        this.line1=this.line_c(1,3);
        this.line2=this.line_c(1,5);
        this.line3=this.line_c(1,7);
        this.line4=this.line_c(3,5);
        this.line5=this.line_c(3,7);
        this.line6=this.line_c(5,7);
        ...
        this.scene.add(this.obj_c,this.line1,this.line2,this.line3,this.line4,this.line5,this.line6);
      },
      createBash(){
        if(this.obj_c!=null){
      ...
      //添加边角
      btnAdd(){
        if(this.back_flag>3||this.anFlag){
          return;
        }
        this.anFlag=true;
