    ...
    methods: {
      init(){
        ...
        var createObj = () => {
          ...
          this.point['m'][0] = (this.point["p"][0]+this.point["s"][0])/2;
          this.point['m'][1] = (this.point["p"][1]+this.point["s"][1])/2;
          ...
          vertices.push(vec3(this.point["p"][0]*40,this.point["p"][1]*40,1));
          vertices.push(vec3(this.point["f"][0]*40,this.point["f"][1]*40,1));
          var linePF = createLineMesh(vertices,"#000",3,2);

          //画SF
          vertices = [];
          vertices.push(vec3(this.point["s"][0]*40,this.point["s"][1]*40,1));
          vertices.push(vec3(this.point["f"][0]*40,this.point["f"][1]*40,1));
          var lineSF = createLineMesh(vertices,"#000",3,2);
          //P,R,S
          ...
          var k = (this.point['p'][1]-this.point['f'][1])/(this.point['p'][0]-this.point['f'][0]);
          angle.position.set(this.point['f'][0]*40,this.point['f'][1]*40,1);
          if(this.point['a'][0]>0){
          ...
          if(this.point["a"][0] != 0){
            obj1.add(yuan,textP,textS,lineBS,angle2,angle3,linePF,lineSF,angle);
          }
          
          obj1.add(lineAP,angle1)
