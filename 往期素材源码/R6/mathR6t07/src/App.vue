    ...
    methods: {
      init(){
        ...
        var createObj1 = () => {
          ...
          vertices = [];
          vertices.push(vec3(this.point["l1"][0]*40,this.point["l1"][1]*40,5));
          vertices.push(vec3(this.point["l2"][0]*40,this.point["l2"][1]*40,5));
        ...
        var createObj = () => {
          ...
          var textB = createText("B",this.point['b'][0]>0?5:-5,this.point['b'][1]>0?40:-20,0,"#6D6EFF",24);
          ...
          var d = 0;
          d = Math.pow(Math.pow(this.point["a"][0]-this.point["b"][0],2)+Math.pow(this.point["a"][1]-this.point["b"][1],2),1/2);
          ...
          for(var i=0;i<361;this.point['a'][0]>0.5?(i++):(i+=0.1)) {
          ...
          vertices.push(vec3(this.point["b"][0]*40,this.point["b"][1]*40,1));
          var lineBS = createLineMesh(vertices,"#21D36A",2,2);
          ...
          var textS = createText("S",this.p>0?-this.p/2*40-20:-this.p/2*40+20,this.point['s'][1]*40+14,0,"#6D6EFF",24);
          ...
          var angle2 = createLineMesh(vertices,"#21D36A",3);
          ...
          obj1.add(lineAP,lineMR,yuan,groupM,textP,textR,textS,lineBS,angle2,angle1,angle3);
