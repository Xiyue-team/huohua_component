<template>
    <div id="app" class="noselect">
        ...
        <div class="app_aside">
            ...
            <!--重制按钮-->
            <ui-btn type="reset1" class="aside_reset" id="buttom1" @click.native="resetWidget"></ui-btn>
            <!--清除浮动-->
    ...
    export default {
        ...
        data() {
            return {
                ...
                females: [{
                    name: 'XWXW',
                    htm: '<img src="static/img/1.png" alt=""><p>X<sup>d</sup>X<sup>d</sup></p>',
                    id:'buttom2'
                }, {
                    name: 'XWXw',
                    htm: '<img src="static/img/2.png" alt=""><p>X<sup class="small">D</sup>X<sup>d</sup></p>',
                    id:'buttom3'
                }, {
                    name: 'XwXw',
                    htm: '<img src="static/img/3.png" alt=""><p>X<sup class="small">D</sup>X<sup class="small">D</sup></p>',
                    id:'buttom4'
                }],
                //雄性按钮
                males: [{
                    name: 'XWY',
                    htm: '<img src="static/img/4.png" alt=""><p>X<sup>d</sup>Y</p>',
                    id:'buttom5'
                }, {
                    name: 'XwY',
                    htm: '<img src="static/img/5.png" alt=""><p>X<sup class="small">D</sup>Y</p>',
                    id:'buttom6'
                }],
                //视图区数据
                topShow: [0,0,0,0,0],
...
//            },
            ...
            setActive(info, type, isDisabled) {
                ...
                if (type === 'female') {
                    ...
                    //更换配子文字
                    this.inputs[0] = this.getValueByName(info, 1);
                    this.inputs[1] = this.getValueByName(info);
            ...
            getValueByName(name, index) {
                if (name === 'XWXW') {
                    ...
                    return index ? 'X<sup class="small">D</sup>' : 'X<sup>d'
                } else if (name === 'XwXw') {
                    return 'X<sup class="small">D</sup>'
                } else if (name === 'XWY') {
                    return index ? 'Y<sup></sup>' : 'X<sup>d</sup>'
                } else if (name === 'XwY') {
                    return index ? 'Y<sup></sup>' : 'X<sup class="small">D</sup>'
                }
            },
            ...
            getChild() {
                ...
                if (this.female === 'XWXW') {
                    ...
                    if (this.male === 'XWY') {
                        ...
                        this.Timeouts[0] = setTimeout(() => {
                            ...
                            this.Timeouts[1] = setTimeout(() => {
                                ...
                                this.Timeouts[2] = setTimeout(() => {
                                    this.$set(this.childrens, 0, '正常X<sup>d</sup>X<sup>d</sup>')
                                }, 100)
                            }, 200)
                        ...
                        this.Timeouts[3] = setTimeout(() => {
                            ...
                            this.Timeouts[4] = setTimeout(() => {
                                ...
                                this.Timeouts[5] = setTimeout(() => {
                                    this.$set(this.childrens, 2, '正常X<sup>d</sup>Y')
                                }, 100)
                            }, 200)
                        }, 1300)
                        ...
                        //             this.$set(this.childrens, 3, '正常X<sup>d</sup>Y')
                        //         }, 100)
                        //     }, 200)
                        // }, 2900)
                    }
                    //正常+患者
                        ...
                        this.Timeouts[0] = setTimeout(() => {
                            ...
                            this.Timeouts[1] = setTimeout(() => {
                                ...
                                this.Timeouts[2] = setTimeout(() => {
                                    this.$set(this.childrens, 0, '患者X<sup class="small">D</sup>X<sup>d</sup>')
                                }, 100)
                            }, 200)
                    ...
                    if (this.male === 'XWY') {
                        ...
                        this.Timeouts[3] = setTimeout(() => {
                            this.$set(this.downShow, 7, 1)
                            this.$set(this.downShow, 8, 1)
                            this.Timeouts[4] = setTimeout(() => {
                                this.$set(this.last_dd, 1, 'static/img/girl-blue.png')
                                this.Timeouts[2] = setTimeout(() => {
                                    this.$set(this.childrens, 1, '正常X<sup>d</sup>X<sup>d</sup>')
                                }, 100)
                            }, 200)
                        }, 1300)
                        ...
                        this.Timeouts[6] = setTimeout(() => {
                            ...
                            this.Timeouts[7] = setTimeout(() => {
                                ...
                                this.Timeouts[11] = setTimeout(() => {
                                    this.$set(this.childrens, 2, '患者X<sup class="small">D</sup>Y')
                                }, 100)
                            }, 200)
                        }, 2100)
                    ...
                    //患者+患者
                        ...
                        this.Timeouts[0] = setTimeout(() => {
                            ...
                            this.Timeouts[1] = setTimeout(() => {
                                ...
                                this.Timeouts[5] = setTimeout(() => {
                                    this.$set(this.childrens, 0, '患者X<sup class="small">D</sup>X<sup class="small">D</sup>')
                                }, 100)
                            }, 200)
                        }, 500)
                        ...
                        this.Timeouts[3] = setTimeout(() => {
                            ...
                            this.Timeouts[4] = setTimeout(() => {
                                ...
                                this.Timeouts[2] = setTimeout(() => {
                                    this.$set(this.childrens, 1, '患者X<sup class="small">D</sup>X<sup>d</sup>')
                                }, 100)
                            }, 200)
                        }, 1300)
                    ...
                    if (this.male === 'XWY') {
                        ...
                        //         this.Timeouts[11] = setTimeout(() => {
                        //             this.$set(this.childrens, 3, '患者X<sup class="small">D</sup>Y')
                        //         }, 100)
                        //     }, 200)
                        // }, 2900)
                    }
