    ...
    methods: {
      ...
      init() {
        ...
        var createObj1 = () => {
          ...
          text1 = createText("A(1,0)", 300+42, -3 , 0, "#299AED", 28);
        ...
        var setPColor = () => {
          ...
          if (this.checked) {
            textPa = createText("a", pointP.x + 65, pointP.y + 20, 0, "#EF2C2C", 40);
            textPb = createText("b", pointP.x + 100, pointP.y + 20, 0, "#299AED", 40);
          } else {
            textPa = createText("a", pointP.x + 65, pointP.y + 20, 0, "#000", 40);
            textPb = createText("b", pointP.x + 100, pointP.y + 20, 0, "#000", 40);
          }
        ...
        var createObj = () => {
          ...
          let textP = createText("P(  ,  )", pointP.x + 70, pointP.y + 25, 0, "#000", 40);
          setPColor();
          var groupP = new THREE.Object3D();
          var circleP = createCircle([0, 0, 0], 6, "#6D68FF");
          vertices = [];
          for (var i = 0; i < 361; i = i + 4) {
            vertices.push(new THREE.Vector3(6 * Math.cos(i * Math.PI / 180), 6 * Math.sin(i * Math.PI / 180), 0));
          }
          ...
          let textA = createText("a", pointP.x / 2, p.y >= 0 ? 0 : 35, 2, "#EF2C2C", 40);
          let textB = createText("b", pointP.x + 22, pointP.y / 2, 2, "#299AED", 40);
          let textM = createText("M", pointP.x, p.y >= 0 ? 0 : 35, 2, "#000", 40);

          //画𝜃角
          vertices = [];
          let dx, dy;
          for (let i = 0; i < radianK / Math.PI * 180; i++) {
          ...
          let text0 = createText('α', 35 * Math.cos(radianK / 2)+10, 35 * Math.sin(radianK / 2) + 35, 3, '#000', 40);
          obj1.add(textA, textB, line0, text0, textM);
          if (canShowLine) {
