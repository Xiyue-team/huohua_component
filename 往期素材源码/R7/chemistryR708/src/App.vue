  ...
  export default {
    ...
    methods: {
      ...
      inits(){
          ...
          mtlLoader.load( mtl, function( materials ) {
            ...
            objLoader.load( obj, function ( object ) {
              ...
              for(var i in O.children){
                ...
                //晶体透明
                if(O.children[i].name.indexOf('dron_')!=-1){
                ...
                //晶胞隐藏
                if(O.children[i].name.indexOf('jinbao')!=-1){
                     O.children[i].visible = false;
                }
              }
              model=O;
        ...
        modelPut('ti.obj','ti.mtl',model,6,()=>{
        ...
        var setColor = () =>{
            ...
            for (var i in modelC.children){
                ...
                if(modelC.children[i].name.indexOf('other') != -1){
                     modelC.children[i].material=new THREE.MeshPhongMaterial({color:colorD,transparent:true,opacity:1});
                }
            }
        }
        ...
        var setVisible = () =>{
            ...
            for(var i in modelC.children){
                if(modelC.children[i].name.indexOf('dron_') != -1) {
              ...
              if(f) {
                ...
                for (var i in model.children) {
                    ...
                    if(model.children[i].name.indexOf('bili') != -1) {
                        ...
                        if(model.children[i].name.indexOf('group33') != -1) {
                            if(model.children[i].name.indexOf('pSphere20') != -1) {
                                model.children[i].material=new THREE.MeshPhongMaterial({color:colorL});
                            }
                             if(model.children[i].name.indexOf('pSphere26_four1') != -1) {
                                model.children[i].material=new THREE.MeshPhongMaterial({color:colorD});
                            }
                        }
                ...
                for (var i in modelC.children) {
                    ...
                    if(modelC.children[i].name.indexOf('bili') != -1) {
                        ...
                        if(modelC.children[i].name.indexOf('group33') != -1) {
                             modelC.children[i].visible=false;
                            if(modelC.children[i].name.indexOf('pSphere20') != -1) {
                                modelC.children[i].visible=true;
                                modelC.children[i].material=new THREE.MeshPhongMaterial({color:colorL});
                            }
                            if(modelC.children[i].name.indexOf('pSphere26_four1') != -1) {
                                modelC.children[i].visible=false;
                                modelC.children[i].material=new THREE.MeshPhongMaterial({color:colorD});
                            }
                        }
                        //八面体晶体显示
        ...
        var show3=(f)=>{
            if(f) {
                ...
                for(var i in model.children) {
                    //晶胞高亮显示
                    if(model.children[i].name.indexOf('qiugun') != -1 && model.children[i].name.indexOf('dron') == -1){
                    ...
                    if(model.children[i].name.indexOf('jinbao') != -1){
                        model.children[i].visible=false;
                    }
                    if(model.children[i].name.indexOf('bili') != -1 && model.children[i].name.indexOf('dron') == -1){
                        model.children[i].material.transparent=true;
                        model.children[i].material.opacity=opN;
                        if(model.children[i].name.indexOf('other') == -1){
                            model.children[i].material=new THREE.MeshPhongMaterial({color:colorL});
               ...
               for(var i in model.children) {
                    ...
                    if(model.children[i].name.indexOf('qiugun') != -1 && model.children[i].name.indexOf('dron') == -1){
                        ...
                        if(model.children[i].name.indexOf('other') == -1 && model.children[i].name.indexOf('dron') == -1){
                            model.children[i].material=new THREE.MeshPhongMaterial({color:colorD});
                        }
                    }
                    if(model.children[i].name.indexOf('jinbao') != -1){
            ...
            if(f) {
                ...
                if(this.blue1){
                    for (var i in modelC.children) {
                        ...
                        if (modelC.children[i].name.indexOf('jinbao') != -1) {
                            modelC.children[i].visible = false;
                        }
                    }
                }
                ...
                for (var i in model.children) {
                    ...
                    if (model.children[i].name.indexOf('bili') != -1 && model.children[i].name.indexOf('dron_') == -1) {
                        model.children[i].visible = true;
                    }
                    if (model.children[i].name.indexOf('jinbao') != -1) {
                        model.children[i].visible = false;
            ...
            for(var i in modelC.children){
                if(modelC.children[i].name.indexOf(s1) != -1) {
                    ...
                    if(modelC.children[i].name.indexOf('group33') != -1) {
                        ...
                        if(modelC.children[i].name.indexOf('pSphere20') != -1 && this.blue==2){
                            modelC.children[i].visible=true;
                        }else if(modelC.children[i].name.indexOf('pSphere20') != -1 && this.blue==1){
                            modelC.children[i].visible=false;
                        }
                    }
        ...
        //显示数学模型
          var show5=(f)=>{
            if(f){
                if(this.blue1) {
                    if(this.checked2){
                        cartoon('qiugun','other','_four1','tetrahedron_','static/img/pic1.png');
                    }else{
                        cartoon('bili','other','_four1','tetrahedron_','static/img/pic1.png');
                    }
                }
                if(this.blue2) {
                    if(this.checked2){   
                        cartoon('qiugun','other','_eight','Octahedron_','static/img/pic2.png');
                    }else{
                        cartoon('bili','other','_eight','Octahedron_','static/img/pic2.png');
                    }
                }
            }else{
                cancelAnimationFrame(SET);
