<template>
  <div id="app" class="noselect">
    <div class="container">
      ...
      <div class="footer">
        <ui-slider id='slider' class="footerSlider" :min="0" :max="719" :title="false" :box="false" :boxHeight="58" :tooltip="false" :speed="0" :timeLine="false" v-model='value' :label="[[' ','卵原细胞'],['','初级卵母细胞'],['',' '],['减数第一次分裂',''],['',' '],['','次级卵母细胞+极体 '],['',' '],['减数第二次分裂',''],['',' '],[' ','卵细胞+极体']]">
        </ui-slider>
  ...
  export default {
    ...
    data() {
      return {
        ...
        sliderPoint: [0, 70, 178, 248, 310, 394, 461, 508, 568, 719],
        index: 0,
        dynamicText: [
    ...
    methods: {
      ...
      getSliderWidth() {
        ...
        processL.style.background = `linear-gradient(to right,#5caefd 0px,#5caefd ${W*70/719}px,#0ceaed ${W*70/719}px,#0ceaed ${W*394/719}px,#09f49e ${W*394/719}px,#09f49e 100%)`;
      },
...
<style>
  ...
  *:after {
  ...
  #slider .ui-label li:last-child {
    margin-left: -10px;
  }
  #slider .ui-label li:first-child {
    margin-left: -20px;
  }
  #slider .ui-label li:nth-child(2){
    margin-left: 10px;
  }
