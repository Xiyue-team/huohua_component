  ...
  export default {
    ...
    methods: {
      ...
      inits(){
            ...
            objLoader.load( obj, function ( object ) {
              ...
              for(var i in O.children){
                ...
                if(O.children[i].name.indexOf('Octahedron')!=-1){
                    O.children[i].material=new THREE.MeshPhongMaterial({color:'#c9fffe',transparent:true,opacity:0.7});
                }
                //四面体晶体透明
        ...
        modelPut('mianxinlifangtiduiji.obj','mianxinlifangtiduiji.mtl',model,6,()=>{
                    ...
                    if(this.blue1){
                        for (var i in modelC.children) {
                           if (modelC.children[i].name.indexOf('qiugun') != -1) {
                                ...
                                if (modelC.children[i].name.indexOf('group36') != -1) {
                                     if (modelC.children[i].name.indexOf('_four1') != -1) {
                                        modelC.children[i].visible = true;
                                    }
                                }
