    ...
    <div id="app" class="noselect">
        ...
        <div class="app_aside" :style="'pointer-events:'+pe">
            ...
            <div class="btn_space" id="btn_space">
                <ui-btn size="big" :class="{op:pe1}" :type="blue1" @click.native="blueClick(1)" id="button2">Na<sup>+</sup>浓度梯度</ui-btn>
                <ui-btn size="big" :class="{op:pe2}" :type="blue2" @click.native="blueClick(2)" id="button3">K<sup>+</sup>浓度梯度</ui-btn>
            </div>
        </div>
    </div>
</template>
        ...
        methods: {
            blueClick(val) {
                ...
                if (this.blue == 1) {
                    ...
                    this.blue2 = '';
                    this.pe2=true;
                    this.imgLi(this.src1,10500,true);
