...
export default {
  ...
  data() {
    return {
      ...
      females: [{
        name: 'XWXW',
        htm: '<img src="static/img/1.png" alt=""><p>X<sup>H</sup>X<sup>H</sup></p>',
        id: 'buttom2'
      }, {
        name: 'XWXw',
        htm: '<img src="static/img/2.png" alt=""><p>X<sup>H</sup>X<sup class="small">h</sup></p>',
        id: 'buttom3'
      }, {
        name: 'XwXw',
        htm: '<img src="static/img/3.png" alt=""><p>X<sup class="small">h</sup>X<sup class="small">h</sup></p>',
        id: 'buttom4'
      }],
      //雄性按钮
      males: [{
        name: 'XWY',
        htm: '<img src="static/img/4.png" alt=""><p>X<sup>H</sup>Y</p>',
        id: 'buttom5'
      }, {
        name: 'XwY',
        htm: '<img src="static/img/5.png" alt=""><p>X<sup class="small">h</sup>Y</p>',
        id: 'buttom6'
      }],
      //视图区数据
      topShow: [0, 0, 0, 0,0],
  ...
  methods: {
    ...
    getValueByName(name, index) {
      if (name === 'XWXW') {
        ...
        return index ? 'X<sup class="small">h</sup>' : 'X<sup>H'
      } else if (name === 'XwXw') {
        return 'X<sup class="small">h</sup>'
      } else if (name === 'XWY') {
        return index ? 'Y<sup></sup>' : 'X<sup>H</sup>'
      } else if (name === 'XwY') {
        return index ? 'Y<sup></sup>' : 'X<sup class="small">h</sup>'
      }
    },
    //根据点击的名称，添加连线
    setLineByName(name) {
