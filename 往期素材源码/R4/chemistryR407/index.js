...
modelPut('zns.obj','zns.mtl',model1,2,function (O) {
    scene.add(O)
});
...
function addC() {
    ...
    if(flag == 0){
        modelPut('zns.obj','zns.mtl',model2,2,function (O) {
            scene.add(O)
        });
        ...
        modelPut('zns.obj','zns.mtl',model3,2,function (O) {
            scene.add(O)
        });
        ...
        modelPut('zns.obj','zns.mtl',model4,2,function (O) {
            scene.add(O)
        });
