...
modelPut('caf2.obj','caf2.mtl',model1,2,function (O) {
    scene.add(O)
});
...
function addC() {
    ...
    if(flag == 0){
        modelPut('caf2.obj','caf2.mtl',model2,2,function (O) {
            scene.add(O)
        });
        ...
        modelPut('caf2.obj','caf2.mtl',model3,2,function (O) {
            scene.add(O)
        });
        ...
        modelPut('caf2.obj','caf2.mtl',model4,2,function (O) {
            scene.add(O)
        });
