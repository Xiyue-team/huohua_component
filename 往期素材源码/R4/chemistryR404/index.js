...
modelPut('nacl_jingti.obj','nacl_jingti.mtl',model1,2,function (O) {
    scene.add(O)
});
...
function addC() {
    ...
    if(flag == 0){
        modelPut('nacl_jingti.obj','nacl_jingti.mtl',model2,2,function (O) {
            scene.add(O)
        });
        model1.position.set(-74,0,0);
        model2.position.set(74,0,0);
        flag++;
    }else if(flag == 1){
        modelPut('nacl_jingti.obj','nacl_jingti.mtl',model3,2,function (O) {
            scene.add(O)
        });
        model1.position.set(-74,-74,0);
        model2.position.set(74,-74,0);
        model3.position.set(-74,74,0);
        flag++;
    }else {
        modelPut('nacl_jingti.obj','nacl_jingti.mtl',model4,2,function (O) {
            scene.add(O)
        });
        model4.position.set(74,74,0);
    }
}
