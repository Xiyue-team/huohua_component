...
modelPut('cscl.obj','cscl.mtl',model1,2,function (O) {
    scene.add(O)
});
...
function addC() {
    ...
    if(flag == 0){
        modelPut('cscl.obj','cscl.mtl',model2,2,function (O) {
            scene.add(O)
        });
        model1.position.set(-50,0,0);
        model2.position.set(50,0,0);
        flag++;
    }else if(flag == 1){
        modelPut('cscl.obj','cscl.mtl',model3,2,function (O) {
            scene.add(O)
        });
        model1.position.set(-50,-50,0);
        model2.position.set(50,-50,0);
        model3.position.set(-50,50,0);
        flag++;
    }else {
        modelPut('cscl.obj','cscl.mtl',model4,2,function (O) {
            scene.add(O)
        });
        model4.position.set(50,50,0);
    }
}
