    ...
    methods: {
      ...
      init() {
        ...
        var createCAAB = (x) =>{
          ...
          var LineCA = createLineMesh(verticesCA,'#000000',3,3);
          var LineAB = createLineMesh(verticesAB,'#E30000',3,3);

          var jianCA = createJian('#000000');
          jianCA.rotation.z = -Math.atan((x+300)/500);
          var X1 = 26*(x+300)/Math.sqrt(500*500+(x+300)*(x+300))/1.2;
          var Y1 = 26*500/Math.sqrt(500*500+(x+300)*(x+300))/1.2;
          jianCA.position.set(x-X1,300-Y1,0);

          var jianBA = createJian('#E30000');
          jianBA.rotation.z = Math.atan((300-x)/500);
          var X2 = 26*(300-x)/Math.sqrt(500*500+(300-x)*(300-x))/1.2;
          var Y2 = 26*500/Math.sqrt(500*500+(300-x)*(300-x))/1.2;
        ...
        var createObj = () => {
          ...
          var LineCB = createLineMesh(verticesCB,'#0094FF',3,3);
          ...
          var D = createText('D',100,-200,0,'#1500FF',32);
          ...
          var jian = createJian('#0094FF');
          jian.position.set(290,-200,0);
          jian.rotation.z = -Math.PI/2;
          scene.add(dashedLine,LineCB,C,B,A,D,touchP,jian);
        };
        createObj();
