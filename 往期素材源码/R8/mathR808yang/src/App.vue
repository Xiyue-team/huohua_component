    ...
    methods: {
      ...
      init() {
        ...
        var createCAAB = (x) =>{
          ...
          LineCA = createLineMesh(verticesCA,'#FF5D00',3,3);
          LineAB = createLineMesh(verticesAB,'#FF5D00',3,3);
        ...
        var createAD = (x) =>{
          ...
          var LineAD = createLineMesh(verticesAD,'#1B8B72',2,2);
          ...
          var D = createText('D',x,-230,0,'#000',38);

          if(x >= -500 && x< -300){
            vertices3.push(vec3(x,-200,0),vec3(-300,-200,0));
            var Linedash1 = createLineMesh(vertices3,'#FF5D00',2,2);
            AD.add(Linedash1);
          }else if(x > 300 && x<= 500){
            vertices4.push(vec3(300,-200,0),vec3(x,-200,0));
            var Linedash2 = createLineMesh(vertices4,'#FF5D00',2,2);
            AD.add(Linedash2);
            angle.rotation.y =  Math.PI;
          }
          AD.add(LineAD,angle1,D);
          scene.add(AD);
        };
        //创建初始物体
        var createObj = () => {
          ...
          A = createText('A',150,375,0,'#000',38);
          var a = createText('a',0,-190,0,'#1500FF',34);
          b  = createText('c',-100,100,0,'#1500FF',34);
          c  = createText('b',250,100,0,'#1500FF',34);
