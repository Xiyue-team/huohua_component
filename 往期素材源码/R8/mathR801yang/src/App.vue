    ...
    methods: {
      ...
      init() {
        ...
        var createYuan = (r, val, color) => {
          ...
          var yuan = createLineMesh(vertices, color1, 3, 1);
          return yuan;
        };
        //画圆面
        ...
        var createObj1 = () => {
          ...
          for (let i = -480; i <= 480; i += deshStep) {
            vertices1.push(vec3(i, Math.sin(i / 160 * Math.PI) * 100, 0));
          }
        ...
        var symmetric = () => {
          ...
          if (this.checked1) {
            ...
            let an = function () {
              ...
              lineBB = createLineMesh(vertices, '#E30000', 2, 2);
              for (var i = -3; i <= 2; i++) {
                var line1 = lineBB.clone();
                line1.position.x = i * 160+80;
        ...
        //旋转
        var translation = () => {
          cancelAnimationFrame(trans);
          curve1.visible = true;
          var number = 0,step = 0.03;
          curve1.rotation.z=0;
          let an = () =>{
            // number++;
            if (curve1.rotation.z < -Math.PI) {
              cancelAnimationFrame(trans);
              curve1.rotation.z = -Math.PI;
              return;
            }
            curve1.rotation.z -= step;
            trans = requestAnimationFrame(an);
          };
          an();
        };
