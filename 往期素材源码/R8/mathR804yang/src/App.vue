    ...
    methods: {
      ...
      init() {
        ...
        var createAD = (x) =>{
          ...
          var bcosc = createText('(bcosC,bsinC)',x+120,365,0,'#000',30);
        ...
        //创建初始物体
        var createObj = () => {
          var vertices =[],verticesCB =[],verticesX = [],verticesY = [];
          ...
          var B = createText('B(a,0)',330,-200,0,'#000',34);
          A = createText('A',150,370,0,'#000',34);
          var a = createText('a',0,-190,0,'#1500FF',30);
          b  = createText('b',-100,100,0,'#1500FF',30);
          c  = createText('c',250,100,0,'#1500FF',30);
          ...
          //坐标轴
          verticesX.push(vec3(-500,-200,-1),vec3(500,-200,-1));
          var Xline = createLineMesh(verticesX,'#000',3,2);

          verticesY.push(vec3(-300,400,-1),vec3(-300,-300,-1));
          var Yline = createLineMesh(verticesY,'#000',3,2);

          var jian = new THREE.Group();
          vertices =[];
          vertices.push(vec3(- 10, 0, 0));
          vertices.push(vec3(- 13, -5, 0));
          ...
          jian.scale.set(1.5,1.5,1.5);
          jian.position.set(-300,400,0);

          var jian1 = jian.clone();
          jian1.position.set(500,-200,0);
          jian1.rotation.z = -Math.PI/2;
          scene.add(dashedLine,LineCB,C,B,A,a,b,touchP,c,Xline,Yline,jian,jian1);
        };
        createObj();
        //拖动事件
        var drawLine = () =>{
