<template>
    <div id="app" class="noselect">
              ...
              <div :style="[zoom]" class="viewBox">
                ...
                <dl>
                    ...
                    <dd :style="{height:405/names.length+'px'}">
                        <img :src="last_dd[0]" alt=""
                             :style="{opacity:last_dd[0] != ''?'1':'0',position:'relative',left:!justifyContent?'115px':'0'}" class="img">
                ...
                <div name="itemlist" tag="div" class="result_btn">
                    <ui-btn v-html="childrens[0]"
                            :style="{opacity:childrens[0] != ''?'1':'0','pointer-events':'none',position:'relative',left:!justifyContent?'140px':'0px'}"></ui-btn>
                    <ui-btn v-html="childrens[1]"
                            :style="{opacity:childrens[1] != ''?'1':'0','pointer-events':'none'}"></ui-btn>
                    <ui-btn v-html="childrens[2]"
                            :style="{opacity:childrens[2] != ''?'1':'0','pointer-events':'none',position:'relative',left:!justifyContent?'2px':'0px'}"></ui-btn>
                ...
                <ol>
                  ...
                  <li>
                    <img :src="'static/arrows/arrow-'+(e+5)+'.png'"
                         ...
                         :key="e"
                         v-if="e+5<=17"
                         :style="{left:'65px',opacity:downShow[(e+5-1)] === 1?1:0}">
                    <img :src="'static/arrows/arrow-0'+(r+5)+'.png'"
                         v-for="r in 17"
                         :key="r"
                         v-if="r+5<=17"
                         :style="{left:'65px',opacity:downShow[(r+5-1)] === 2?1:0}">
        ...
        <div class="app_aside">
            ...
            <!--重制按钮-->
            <ui-btn type="reset1" id="buttom2" class="aside_reset" @click.native="resetWidget"></ui-btn>
            <!--清除浮动-->
            <div class="btn_space" id="btn_space" :style="{display:BtnSpaceStyle}">
                <div>
                    <div>
                        <h3>女性</h3>
                        <div size="big" :id="fe.id"
                              :key="fe.name"
                              @click="setActive(fe.name,'female',female != fe.name && female != '')"
                              :type="female === fe.name?'blue':''"
                              :class="{disabled:female != fe.name && female != '',checked:female == fe.name}"
                              v-html="fe.htm"
                              v-for="fe in females"></div>
                    </div>
                    <div>
                        <h3>男性</h3>
                        <div size="big" :id="ma.id"
                              :key="ma.name"
                              @click="setActive(ma.name,'male',male != ma.name && male != '')"
                              :type="male === ma.name?'blue':''"
                              :class="{disabled:male != ma.name && male != '',checked:male == ma.name}"
                              v-html="ma.htm"
                              v-for="ma in males"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        data(){
            return {
                ...
                females:[{
                    name:'XWXW',
                    htm:'<img src="static/img/1.png" alt=""><p>X<sup>B</sup>X<sup>B</sup></p>',
                    id:'buttom2'
                },{
                  name:'XWXw',
                  htm:'<img src="static/img/2.png" alt=""><p>X<sup>B</sup>X<sup class="small">b</sup></p>',
                    id:'buttom3'
                },{
                  name:'XwXw',
                  htm:'<img src="static/img/3.png" alt=""><p>X<sup class="small">b</sup>X<sup class="small">b</sup></p>',
                    id:'buttom4'
                }],
                //雄性按钮
                males:[{
                  name:'XWY',
                  htm:'<img src="static/img/4.png" alt=""><p>X<sup>B</sup>Y</p>',
                    id:'buttom5'
                },{
                  name:'XwY',
                  htm:'<img src="static/img/5.png" alt=""><p>X<sup class="small">b</sup>Y</p>',
                    id:'buttom6'
                }],
                //视图区数据
                topShow:[0,0,0,0,0],
           ...
           // },
            ...
            getValueByName(name,index){
              if(name === 'XWXW'){
                return 'X<sup>B'
                  ...
                  return index?'X<sup class="small">b</sup>':'X<sup>B'
              }else if(name === 'XwXw'){
                return 'X<sup class="small">b</sup>'
              }else if(name === 'XWY'){
                return index?'Y<sup></sup>':'X<sup>B</sup>'
              }else if(name === 'XwY'){
                return index?'Y<sup></sup>':'X<sup class="small">b</sup>'
              }
            },
            ...
            setLineByName(name){
              if(name === 'XWXW'){
                ...
                this.topShow[0] = 1; this.topShow[1] = 2;
              }else if(name === 'XwXw'){
                this.topShow[4] = 2;
              }else if(name === 'XWY'){
                this.topShow[2] = 1; this.topShow[3] = 1;
              }else if(name === 'XwY'){
                this.topShow[2] = 2;this.topShow[3] = 1;
              }
            },
                   ...
                   this.Timeouts[0]= setTimeout(()=>{
                     ...
                     this.Timeouts[1]= setTimeout(()=>{
                       ...
                       this.Timeouts[2]= setTimeout(()=>{
                          this.$set(this.childrens,0,'正常X<sup>B</sup>X<sup>B</sup>')
                        },100)
                      },200)
                    ...
                    this.Timeouts[3]= setTimeout(()=>{
                      ...
                      this.Timeouts[4]=setTimeout(()=>{
                        ...
                        this.Timeouts[5]= setTimeout(()=>{
                          this.$set(this.childrens,2,'正常X<sup>B</sup>Y')
                        },100)
                      },200)
                    },1300)
                    ...
                    //       this.$set(this.childrens,3,'正常X<sup>B</sup>Y')
                    //     },100)
                    //   },200)
                    // },2900)
                  }
                  //正常+色盲
                    ...
                    this.Timeouts[0]= setTimeout(()=>{
                      ...
                      this.Timeouts[1]= setTimeout(()=>{
                        ...
                        this.Timeouts[2]= setTimeout(()=>{
                          this.$set(this.childrens,0,'携带X<sup>B</sup>X<sup class="small">b</sup>')
                        },100)
                      },200)
                  ...
                  if(this.male === 'XWY'){
                    ...
                    this.Timeouts[3]= setTimeout(()=>{
                      ...
                      this.Timeouts[4]=setTimeout(()=>{
                        ...
                        this.Timeouts[5]= setTimeout(()=>{
                          this.$set(this.childrens,1,'携带X<sup>B</sup>X<sup class="small">b</sup>')
                        },100)
                      },200)
                    },1300)
                    ...
                    this.Timeouts[9]= setTimeout(()=>{
                      ...
                      this.Timeouts[10]=setTimeout(()=>{
                        ...
                        this.Timeouts[11]=setTimeout(()=>{
                          this.$set(this.childrens,3,'色盲X<sup class="small">b</sup>Y')
                        },100)
                      },200)
                    },2900)
                  ...
                  //携带+色盲
                    ...
                    this.Timeouts[3]= setTimeout(()=>{
                      ...
                      this.Timeouts[4]=setTimeout(()=>{
                        ...
                        this.Timeouts[5]= setTimeout(()=>{
                          this.$set(this.childrens,1,'色盲X<sup class="small">b</sup>X<sup class="small">b</sup>')
                        },100)
                      },200)
                    },1300)
                  ...
                  if(this.male === 'XWY'){
                    ...
                    this.Timeouts[3]= setTimeout(()=>{
                      ...
                      this.Timeouts[4]=setTimeout(()=>{
                        ...
                        this.Timeouts[5]= setTimeout(()=>{
                          this.$set(this.childrens,2,'色盲X<sup class="small">b</sup>Y')
                        },100)
                      },200)
                    },1300)
                  ...
                  //色盲+色盲
                    ...
                    this.Timeouts[0]= setTimeout(()=>{
                      ...
                      this.Timeouts[1]= setTimeout(()=>{
                        ...
                        this.Timeouts[2]= setTimeout(()=>{
                          this.$set(this.childrens,0,'色盲X<sup class="small">b</sup>X<sup class="small">b</sup>')
                        },100)
                      },200)
