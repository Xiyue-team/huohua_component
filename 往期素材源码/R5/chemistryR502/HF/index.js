...
function modelPut(obj,mtl,O,scale) {
    ...
    mtlLoader.load( mtl, function( materials ) {
        ...
        for(var i in materials.materials){
        		...
        		}else if(materials.materials[i].name=='h'){
        			materials.materials[i]=new THREE.MeshPhongMaterial({color:'#efefef'})
        		}else if(materials.materials[i].name=='f'){
...
modelPut('hfg_qj.obj','hfg_qj.mtl',model1,1.5);
modelPut('hf_qj.obj','hf_qj.mtl',model2,2);
