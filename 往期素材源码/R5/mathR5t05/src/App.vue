      ...
      switch_checked1(){
        ...
        if (this.switch_checked1) {
          ...
          if (this.value == 0 || this.value == 150) {
            ...
            //棱台
            var geometry = new THREE.CylinderBufferGeometry( r, 90, this.value, 4);
            ...
            var an2=function () {
              ...
              for (var b in thiz.bigLine.children) {
                thiz.bigLine.children[b].material.transparent = true;
                thiz.bigLine.children[b].material.opacity = i;
              }
          ...
          for (var b in this.obj1.children) {
            this.obj1.children[b].material.transparent = false;
            this.obj1.children[b].material.opacity = 0;
          }
          for (var b in this.bigLine.children) {
            this.bigLine.children[b].material.transparent = true;
            this.bigLine.children[b].material.opacity = 1;
          }
          this.scene.remove(this.smallLine);
        }
      }
    },
    methods: {
      creatSmall(){
        this.smallLine = new THREE.Group();
        var r = Math.sqrt(2,2)*45;
        var x = Math.sqrt(2,2)*3*(150 - this.value) /10;
        var vertices =[],vertices1 =[],vertices2 =[],vertices3 =[];
        vertices.push(
          new THREE.Vector3(-x,this.value-50,-x),
          new THREE.Vector3(-r,-50,-r)
        );
        var line = this.createLineMesh(vertices, '#000000', 3);
        var line01 = this.createLineMesh(vertices, '#000000', 2);

        vertices1.push(
          new THREE.Vector3(x,this.value-50,x),
          new THREE.Vector3(r,-50,r)
        );
        var line1 = this.createLineMesh(vertices1, '#000000', 3);
        var line02 = this.createLineMesh(vertices1, '#000000', 2);

        vertices2.push(
          new THREE.Vector3(-x,this.value-50,x),
          new THREE.Vector3(-r,-50,r)
        );
        var line2 = this.createLineMesh(vertices2, '#000000', 3);
        var line03 = this.createLineMesh(vertices2, '#000000', 2);

        vertices3.push(
          new THREE.Vector3(x,this.value-50,-x),
          new THREE.Vector3(r,-50,-r)
        );
        var line3 = this.createLineMesh(vertices3, '#000000', 3);
        var line04 = this.createLineMesh(vertices3, '#000000', 2);

        this.smallLine.add(line,line1,line2,line3,line04,line03,line02,line01);
        this.scene.add(this.smallLine);
      },
      //滑动条
      changeEvent(val){
        if(val !== this.value){
      ...
      createNeng(r,h,obj,y){
        var geometry = new THREE.ConeGeometry( r, h, 4 );
        var material = new THREE.MeshBasicMaterial( {color:'#A8F1E0'} );
      ...
      createYuanMian(r,y,type,scene){
        ...
        if(type == 2){
          ...
          this.line1.rotation.y=Math.PI/4;
          ...
          this.line.rotation.y=Math.PI/4;
          scene.add(this.line);
        }
      },
      //圆线
      ...
      creatXian(){
        ...
        this.bigLine.add(line,line1,line2,line3,line04,line03,line02,line01);
        this.scene.add(this.bigLine);
      },
      //初始化
      init(){
