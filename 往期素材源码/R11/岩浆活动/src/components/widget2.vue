<template>
    <div id="app">
        ...
        <div class="renderCanvas-container">
            ...
            <div id="view_space" class="view_space" :style="'position:relative;z-index:10;pointer-events:none;height:130%;width:'+imgViewWidth+'px;position: absolute;top:'+((H-imgViewHeight)/2-H/781*93)+'px;left:'+((W-imgViewWidth)/2-H/781*16)+'px;'">
                <img v-for="index in 210" :src="'static/textures/gaoqing_xulie/Vulcano_' + (index-1) + '.jpg'" :class="{op:num!=index-1}">
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            createScene(engine) {
                ...
                camera.layerMask = 2
                var cameranextpos = new BABYLON.Vector3(-28.39783782275308, 9.946323109142789,
                    9.393554364624013);
                camera.setPosition(cameranextpos)
                var cameranextpos2 = new BABYLON.Vector3(-31.847057263540634, 1.9709919284013787e-15,
                    4.677604871890658);
                ...
                scene.registerBeforeRender(function () {
                    ...
                    if (isClick) {
                        if (material_chuanglian.diffuseTexture.vOffset >= -0.454) {
                            material_chuanglian.diffuseTexture.vOffset -= 0.001;
                            mesh_sparks.position.y -= 0.0235;
                            mesh_sparks.position.y += 0.0235;
                ...
                var aniamtionOneByOne = () => {
                    ...
                    this.num++;
                    SET = requestAnimationFrame(aniamtionOneByOne);
                }

                //图片火山渐现
                function imageShowAnimation() {
                    camera.layerMask = 0x80000000;
                    $('.view_space').animate({opacity: 1}, 1200, () => {
                        aniamtionOneByOne();
                    });
                }
                ...
                var resetAll = function () {
                    cameranextpos = new BABYLON.Vector3(-28.39783782275308, 9.946323109142789,
                        9.393554364624013);
                    camera.setPosition(cameranextpos);
