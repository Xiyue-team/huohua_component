...
var createCircle = (vertices, radius, color,  opacity=1,start=0, end=Math.PI*2) => {
  ...
  var CircleG = new THREE.CircleGeometry(radius, 36, start, end);
...
var createSphere = (radius,end=Math.PI*2,color,opacity=1,seg=48)=>{
  var geometry = new THREE.SphereGeometry( radius, seg, seg ,0,end);
