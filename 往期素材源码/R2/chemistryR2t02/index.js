...
function obj2(){
    ...
    for(var i=0;i<3;i++){
        var a=C('#D5D7E0',20,-45,y,0);
        var b=C("#D5D7E0",20,0,y,0);
        var c=C("#D5D7E0",20,45,y,0);
        obj2G[i].add(a,b,c);
        if(i!=0){
...
function obj3(){
    ...
    //第一层
    var a11=C('#D5D7E0',20,-45,-22.5,-45);
    var a12=C("#D5D7E0",20,0,-22.5,-45);
    var a13=C("#D5D7E0",20,45,-22.5,-45);
    var a14=C("#D5D7E0",20,-45,-22.5,0);
    var a15=C("#D5D7E0",20,0,-22.5,0);
    var a16=C("#D5D7E0",20,45,-22.5,0);
    var a17=C("#D5D7E0",20,-45,-22.5,45);
    var a18=C("#D5D7E0",20,0,-22.5,45);
    var a19=C("#D5D7E0",20,45,-22.5,45);
    obj3G[0].add(a14,a15,a17,a18);
    obj3G[3].add(a11,a12,a13,a16,a19);
    //第二层
    var a21=C('#D5D7E0',20,-45,0,-45);
    var a22=C("#D5D7E0",20,0,0,-45);
    var a23=C("#D5D7E0",20,45,0,-45);
    var a24=C("#D5D7E0",20,-45,0,0);
    var a25=C("#D5D7E0",20,0,0,0);
    var a26=C("#D5D7E0",20,45,0,0);
    var a27=C("#D5D7E0",20,-45,0,45);
    var a28=C("#D5D7E0",20,0,0,45);
    var a29=C("#D5D7E0",20,45,0,45);
    obj3G[1].add(a27);
    obj3G[4].add(a21,a28,a24,a25,a22,a23,a26,a29);
    obj3G[1].position.set(22.5,0,-22.5);
    obj3G[4].position.set(22.5,0,-22.5);
    obj3G[1].visible=false;
    obj3G[4].visible=false;
    //第三层
    var a31=C('#D5D7E0',20,-45,22.5,-45)
    var a32=C("#D5D7E0",20,0,22.5,-45);
    var a33=C("#D5D7E0",20,45,22.5,-45);
    var a34=C("#D5D7E0",20,-45,22.5,0);
    var a35=C("#D5D7E0",20,0,22.5,0);
    var a36=C("#D5D7E0",20,45,22.5,0);
    var a37=C("#D5D7E0",20,-45,22.5,45);
    var a38=C("#D5D7E0",20,0,22.5,45);
    var a39=C("#D5D7E0",20,45,22.5,45);
    obj3G[2].add(a34,a35,a37,a38);
    obj3G[5].add(a31,a32,a33,a36,a39);
    obj3G[2].visible=false;
    obj3G[5].visible=false;

    scene.add(obj3G[0],obj3G[1],obj3G[2],obj3G[3],obj3G[4],obj3G[5]);
}
...
function check(){
    ...
    if(checked){
        ...
        San=setInterval(function () {
            if(obj3G[3].children[0].material.opacity<=0){
                obj3G[5].visible=false;
