...
(function () {
    ...
    window.onresize=function(){
        ...
        if(window.innerWidth<500||window.innerHeight<500) {
            $('#mark1').css({'left': cW / 2 + 68 + 'px', 'top': cH / 2 + 120 + 'px'});
            $('#mark2').css({'left': cW / 2 + 132 + 'px', 'top': cH / 2 - 152 + 'px'});
            $('#mark3').css({'left': cW / 2 + 180 + 'px', 'top': cH / 2 - 90 + 'px'});
            $('#mark4').css({'left': cW / 2 + 47 + 'px', 'top': cH / 2 - 188 + 'px'});
            $('#mark5').css({'left': cW / 2 - 40 + 'px', 'top': cH / 2 + 155 + 'px'});
        }
    else{
