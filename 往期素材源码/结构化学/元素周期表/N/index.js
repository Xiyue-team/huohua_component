...
(function () {
    ...
    window.onresize=function(){
        ...
        if(window.innerWidth<500||window.innerHeight<500){
            $('#mark1').css({'left':cW/2+80+'px','top':cH/2+110+'px'});
            $('#mark2').css({'left':cW/2+180+'px','top':cH/2-152+'px'});
            $('#mark3').css({'left':cW/2+190+'px','top':cH/2-90+'px'});
            $('#mark4').css({'left':cW/2+127+'px','top':cH/2-190+'px'});
            $('#mark5').css({'left':cW/2-40+'px','top':cH/2+150+'px'});
        }
        else{
