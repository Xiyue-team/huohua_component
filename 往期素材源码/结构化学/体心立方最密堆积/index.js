...
function obj3() {
    ...
    if (window.innerWidth < 500 || window.innerHeight < 500) {
        //第一层
        //第一层
        var a11 = C('#D5D7E0', 20, -40, -22.5, -40);
        var a12 = C("#D5D7E0", 20, 0, -22.5, -40);
        var a13 = C("#D5D7E0", 20, 40, -22.5, -40);
        var a14 = C("#D5D7E0", 20, -40, -22.5, 0);
        var a15 = C("#D5D7E0", 20, 0, -22.5, 0);
        var a16 = C("#D5D7E0", 20, 40, -22.5, 0);
        var a17 = C("#D5D7E0", 20, -40, -22.5, 40);
        var a18 = C("#D5D7E0", 20, 0, -22.5, 40);
        var a19 = C("#D5D7E0", 20, 40, -22.5, 40);
        ...
        //第三层
        var a31 = C('#D5D7E0', 20, -40, 22.5, -40)
        var a32 = C("#D5D7E0", 20, 0, 22.5, -40);
        var a33 = C("#D5D7E0", 20, 40, 22.5, -40);
        var a34 = C("#D5D7E0", 20, -40, 22.5, 0);
        var a35 = C("#D5D7E0", 20, 0, 22.5, 0);
        var a36 = C("#D5D7E0", 20, 40, 22.5, 0);
        var a37 = C("#D5D7E0", 20, -40, 22.5, 40);
        var a38 = C("#D5D7E0", 20, 0, 22.5, 40);
        var a39 = C("#D5D7E0", 20, 40, 22.5, 40);
