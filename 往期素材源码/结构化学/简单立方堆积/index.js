...
function obj2() {
    if (window.innerWidth < 500 || window.innerHeight < 500) {
        ...
        for (var i = 0; i < 3; i++) {
            var a = C('#D5D7E0', 15, -30, y, 0);
            var b = C("#D5D7E0", 15, 0, y, 0);
            var c = C("#D5D7E0", 15, 30, y, 0);
            obj2G[i].add(a, b, c);
            if (i != 0) {
...
function obj3() {
    ...
    if (window.innerWidth < 500 || window.innerHeight < 500) {
        //第一层
        var a11 = C('#D5D7E0', 15, -60*0.7, -50, -40*0.7);
        var a12 = C("#D5D7E0", 15, -20*0.7, -50, -40*0.7);
        var a13 = C("#D5D7E0", 15, 20*0.7, -50, -40*0.7);
        var a14 = C("#D5D7E0", 15, -60*0.7, -50, 0);
        var a15 = C("#D5D7E0", 15, -20*0.7, -50, 0);
        var a16 = C("#D5D7E0", 15, 20*0.7, -50, 0);
        var a17 = C("#D5D7E0", 15, -60*0.7, -50, 40*0.7);
        var a18 = C("#D5D7E0", 15, -20*0.7,-50, 40*0.7);
        var a19 = C("#D5D7E0", 15, 20*0.7, -50, 40*0.7);
        obj3G[0].add(a14, a15, a17, a18);
        obj3G[3].add(a11, a12, a13, a16, a19);
        //第二层
        var a21 = C('#D5D7E0', 15, -60*0.7, -20, -40*0.7);
        var a22 = C("#D5D7E0", 15, -20*0.7, -20, -40*0.7);
        var a23 = C("#D5D7E0", 15, 20*0.7, -20, -40*0.7);
        var a24 = C("#D5D7E0", 15, -60*0.7, -20, 0);
        var a25 = C("#D5D7E0", 15, -20*0.7, -20, 0);
        var a26 = C("#D5D7E0", 15, 20*0.7, -20, 0);
        var a27 = C("#D5D7E0", 15, -60*0.7, -20, 40*0.7);
        var a28 = C("#D5D7E0", 15, -20*0.7,-20, 40*0.7);
        var a29 = C("#D5D7E0", 15, 20*0.7, -20, 40*0.7);
        obj3G[1].add(a27, a28, a24, a25);
        obj3G[4].add(a21, a22, a23, a26, a29);
        obj3G[1].visible = false;
        obj3G[4].visible = false;
        //第三层
        var a31 = C('#D5D7E0', 15, -60*0.7, 10, -40*0.7);
        var a32 = C("#D5D7E0", 15, -20*0.7, 10, -40*0.7);
        var a33 = C("#D5D7E0", 15, 20*0.7, 10, -40*0.7);
        var a34 = C("#D5D7E0", 15, -60*0.7, 10, 0);
        var a35 = C("#D5D7E0", 15, -20*0.7, 10, 0);
        var a36 = C("#D5D7E0", 15, 20*0.7, 10, 0);
        var a37 = C("#D5D7E0", 15, -60*0.7,10, 40*0.7);
        var a38 = C("#D5D7E0", 15, -20*0.7, 10, 40*0.7);
        var a39 = C("#D5D7E0", 15, 20*0.7, 10, 40*0.7);
    }
    else {
        //第一层
