...
function obj2(){
    ...
    if(window.innerWidth<500||window.innerHeight<500){
        //第一层
        var a01 = C('#D5D7E0', 15, -20*0.75, -5*0.75, 0);
        var a02 = C("#D5D7E0", 15, 20*0.75, -5*0.75, 0);
        obj2G[0].add(a01, a02);
        //第二层
        var a11 = C('#D5D7E0', 15, -40*0.75, 30*0.75, 0);
        var a12 = C("#D5D7E0", 15, 0, 30*0.75, 0);
        var a13 = C("#D5D7E0", 15, 40*0.75, 30*0.75, 0);
        obj2G[1].add(a11, a12, a13);
        obj2G[1].visible = false;
        //第三层
        var a21 = C('#D5D7E0', 15, -20*0.75, 64*0.75, 0);
        var a22 = C("#D5D7E0", 15, 20*0.75, 64*0.75, 0);
        obj2G[2].add(a21, a22);
        obj2G[2].visible = false;
    }
    else {
        //第一层
        var a01 = C('#D5D7E0', 20, -20, -4, 0);
        var a02 = C("#D5D7E0", 20, 20, -4, 0);
        obj2G[0].add(a01, a02);
        //第二层
        var a11 = C('#D5D7E0', 20, -40, 30, 0);
        var a12 = C("#D5D7E0", 20, 0, 30, 0);
        var a13 = C("#D5D7E0", 20, 40, 30, 0);
        obj2G[1].add(a11, a12, a13);
        obj2G[1].visible = false;
        //第三层
        var a21 = C('#D5D7E0', 20, -20, 64, 0);
        var a22 = C("#D5D7E0", 20, 20, 64, 0);
        obj2G[2].add(a21, a22);
        obj2G[2].visible = false;
    }
