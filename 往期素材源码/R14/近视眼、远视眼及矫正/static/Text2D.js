      ...
      var CanvasText = (function() {
        ...
        _createClass(CanvasText, [{
          ...
          value: function drawText(text, ctxOptions) {
            ...
            this.canvas.width = ctxOptions.sqrt ? THREE.Math.ceilPowerOfTwo(this.textWidth) + 13 : THREE.Math.ceilPowerOfTwo(this.textWidth);
            ...
            if (ctxOptions.sub) {
              ...
              this.ctx.fillText('1', this.canvas.width / 2+5, 30);
            }
            if (ctxOptions.sqrt) {
              this.ctx.save();
              ...
              this.ctx.lineTo(8, 65 - 15);
              this.ctx.lineTo(4, 65 - 20);
              this.ctx.lineTo(0, 65 - 16);
              this.ctx.stroke();
              this.ctx.restore();
            }
            return this.canvas;
    ...
    2: [function(require, module, exports) {
      ...
      var SpriteText2D = (function(_THREE$Object3D) {
        ...
        function SpriteText2D() {
          ...
          _this.sub = options.sub;
          _this.sqrt = options.sqrt;
