<template>
    <!-- eslint-disable -->
    <div ref="wrap" :class="['uiSlider',isBox, flowDirection,  { 'ui-has-piecewise': piecewiseLabel,'noBlueProcess':noBlueProcess?noBlueProcess:noBlue }]" :style="wrapStyles" @click="wrapClick">
        <!--标题-->
        <h3 v-text="title" v-if="title" class="ui-title"></h3>
        <!--副标题-->
        <p v-text="subTitle" v-if="subTitle" class="ui-subTitle"></p>
        <!--滑条上的文字-->
        <ul v-if="label" :style="{width:infinity?'53%':'',marginLeft:dotSize/2+'px'}" class="ui-label">
        ...
        <div ref="elem" aria-hidden="true" class="vue-slider" :style="[elemStyles,infinityStyle]">
            ...
            <template v-if="valueIsArray">
                <div ref="dot0" :class="[tooltipStatus, 'ui-dot']" :style="[dotStyles]" @mousedown="moveStart(0)" @touchstart="moveStart(0)">
            ...
            {{ formatter ? formatting(val[0]) : val[0] }}
                ...
                <div ref="dot1" :class="[tooltipStatus, 'ui-dot']" :style="[dotStyles]" @mousedown="moveStart(1)" @touchstart="moveStart(1)">
            ...
            <!--单向-->
            <template v-else>
                <div ref="dot" :class="[tooltipStatus, 'ui-dot']" :style="[dotStyles]" @mousedown="moveStart" @touchstart="moveStart">
