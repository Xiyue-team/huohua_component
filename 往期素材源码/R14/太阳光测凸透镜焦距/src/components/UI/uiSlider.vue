    ...
    <div ref="elem" aria-hidden="true" class="vue-slider" :style="[elemStyles,infinityStyle]">
      ...
      <ul class="ui-piecewise" ref="sliderWidth">
        <li v-for="(obj, index) in piecewiseDotWrap" class="ui-piecewise-item" :style="[piecewiseDotStyle, obj.style]" :key="index">
          <!--滑条上的圆-->
          <span v-if="piecewise" class="ui-piecewise-dot" :class="{piecewiseActiveStyle:obj.inRange}"></span>
          <!--滑条上方的文字-->
          <span v-if="piecewiseLabel" class="ui-piecewise-label" :class="{labelActiveStyle:obj.inRange}">
                            {{ obj.label }}
                        </span>
        </li>
      </ul>
...
export default {
  ...
  props: {
    ...
    piecewiseLabel: { type: Boolean, default: true },
    //是否显示蓝色滑条
